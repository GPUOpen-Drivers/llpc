...
; This test checks how the scalarization of descriptor loads works if we have a @lgc.create.image.load.v4f32
; call whose returned value is used in a @lgc.create.image.store call.
...
.entry:
  ...
  %i3 = mul i32 %__llpc_input_proxy_4.4.vec.extract, %i2
  ...
  %i7 = mul i32 %__llpc_input_proxy_4.0.vec.extract, %i2
  %i8 = sext i32 %i7 to i64
  %i9 = getelementptr i8, ptr addrspace(4) %i1, i64 %i8
  %i10 = load <4 x i32>, ptr addrspace(4) %i9, align 16, !invariant.load !16
  %i11 = call reassoc nnan nsz arcp contract afn <4 x float> (...) @lgc.create.image.load.v4f32(i32 0, i32 8, <4 x i32> %i10, i32 0)
  call void (...) @lgc.create.image.store(<4 x float> %i11, i32 0, i32 8, <4 x i32> %i6, i32 1)
  ret void
}
...
; CHECK-NEXT:    [[I3:%.*]] = mul i32 [[__LLPC_INPUT_PROXY_4_4_VEC_EXTRACT]], 16
...
; CHECK-NEXT:    [[I7:%.*]] = mul i32 [[__LLPC_INPUT_PROXY_4_0_VEC_EXTRACT]], 16
; CHECK-NEXT:    [[I8:%.*]] = sext i32 [[I7]] to i64
; CHECK-NEXT:    [[I9:%.*]] = getelementptr i8, ptr addrspace(4) [[I1]], i64 [[I8]]
; CHECK-NEXT:    [[I10:%.*]] = load <4 x i32>, ptr addrspace(4) [[I9]], align 16, !invariant.load !16
; CHECK-NEXT:    [[TMP6:%.*]] = call i32 @llvm.amdgcn.waterfall.begin.i32(i32 0, i32 [[I7]])
; CHECK-NEXT:    [[TMP7:%.*]] = call i32 @llvm.amdgcn.waterfall.readfirstlane.i32.i32(i32 [[TMP6]], i32 [[I7]])
; CHECK-NEXT:    [[TMP8:%.*]] = sext i32 [[TMP7]] to i64
; CHECK-NEXT:    [[TMP9:%.*]] = getelementptr i8, ptr addrspace(4) [[I1]], i64 [[TMP8]]
; CHECK-NEXT:    [[TMP10:%.*]] = load <4 x i32>, ptr addrspace(4) [[TMP9]], align 16, !invariant.load !16
; CHECK-NEXT:    [[TMP11:%.*]] = call reassoc nnan nsz arcp contract afn <4 x float> @llvm.amdgcn.struct.buffer.load.format.v4f32(<4 x i32> [[TMP10]], i32 0, i32 0, i32 0, i32 0)
; CHECK-NEXT:    [[I11:%.*]] = call reassoc nnan nsz arcp contract afn <4 x float> @llvm.amdgcn.waterfall.end.v4f32(i32 [[TMP6]], <4 x float> [[TMP11]])
...
; CHECK-NEXT:    [[TMP16:%.*]] = load <4 x i32>, ptr addrspace(4) [[TMP15]], align 16, !invariant.load !16
; CHECK-NEXT:    [[TMP17:%.*]] = call <4 x i32> @llvm.amdgcn.waterfall.last.use.v4i32(i32 [[TMP12]], <4 x i32> [[TMP16]])
; CHECK-NEXT:    call void @llvm.amdgcn.struct.buffer.store.format.v4f32(<4 x float> [[I11]], <4 x i32> [[TMP17]], i32 1, i32 0, i32 0, i32 0)
; CHECK-NEXT:    ret void
;
