...
loop.latch:
  %phi = phi ptr addrspace(4) [ %5, %bb1 ], [ %8, %bb2 ]
  %9 = load <4 x i32>, ptr addrspace(4) %phi, align 16, !invariant.load !10
  %10 = load <8 x i32>, ptr addrspace(4) %phi, align 32, !invariant.load !10
...
; CHECK-NEXT:    br label [[LOOP_LATCH]]
; CHECK:       loop.latch:
; CHECK-NEXT:    [[PHI:%.*]] = phi ptr addrspace(4) [ [[TMP17]], [[BB1]] ], [ [[TMP20]], [[BB2]] ]
; CHECK-NEXT:    [[TMP21:%.*]] = load <4 x i32>, ptr addrspace(4) [[PHI]], align 16, !invariant.load !10
; CHECK-NEXT:    [[TMP22:%.*]] = load <8 x i32>, ptr addrspace(4) [[PHI]], align 32, !invariant.load !10
; CHECK-NEXT:    [[TMP23:%.*]] = call i32 @llvm.amdgcn.waterfall.begin.v8i32(i32 0, <8 x i32> [[TMP22]])
; CHECK-NEXT:    [[TMP24:%.*]] = call i32 @llvm.amdgcn.waterfall.begin.v4i32(i32 [[TMP23]], <4 x i32> [[TMP21]])
; CHECK-NEXT:    [[TMP25:%.*]] = call <8 x i32> @llvm.amdgcn.waterfall.readfirstlane.v8i32.v8i32(i32 [[TMP24]], <8 x i32> [[TMP22]])
; CHECK-NEXT:    [[TMP26:%.*]] = load <8 x i32>, ptr addrspace(4) [[PHI]], align 32, !invariant.load !10
; CHECK-NEXT:    [[TMP27:%.*]] = call <4 x i32> @llvm.amdgcn.waterfall.readfirstlane.v4i32.v4i32(i32 [[TMP24]], <4 x i32> [[TMP21]])
; CHECK-NEXT:    [[TMP28:%.*]] = load <4 x i32>, ptr addrspace(4) [[PHI]], align 16, !invariant.load !10
; CHECK-NEXT:    [[TMP29:%.*]] = call reassoc nnan nsz arcp contract afn <4 x float> @llvm.amdgcn.image.sample.2d.v4f32.f32(i32 15, float 0.000000e+00, float 0.000000e+00, <8 x i32> [[TMP25]], <4 x i32> [[TMP27]], i1 false, i32 0, i32 0)
; CHECK-NEXT:    [[TMP30:%.*]] = call reassoc nnan nsz arcp contract afn <4 x float> @llvm.amdgcn.waterfall.end.v4f32(i32 [[TMP24]], <4 x float> [[TMP29]])
; CHECK-NEXT:    call void @lgc.output.export.generic.i32.i32.v4f32(i32 0, i32 0, <4 x float> [[TMP30]]) #[[ATTR5:[0-9]+]]
