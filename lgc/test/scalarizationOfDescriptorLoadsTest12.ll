...
exit:
  call void (...) @lgc.create.write.generic.output(<4 x float> %12, i32 0, i32 0, i32 0, i32 0, i32 0, i32 poison)
  ret void
}
...
; CHECK:       exit:
; CHECK-NEXT:    call void @lgc.output.export.generic.i32.i32.v4f32(i32 0, i32 0, <4 x float> [[TMP33]]) #[[ATTR5:[0-9]+]]
; CHECK-NEXT:    ret void
;
