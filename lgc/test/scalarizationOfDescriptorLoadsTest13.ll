...
; CHECK-NEXT:    [[L:%.*]] = load <8 x i32>, ptr addrspace(4) [[I5]], align 32, !invariant.load !10
...
; CHECK-NEXT:    [[I9:%.*]] = load <4 x i32>, ptr addrspace(4) [[I8]], align 16, !invariant.load !10
; CHECK-NEXT:    [[I10]] = load <8 x i32>, ptr addrspace(4) [[I8]], align 32, !invariant.load !10
...
; CHECK-NEXT:    [[TMP18:%.*]] = load <4 x i32>, ptr addrspace(4) [[TMP17]], align 16, !invariant.load !10
