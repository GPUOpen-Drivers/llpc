...
loop:
  ...
  %10 = load <4 x i32>, ptr addrspace(4) %5, align 32, !invariant.load !10
  call void (...) @lgc.create.image.store(<4 x i32> %10, i32 0, i32 8, <4 x i32> %9, i32 1)
...
; CHECK-NEXT:    [[TMP22:%.*]] = load <4 x i32>, ptr addrspace(4) [[TMP17]], align 32, !invariant.load !10
; CHECK-NEXT:    [[TMP23:%.*]] = bitcast <4 x i32> [[TMP22]] to <4 x float>
; CHECK-NEXT:    [[TMP24:%.*]] = call i32 @llvm.amdgcn.waterfall.begin.i32(i32 0, i32 [[TMP18]])
; CHECK-NEXT:    [[TMP25:%.*]] = call i32 @llvm.amdgcn.waterfall.readfirstlane.i32.i32(i32 [[TMP24]], i32 [[TMP18]])
; CHECK-NEXT:    [[TMP26:%.*]] = sext i32 [[TMP25]] to i64
; CHECK-NEXT:    [[TMP27:%.*]] = getelementptr i8, ptr addrspace(4) [[TMP14]], i64 [[TMP26]]
; CHECK-NEXT:    [[TMP28:%.*]] = load <4 x i32>, ptr addrspace(4) [[TMP27]], align 16, !invariant.load !10
; CHECK-NEXT:    [[TMP29:%.*]] = call <4 x i32> @llvm.amdgcn.waterfall.last.use.v4i32(i32 [[TMP24]], <4 x i32> [[TMP28]])
; CHECK-NEXT:    call void @llvm.amdgcn.struct.buffer.store.format.v4f32(<4 x float> [[TMP23]], <4 x i32> [[TMP29]], i32 1, i32 0, i32 0, i32 0)
