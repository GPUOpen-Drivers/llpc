...
; Here, we check how the scalarization of descriptor loads works if one of the operands of the call is uniform.
...
.entry:
  ...
  %i12 = call reassoc nnan nsz arcp contract afn <4 x float> (...) @lgc.create.image.sample.v4f32(i32 1, i32 24, <8 x i32> %i11, <4 x i32> <i32 42, i32 42, i32 42, i32 42>, i32 1, <2 x float> zeroinitializer)
  ret void
}
...
; CHECK-NEXT:    [[TMP13:%.*]] = call i32 @llvm.amdgcn.waterfall.begin.v4i32(i32 [[TMP12]], <4 x i32> <i32 42, i32 42, i32 42, i32 42>)
...
; CHECK-NEXT:    [[TMP18:%.*]] = call <4 x i32> @llvm.amdgcn.waterfall.readfirstlane.v4i32.v4i32(i32 [[TMP13]], <4 x i32> <i32 42, i32 42, i32 42, i32 42>)
...
; CHECK-NEXT:    [[I12:%.*]] = call reassoc nnan nsz arcp contract afn <4 x float> @llvm.amdgcn.waterfall.end.v4f32(i32 [[TMP13]], <4 x float> [[TMP19]])
; CHECK-NEXT:    ret void
;
