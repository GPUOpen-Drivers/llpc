...
; SHADERTEST: call i32 (...) @lgc.create.subgroup.clustered.reduction.i32(i32 0,
; SHADERTEST: call i32 (...) @lgc.create.subgroup.clustered.reduction.i32(i32 0,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.reduction.f32(i32 1,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.reduction.f32(i32 1,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.reduction.f32(i32 1,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.reduction.f32(i32 1,
...
; SHADERTEST: call i32 (...) @lgc.create.subgroup.clustered.reduction.i32(i32 5,
; SHADERTEST: call i32 (...) @lgc.create.subgroup.clustered.reduction.i32(i32 5,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.reduction.f32(i32 6,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.reduction.f32(i32 6,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.reduction.f32(i32 6,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.reduction.f32(i32 6,
...
; SHADERTEST: call i32 (...) @lgc.create.subgroup.clustered.reduction.i32(i32 8,
; SHADERTEST: call i32 (...) @lgc.create.subgroup.clustered.reduction.i32(i32 8,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.reduction.f32(i32 9,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.reduction.f32(i32 9,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.reduction.f32(i32 9,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.reduction.f32(i32 9,
...
; SHADERTEST: call i32 (...) @lgc.create.subgroup.clustered.inclusive.i32(i32 0,
; SHADERTEST: call i32 (...) @lgc.create.subgroup.clustered.inclusive.i32(i32 0,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.inclusive.f32(i32 1,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.inclusive.f32(i32 1,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.inclusive.f32(i32 1,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.inclusive.f32(i32 1,
...
; SHADERTEST: call i32 (...) @lgc.create.subgroup.clustered.inclusive.i32(i32 5,
; SHADERTEST: call i32 (...) @lgc.create.subgroup.clustered.inclusive.i32(i32 5,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.inclusive.f32(i32 6,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.inclusive.f32(i32 6,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.inclusive.f32(i32 6,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.inclusive.f32(i32 6,
...
; SHADERTEST: call i32 (...) @lgc.create.subgroup.clustered.inclusive.i32(i32 8,
; SHADERTEST: call i32 (...) @lgc.create.subgroup.clustered.inclusive.i32(i32 8,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.inclusive.f32(i32 9,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.inclusive.f32(i32 9,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.inclusive.f32(i32 9,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.inclusive.f32(i32 9,
...
; SHADERTEST: call i32 (...) @lgc.create.subgroup.clustered.exclusive.i32(i32 0,
; SHADERTEST: call i32 (...) @lgc.create.subgroup.clustered.exclusive.i32(i32 0,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.exclusive.f32(i32 1,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.exclusive.f32(i32 1,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.exclusive.f32(i32 1,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.exclusive.f32(i32 1,
...
; SHADERTEST: call i32 (...) @lgc.create.subgroup.clustered.exclusive.i32(i32 5,
; SHADERTEST: call i32 (...) @lgc.create.subgroup.clustered.exclusive.i32(i32 5,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.exclusive.f32(i32 6,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.exclusive.f32(i32 6,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.exclusive.f32(i32 6,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.exclusive.f32(i32 6,
...
; SHADERTEST: call i32 (...) @lgc.create.subgroup.clustered.exclusive.i32(i32 8,
; SHADERTEST: call i32 (...) @lgc.create.subgroup.clustered.exclusive.i32(i32 8,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.exclusive.f32(i32 9,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.exclusive.f32(i32 9,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.exclusive.f32(i32 9,
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.subgroup.clustered.exclusive.f32(i32 9,
