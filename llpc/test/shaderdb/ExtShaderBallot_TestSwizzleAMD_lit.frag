...
; SHADERTEST: call reassoc nnan nsz arcp contract <4 x float> (...) @lgc.create.subgroup.swizzle.quad.v4f32(<4 x float> %{{[0-9]*}}, <4 x i32> <i32 1, i32 0, i32 3, i32 2>)
...
; SHADERTEST: call reassoc nnan nsz arcp contract <4 x float> (...) @lgc.create.subgroup.swizzle.mask.v4f32(<4 x float> %{{[0-9]*}}, <3 x i32> <i32 3, i32 15, i32 6>)
