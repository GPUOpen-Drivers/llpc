...
; SHADERTEST: %[[arr:[0-9]+]] = alloca [5 x i32], align 4, addrspace(5)
...
; SHADERTEST: br i1 %[[cmp1]], label %{{[^, ]+}}, label %{{[A-Za-z0-9_.]+}}
...
; SHADERTEST: %[[gep2:[0-9]+]] = getelementptr [5 x i32], [5 x i32] addrspace(5)* %[[arr]], i32 0, i32 %[[phi]]
; SHADERTEST: %[[cmp2:[0-9]+]] = icmp ult i32 %[[phi]], 5
; SHADERTEST: br i1 %[[cmp2]], label %{{[^, ]+}}, label %{{[A-Za-z0-9_.]+}}
