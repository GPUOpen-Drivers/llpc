...
; SHADERTEST: load i32, i32 addrspace(7)* getelementptr inbounds (<{ i32 }>, <{ i32 }> addrspace(7)* @0, i32 0, i32 0), align 4
...
; SHADERTEST-NEXT: br i1 %[[cmp1]], label %{{[^, ]+}}, label %{{[A-Za-z0-9_.]+}}
...
; SHADERTEST-NEXT: br i1 %[[cmp2]], label %{{[^, ]+}}, label %{{[A-Za-z0-9_.]+}}
