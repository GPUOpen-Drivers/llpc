...
; SHADERTEST: call void @llvm.amdgcn.raw.buffer.store.v4i32(<4 x i32> <i32 1065353216, i32 1065353216, i32 1065353216, i32 1065353216>, <4 x i32> %{{[^, ]+}}, i32 16, i32 0, i32 0)
...
; SHADERTEST: call void @llvm.amdgcn.raw.buffer.store.v4i32(<4 x i32> %{{[^, ]+}}, <4 x i32> %{{[^, ]+}}, i32 96, i32 0, i32 0)
; SHADERTEST: call void @llvm.amdgcn.raw.buffer.store.v4i32(<4 x i32> zeroinitializer, <4 x i32> %{{[^, ]+}}, i32 112, i32 0, i32 0)
; SHADERTEST: call void @llvm.amdgcn.raw.buffer.store.v4i32(<4 x i32> zeroinitializer, <4 x i32> %{{[^, ]+}}, i32 128, i32 0, i32 0)
