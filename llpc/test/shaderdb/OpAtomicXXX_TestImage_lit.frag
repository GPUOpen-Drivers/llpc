...
; SHADERTEST: call i32 (...) @lgc.create.image.atomic.i32(i32 6, i32 1, i32 0, i32 0, <8 x i32>
...
; SHADERTEST: call i32 (...) @lgc.create.image.atomic.i32(i32 7, i32 0, i32 0, i32 0, <4 x i32>
...
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @lgc.create.image.atomic.f32(i32 0, i32 1, i32 0, i32 0, <8 x i32>
