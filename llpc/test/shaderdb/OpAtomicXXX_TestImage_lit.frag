...
; SHADERTEST: call i32 @llvm.amdgcn.image.atomic.add.1d.i32.i32(i32 %{{[^, ]+}}, i32 1, <8 x i32> %{{[^, ]+}}, i32 0
; SHADERTEST: call i32 @llvm.amdgcn.image.atomic.smin.2d.i32.i32(i32 %{{[^, ]+}}, i32 2, i32 2, <8 x i32> %{{[^, ]+}}, i32 0
; SHADERTEST: call i32 @llvm.amdgcn.image.atomic.smax.2d.i32.i32(i32 %{{[^, ]+}}, i32 2, i32 2, <8 x i32> %{{[^, ]+}}, i32 0
; SHADERTEST: call i32 @llvm.amdgcn.image.atomic.and.2dmsaa.i32.i32(i32 %{{[^, ]+}}, i32 2, i32 2, i32 4, <8 x i32> %{{[^, ]+}}, i32 0
; SHADERTEST: call i32 @llvm.amdgcn.image.atomic.or.1d.i32.i32(i32 %{{[^, ]+}}, i32 1, <8 x i32> %{{[^, ]+}}, i32 0
; SHADERTEST: call i32 @llvm.amdgcn.image.atomic.xor.1d.i32.i32(i32 %{{[^, ]+}}, i32 2, <8 x i32> %{{[^, ]+}}, i32 0
; SHADERTEST: call i32 @llvm.amdgcn.image.atomic.swap.1d.i32.i32(i32 %{{[^, ]+}}, i32 1, <8 x i32> %{{[^, ]+}}, i32 0
; SHADERTEST: call i32 @llvm.amdgcn.image.atomic.cmpswap.1d.i32.i32(i32 %{{[^, ]+}}, i32 28, i32 1, <8 x i32> %{{[^, ]+}}, i32 0
; SHADERTEST: call i32 @llvm.amdgcn.image.atomic.add.cube.i32.i32(i32 %{{[^, ]+}}, i32 1, i32 1, i32 1, <8 x i32> %{{[^, ]+}}, i32 0
; SHADERTEST: call i32 @llvm.amdgcn.struct.buffer.atomic.umin.i32(i32 %{{[^, ]+}}, <4 x i32> %{{[^, ]+}}, i32 2, i32 0, i32 0
; SHADERTEST: call i32 @llvm.amdgcn.struct.buffer.atomic.umax.i32(i32 %{{[^, ]+}}, <4 x i32> %{{[^, ]+}}, i32 1, i32 0, i32 0
; SHADERTEST: call i32 @llvm.amdgcn.image.atomic.and.2darraymsaa.i32.i32(i32 %{{[^, ]+}}, i32 2, i32 2, i32 2, i32 5, <8 x i32> %{{[^, ]+}}, i32 0
; SHADERTEST: call i32 @llvm.amdgcn.image.atomic.or.cube.i32.i32(i32 %{{[^, ]+}}, i32 1, i32 1, i32 1, <8 x i32> %{{[^, ]+}}, i32 0
; SHADERTEST: call i32 @llvm.amdgcn.image.atomic.xor.cube.i32.i32(i32 %{{[^, ]+}}, i32 2, i32 2, i32 2, <8 x i32> %{{[^, ]+}}, i32 0
; SHADERTEST: call i32 @llvm.amdgcn.image.atomic.swap.cube.i32.i32(i32 %{{[^, ]+}}, i32 1, i32 1, i32 1, <8 x i32> %{{[^, ]+}}, i32 0
; SHADERTEST: call i32 @llvm.amdgcn.image.atomic.cmpswap.cube.i32.i32(i32 %{{[^, ]+}}, i32 17, i32 1, i32 1, i32 1, <8 x i32> %{{[^, ]+}}, i32 0
; SHADERTEST: call {{.*}} float @llvm.amdgcn.image.atomic.swap.2d.f32.i32(float %{{[^, ]+}}, i32 3, i32 3, <8 x i32> %{{[^, ]+}}, i32 0, i32 0)
