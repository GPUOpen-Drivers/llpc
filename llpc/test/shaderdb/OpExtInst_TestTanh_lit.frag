...
; SHADERTEST: = call reassoc nnan nsz arcp contract float (...) @lgc.create.tanh.f32(float
; SHADERTEST: = call reassoc nnan nsz arcp contract <3 x float> (...) @lgc.create.tanh.v3f32(<3 x float>
