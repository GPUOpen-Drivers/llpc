...
; SHADERTEST: [[SAMPLER:%[0-9A-Za-z_.-]+]] = call <8 x i32> (...) @llpc.call.load.desc.from.ptr.v8i32({ <8 x i32> addrspace(4)*, i32 } [[SAMPLERPTR]])
; SHADERTEST: [[IMAGE:%[0-9A-Za-z_.-]+]] = call <8 x i32> (...) @llpc.call.load.desc.from.ptr.v8i32({ <8 x i32> addrspace(4)*, i32 } [[IMAGEPTR]])
; SHADERTEST: call reassoc nnan nsz arcp contract <4 x float> {{.*}}@llpc.call.image.gather.v4f32(i32 1, i32 0, <8 x i32> [[IMAGE]], <8 x i32> [[SAMPLER]],{{.*}},{{.*}} float 2.000000e+00
