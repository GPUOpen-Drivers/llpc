...
; SHADERTEST: call reassoc nnan nsz arcp contract <4 x float> (...) @lgc.create.image.gather.v4f32(i32 1, i32 0, <8 x i32>
; SHADERTEST: call reassoc nnan nsz arcp contract <4 x float> (...) @lgc.create.image.gather.v4f32(i32 5, i32 0, <8 x i32>
; SHADERTEST: call reassoc nnan nsz arcp contract <4 x float> (...) @lgc.create.image.gather.v4f32(i32 1, i32 0, <8 x i32>
