...
; SHADERTEST: call reassoc nnan nsz arcp contract <4 x float> (...) @lgc.create.image.load.v4f32(i32 0, i32 0, {{.*}}, i32 6, i32 3)
; SHADERTEST: call {{.*}} @"lgc.create.get.image.desc.ptr{{.*}}(i32 1, i32 0
; SHADERTEST: call reassoc nnan nsz arcp contract <4 x float> (...) @lgc.create.image.load.v4f32(i32 1, i32 0, {{.*}}, <2 x i32> <i32 12, i32 12>, i32 6)
; SHADERTEST: call {{.*}} @"lgc.create.get.image.desc.ptr{{.*}}(i32 0, i32 1
; SHADERTEST: call reassoc nnan nsz arcp contract <4 x float> (...) @lgc.create.image.load.v4f32(i32 2, i32 0, {{.*}}, <3 x i32> <i32 4, i32 4, i32 4>, i32 2)
; SHADERTEST: call {{.*}} @"lgc.create.get.image.desc.ptr{{.*}}(i32 0, i32 2
; SHADERTEST: call reassoc nnan nsz arcp contract <4 x float> (...) @lgc.create.image.load.v4f32(i32 1, i32 0, {{.*}}, <2 x i32> <i32 9, i32 9>)
; SHADERTEST: call {{.*}} @"lgc.create.get.image.desc.ptr{{.*}}(i32 0, i32 3
; SHADERTEST: call reassoc nnan nsz arcp contract <4 x float> (...) @lgc.create.image.load.v4f32(i32 4, i32 0, {{.*}}, <2 x i32> <i32 12, i32 5>, i32 6)
; SHADERTEST: call {{.*}} @"lgc.create.get.image.desc.ptr{{.*}}(i32 2, i32 0
; SHADERTEST: call reassoc nnan nsz arcp contract <4 x float> (...) @lgc.create.image.load.v4f32(i32 5, i32 0, {{.*}}, <3 x i32> <i32 4, i32 4, i32 1>, i32 2)
