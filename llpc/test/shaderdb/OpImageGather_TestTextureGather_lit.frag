...
; SHADERTEST: call {{.*}} <4 x float> @llvm.amdgcn.image.gather4.l.2d.v4f32.f32(i32 4, float 0x3FB99999A0000000, float 0x3FB99999A0000000, float 0.000000e+00, <8 x i32> %{{[^, ]+}}, <4 x i32> %{{[^, ]+}}, i1 false, i32 0, i32 0)
; SHADERTEST: call {{.*}} <4 x float> @llvm.amdgcn.image.gather4.l.2darray.v4f32.f32(i32 8, float 0x3FC99999A0000000, float 0x3FC99999A0000000, float 0.000000e+00, float 0.000000e+00, <8 x i32> %{{[^, ]+}}, <4 x i32> %{{[^, ]+}}, i1 false, i32 0, i32 0)
