...
; SHADERTEST: call reassoc nnan nsz arcp contract <2 x float> (...) @lgc.create.image.get.lod.v2f32(i32 0, i32 0, {{.*}}, {{.*}}, float 1.000000e+00)
...
; SHADERTEST: call reassoc nnan nsz arcp contract <2 x float> (...) @lgc.create.image.get.lod.v2f32(i32 1, i32 0, {{.*}}, {{.*}}, <2 x float> <float 5.000000e-01, float 5.000000e-01>)
...
; SHADERTEST: call reassoc nnan nsz arcp contract <2 x float> (...) @lgc.create.image.get.lod.v2f32(i32 1, i32 0, {{.*}}, {{.*}}, <2 x float> <float 0x3FD99999A0000000, float 0x3FD99999A0000000>)
...
; SHADERTEST: call reassoc nnan nsz arcp contract <2 x float> (...) @lgc.create.image.get.lod.v2f32(i32 8, i32 0, {{.*}}, {{.*}}, <3 x float> <float 0x3FE3333340000000, float 0x3FE3333340000000, float 0x3FE3333340000000>)
...
; SHADERTEST: call reassoc nnan nsz arcp contract <2 x float> (...) @lgc.create.image.get.lod.v2f32(i32 2, i32 0, {{.*}}, {{.*}}, <3 x float> <float 0x3FE6666660000000, float 0x3FE6666660000000, float 0x3FE6666660000000>)
