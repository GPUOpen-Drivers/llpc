...
; SHADERTEST: call {{.*}} @lgc.create.image.load.v4f32(i32 1, i32 96, {{.*}}, <2 x i32> zeroinitializer) 
; SHADERTEST: call {{.*}} @"lgc.create.get.image.desc.ptr.s[p4v8i32,i32]"(i32 0, i32 1) 
; SHADERTEST: call {{.*}} @lgc.create.image.load.with.fmask.v4f32(i32 6, i32 96, {{.*}}, {{.*}}, <2 x i32> zeroinitializer, i32 7) 
; SHADERTEST: call {{.*}} @"lgc.create.get.image.desc.ptr.s[p4v8i32,i32]"(i32 0, i32 2) 
; SHADERTEST: call {{.*}} @lgc.create.image.load.v4i32(i32 1, i32 100, {{.*}}, <2 x i32> zeroinitializer) 
; SHADERTEST: call {{.*}} @"lgc.create.get.image.desc.ptr.s[p4v8i32,i32]"(i32 0, i32 3) 
; SHADERTEST: call {{.*}} @lgc.create.image.load.with.fmask.v4i32(i32 6, i32 100, {{.*}}, {{.*}}, <2 x i32> zeroinitializer, i32 7) 
; SHADERTEST: call {{.*}} @"lgc.create.get.image.desc.ptr.s[p4v8i32,i32]"(i32 0, i32 4) 
; SHADERTEST: call {{.*}} @lgc.create.image.load.v4i32(i32 1, i32 96, {{.*}}, <2 x i32> zeroinitializer) 
; SHADERTEST: call {{.*}} @"lgc.create.get.image.desc.ptr.s[p4v8i32,i32]"(i32 0, i32 5) 
; SHADERTEST: call {{.*}} @lgc.create.image.load.with.fmask.v4i32(i32 6, i32 96, {{.*}}, {{.*}}, <2 x i32> zeroinitializer, i32 7) 
