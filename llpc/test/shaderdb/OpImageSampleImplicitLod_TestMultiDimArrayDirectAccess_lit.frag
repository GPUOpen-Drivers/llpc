...
; SHADERTEST: call reassoc nnan nsz arcp contract afn <4 x float> (...) @lgc.create.image.sample.v4f32(i32 1, i32 0, <8 x i32> %{{[^, ]+}}, <4 x i32> %{{[^, ]+}}, i32 1, <2 x float> <float 1.000000e+00, float 1.000000e+00>)
...
; SHADERTEST-LABEL: load <4 x i32>, <4 x i32> addrspace(4)* %{{[A-Za-z0-9_.]+}}
; SHADERTEST-LABEL: load <8 x i32>, <8 x i32> addrspace(4)* %{{[A-Za-z0-9_.]+}}
