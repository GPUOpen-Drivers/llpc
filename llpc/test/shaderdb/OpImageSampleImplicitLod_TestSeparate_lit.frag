...
; SHADERTEST: call reassoc nnan nsz arcp contract <4 x float> (...) @llpc.call.image.sample.v4f32(i32 1, i32 0, <8 x i32> %{{[-0-9A-Za0z_.]+}}, <8 x i32> %{{[-0-9A-Za0z_.]+}}, i32 1, <2 x float> zeroinitializer)
