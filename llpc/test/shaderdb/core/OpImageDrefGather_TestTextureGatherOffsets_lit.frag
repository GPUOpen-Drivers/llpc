...
; SHADERTEST: {{<8 x i32> addrspace\(4\)\*|ptr addrspace\(4\)}} (...) @lgc.create.get.desc.ptr.p4{{.*}}(i32 1, i32 1, i32 1, i32 0)
; SHADERTEST: {{<4 x i32> addrspace\(4\)\*|ptr addrspace\(4\)}} (...) @lgc.create.get.desc.ptr.p4{{.*}}(i32 2, i32 2, i32 1, i32 0)
...
; SHADERTEST: call reassoc nnan nsz arcp contract afn <4 x float> (...) @lgc.create.image.gather.v4f32(i32 1, i32 512, {{.*}}, i32 801, <2 x float> <float 1.000000e+00, float 1.000000e+00>, float 0.000000e+00, [4 x <2 x i32>] [<2 x i32> <i32 1, i32 1>, <2 x i32> <i32 2, i32 2>, <2 x i32> <i32 3, i32 3>, <2 x i32> <i32 4, i32 4>], float 0x3FE6666660000000)
