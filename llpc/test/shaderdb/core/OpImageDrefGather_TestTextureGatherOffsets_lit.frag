...
; SHADERTEST: call {{.*}} <4 x float> @llvm.amdgcn.image.gather4.c.lz.o.2d.v4f32.f32(i32 1, i32 257, float 0x3FE6666660000000, float 1.000000e+00, float 1.000000e+00,{{.*}}, i1 true, i32 0, i32 0)
; SHADERTEST: call {{.*}} <4 x float> @llvm.amdgcn.image.gather4.c.lz.o.2d.v4f32.f32(i32 1, i32 514, float 0x3FE6666660000000, float 1.000000e+00, float 1.000000e+00,{{.*}}, i1 true, i32 0, i32 0)
; SHADERTEST: call {{.*}} <4 x float> @llvm.amdgcn.image.gather4.c.lz.o.2d.v4f32.f32(i32 1, i32 771, float 0x3FE6666660000000, float 1.000000e+00, float 1.000000e+00,{{.*}}, i1 true, i32 0, i32 0)
; SHADERTEST: call {{.*}} <4 x float> @llvm.amdgcn.image.gather4.c.lz.o.2d.v4f32.f32(i32 1, i32 1028, float 0x3FE6666660000000, float 1.000000e+00, float 1.000000e+00,{{.*}}, i1 true, i32 0, i32 0)
