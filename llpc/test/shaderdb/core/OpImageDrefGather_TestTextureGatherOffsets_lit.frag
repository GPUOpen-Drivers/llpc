...
; SHADERTEST: call reassoc nnan nsz arcp contract afn <4 x float> (...) @lgc.create.image.gather.v4f32(i32 1, i32 512, {{.*}}, i32 801, <2 x float> {{(splat \(float 0x3FB99999A0000000\))|(<float 0x3FB99999A0000000, float 0x3FB99999A0000000>)}}, float 0.000000e+00, [4 x <2 x i32>] [<2 x i32> {{(splat \(i32 1\))|(<i32 1, i32 1>)}}, <2 x i32> {{(splat \(i32 2\))|(<i32 2, i32 2>)}}, <2 x i32> {{(splat \(i32 3\))|(<i32 3, i32 3>)}}, <2 x i32> {{(splat \(i32 4\))|(<i32 4, i32 4>)}}], float 0x3FECCCCCC0000000)
; SHADERTEST: call reassoc nnan nsz arcp contract afn <4 x float> (...) @lgc.create.image.gather.v4f32(i32 5, i32 896, {{.*}}, i32 801, <3 x float> {{(splat \(float 0x3FC99999A0000000\))|(<float 0x3FC99999A0000000, float 0x3FC99999A0000000, float 0x3FC99999A0000000>)}}, float 0.000000e+00, [4 x <2 x i32>] [<2 x i32> {{(splat \(i32 1\))|(<i32 1, i32 1>)}}, <2 x i32> {{(splat \(i32 2\))|(<i32 2, i32 2>)}}, <2 x i32> {{(splat \(i32 3\))|(<i32 3, i32 3>)}}, <2 x i32> {{(splat \(i32 4\))|(<i32 4, i32 4>)}}], float 0x3FE99999A0000000)
; SHADERTEST: call reassoc nnan nsz arcp contract afn <4 x float> (...) @lgc.create.image.gather.v4f32(i32 9, i32 512, {{.*}}, i32 801, <2 x float> {{(splat \(float 1\.000000e\+00\))|(<float 1\.000000e\+00, float 1\.000000e\+00>)}}, float 0.000000e+00, [4 x <2 x i32>] [<2 x i32> {{(splat \(i32 1\))|(<i32 1, i32 1>)}}, <2 x i32> {{(splat \(i32 2\))|(<i32 2, i32 2>)}}, <2 x i32> {{(splat \(i32 3\))|(<i32 3, i32 3>)}}, <2 x i32> {{(splat \(i32 4\))|(<i32 4, i32 4>)}}], float 0x3FE6666660000000)
