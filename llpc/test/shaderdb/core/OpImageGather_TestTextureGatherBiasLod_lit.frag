...
; SHADERTEST: call {{.*}} @lgc.create.get.desc.ptr.p4v4i32(i32 2, i32 0, i32 1
...
; SHADERTEST: call {{.*}} @lgc.create.get.desc.ptr.p4v4i32(i32 2, i32 0, i32 2
...
; SHADERTEST: call {{.*}} @lgc.create.get.desc.ptr.p4v4i32(i32 2, i32 0, i32 3
