...
; SHADERTEST: call {{.*}} @lgc.create.image.sample.v4f32(i32 1, i32  896, {{.*}}, {{.*}}, i32 153, <2 x float> <float 0x3FB99999A0000000, float 0x3FB99999A0000000>, <2 x float> <float 1.000000e+00, float 1.000000e+00>, <2 x float> <float 0x3FF19999A0000000, float 0x3FF19999A0000000>, {{.*}})
...
; SHADERTEST: call {{.*}} @lgc.create.image.sample.v4f32(i32 1, i32  896, {{.*}}, {{.*}}, i32 409, <2 x float> <float 0x3FB99999A0000000, float 0x3FB99999A0000000>, <2 x float> <float 1.000000e+00, float 1.000000e+00>, <2 x float> <float 0x3FF19999A0000000, float 0x3FF19999A0000000>, {{.*}}, <2 x i32> <i32 2, i32 2>)
