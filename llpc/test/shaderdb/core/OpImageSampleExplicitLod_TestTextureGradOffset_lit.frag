...
; SHADERTEST: call {{.*}} @lgc.create.image.sample.v4f32(i32 1, i32  896, {{.*}}, {{.*}}, i32 281, <2 x float> <float 4.000000e+00, float 4.000000e+00>, <2 x float> <float 5.000000e+00, float 5.000000e+00>, <2 x float> <float 6.000000e+00, float 6.000000e+00>, <2 x i32> <i32 3, i32 3>)
