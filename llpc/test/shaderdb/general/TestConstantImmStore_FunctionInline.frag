...
// SHADERTEST: @{{.*}} = internal unnamed_addr addrspace(4) constant [2 x <2 x float>] [<2 x float> <float 2.500000e-01, float 2.500000e-01>, <2 x float> <float -2.500000e-01, float -2.500000e-01>]
