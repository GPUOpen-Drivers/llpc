...
; SHADERTEST-COUNT-3: call reassoc nnan nsz arcp contract afn half @llvm.sin.f16(half
; SHADERTEST-COUNT-3: call reassoc nnan nsz arcp contract afn half @llvm.cos.f16(half
