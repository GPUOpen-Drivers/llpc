...
; SHADERTEST: fadd reassoc nnan nsz arcp contract afn <4 x half> %{{[^, ]+}}, %{{[A-Za-z0-9_.]+}}
; SHADERTEST: fmul reassoc nnan nsz arcp contract afn <4 x half> %{{[^, ]+}}, %{{[A-Za-z0-9_.]+}}
; SHADERTEST: fsub reassoc nnan nsz arcp contract afn <4 x half> %{{[^, ]+}}, %{{[A-Za-z0-9_.]+}}
