...
; CPS-STACK-LOWERING-CPS-NEXT:    [[TMP6:%.*]] = load i32, ptr addrspace(20) @REGISTERS, align 4
...
; CPS-STACK-LOWERING-CPS-NEXT:    store i32 [[TMP6]], ptr addrspace(20) @REGISTERS, align 4
