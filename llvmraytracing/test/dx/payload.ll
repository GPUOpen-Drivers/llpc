...
; RUN: grep -v SKIP_GLOBAL_ADDRSPACE %s | opt --verify-each -passes='dxil-cont-lgc-rt-op-converter,lint,inline,lint,lower-raytracing-pipeline,lint,sroa,lint,lower-await,lint,coro-early,dxil-coro-split,coro-cleanup,lint,dxil-cleanup-continuations,lint,dxil-cont-post-process,lint,continuations-lint,remove-types-metadata' \
; RUN:     -S --lint-abort-on-error | FileCheck -check-prefix=POST-PROCESS-CPS %s
...
; RUN:     -S %s --lint-abort-on-error | FileCheck -check-prefix=POST-PROCESS-GLOBAL-CPS %s
...
; CLEANUP-NEXT:    [[TMP67:%.*]] = call [[DX_TYPES_HANDLE]] @[[DX_OP_CREATEHANDLEFORLIB_DX_TYPES_HANDLE]](i32 160, [[DX_TYPES_HANDLE]] [[TMP59]])
; CLEANUP-NEXT:    [[TMP69:%.*]] = call [[DX_TYPES_HANDLE]] @[[DX_OP_ANNOTATEHANDLE]](i32 216, [[DX_TYPES_HANDLE]] [[TMP67]], [[DX_TYPES_RESOURCEPROPERTIES:%.*]] { i32 16, i32 0 })
...
; POST-PROCESS-GLOBAL-NEXT:    [[TMP93:%.*]] = call [[DX_TYPES_HANDLE]] @[[DX_OP_CREATEHANDLEFORLIB_DX_TYPES_HANDLE]](i32 160, [[DX_TYPES_HANDLE]] [[TMP91]])
; POST-PROCESS-GLOBAL-NEXT:    [[TMP94:%.*]] = call [[DX_TYPES_HANDLE]] @[[DX_OP_ANNOTATEHANDLE]](i32 216, [[DX_TYPES_HANDLE]] [[TMP93]], [[DX_TYPES_RESOURCEPROPERTIES:%.*]] { i32 16, i32 0 })
...
; CLEANUP-CPS-NEXT:    [[DOTFCA_0_EXTRACT56:%.*]] = extractvalue [[STRUCT_DISPATCHSYSTEMDATA]] [[TMP0]], 0
...
; CLEANUP-CPS-NEXT:    [[DIS_DATA_I_FCA_0_INSERT:%.*]] = insertvalue [[STRUCT_DISPATCHSYSTEMDATA]] poison, <3 x i32> [[DOTFCA_0_EXTRACT56]], 0
...
; CLEANUP-CPS-NEXT:    [[TMP6:%.*]] = call i64 (...) @lgc.cps.as.continuation.reference__i64(ptr @main.resume.0)
...
; CLEANUP-CPS-NEXT:    [[TMP8:%.*]] = inttoptr i32 [[TMP7]] to ptr addrspace(32)
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP8]], align 4
; CLEANUP-CPS-NEXT:    [[TMP9:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 1
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP9]], align 4
; CLEANUP-CPS-NEXT:    [[TMP10:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 2
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP10]], align 4
; CLEANUP-CPS-NEXT:    [[TMP11:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 3
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP11]], align 4
; CLEANUP-CPS-NEXT:    [[TMP12:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 4
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP12]], align 4
; CLEANUP-CPS-NEXT:    [[TMP13:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 5
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP13]], align 4
; CLEANUP-CPS-NEXT:    [[TMP14:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 6
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP14]], align 4
; CLEANUP-CPS-NEXT:    [[TMP15:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 7
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP15]], align 4
; CLEANUP-CPS-NEXT:    [[TMP16:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 8
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP16]], align 4
; CLEANUP-CPS-NEXT:    [[TMP17:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 9
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP17]], align 4
; CLEANUP-CPS-NEXT:    [[TMP18:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 10
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP18]], align 4
; CLEANUP-CPS-NEXT:    [[TMP19:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 11
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP19]], align 4
; CLEANUP-CPS-NEXT:    [[TMP20:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 12
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP20]], align 4
; CLEANUP-CPS-NEXT:    [[TMP21:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 13
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP21]], align 4
; CLEANUP-CPS-NEXT:    [[TMP22:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 14
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP22]], align 4
; CLEANUP-CPS-NEXT:    [[TMP23:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 15
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP23]], align 4
; CLEANUP-CPS-NEXT:    [[TMP24:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 16
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP24]], align 4
; CLEANUP-CPS-NEXT:    [[TMP25:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 17
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP25]], align 4
; CLEANUP-CPS-NEXT:    [[TMP26:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 18
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP26]], align 4
; CLEANUP-CPS-NEXT:    [[TMP27:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 19
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP27]], align 4
; CLEANUP-CPS-NEXT:    [[TMP28:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 20
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP28]], align 4
; CLEANUP-CPS-NEXT:    [[TMP29:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 21
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP29]], align 4
; CLEANUP-CPS-NEXT:    [[TMP30:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 22
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP30]], align 4
; CLEANUP-CPS-NEXT:    [[TMP31:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 23
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP31]], align 4
; CLEANUP-CPS-NEXT:    [[TMP32:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 24
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP32]], align 4
; CLEANUP-CPS-NEXT:    [[TMP33:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 25
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP33]], align 4
; CLEANUP-CPS-NEXT:    [[TMP34:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP8]], i32 26
; CLEANUP-CPS-NEXT:    store i32 undef, ptr addrspace(32) [[TMP34]], align 4
; CLEANUP-CPS-NEXT:    [[DOTFCA_0_INSERT:%.*]] = insertvalue [30 x i32] poison, i32 [[TMP7]], 0
; CLEANUP-CPS-NEXT:    [[DOTFCA_1_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_0_INSERT]], i32 undef, 1
; CLEANUP-CPS-NEXT:    [[DOTFCA_2_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_1_INSERT]], i32 undef, 2
; CLEANUP-CPS-NEXT:    [[DOTFCA_3_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_2_INSERT]], i32 undef, 3
; CLEANUP-CPS-NEXT:    [[DOTFCA_4_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_3_INSERT]], i32 undef, 4
; CLEANUP-CPS-NEXT:    [[DOTFCA_5_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_4_INSERT]], i32 undef, 5
; CLEANUP-CPS-NEXT:    [[DOTFCA_6_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_5_INSERT]], i32 undef, 6
; CLEANUP-CPS-NEXT:    [[DOTFCA_7_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_6_INSERT]], i32 undef, 7
; CLEANUP-CPS-NEXT:    [[DOTFCA_8_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_7_INSERT]], i32 undef, 8
; CLEANUP-CPS-NEXT:    [[DOTFCA_9_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_8_INSERT]], i32 undef, 9
; CLEANUP-CPS-NEXT:    [[DOTFCA_10_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_9_INSERT]], i32 undef, 10
; CLEANUP-CPS-NEXT:    [[DOTFCA_11_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_10_INSERT]], i32 undef, 11
; CLEANUP-CPS-NEXT:    [[DOTFCA_12_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_11_INSERT]], i32 undef, 12
; CLEANUP-CPS-NEXT:    [[DOTFCA_13_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_12_INSERT]], i32 undef, 13
; CLEANUP-CPS-NEXT:    [[DOTFCA_14_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_13_INSERT]], i32 undef, 14
; CLEANUP-CPS-NEXT:    [[DOTFCA_15_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_14_INSERT]], i32 undef, 15
; CLEANUP-CPS-NEXT:    [[DOTFCA_16_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_15_INSERT]], i32 undef, 16
; CLEANUP-CPS-NEXT:    [[DOTFCA_17_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_16_INSERT]], i32 undef, 17
; CLEANUP-CPS-NEXT:    [[DOTFCA_18_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_17_INSERT]], i32 undef, 18
; CLEANUP-CPS-NEXT:    [[DOTFCA_19_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_18_INSERT]], i32 undef, 19
; CLEANUP-CPS-NEXT:    [[DOTFCA_20_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_19_INSERT]], i32 undef, 20
; CLEANUP-CPS-NEXT:    [[DOTFCA_21_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_20_INSERT]], i32 undef, 21
; CLEANUP-CPS-NEXT:    [[DOTFCA_22_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_21_INSERT]], i32 undef, 22
; CLEANUP-CPS-NEXT:    [[DOTFCA_23_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_22_INSERT]], i32 undef, 23
; CLEANUP-CPS-NEXT:    [[DOTFCA_24_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_23_INSERT]], i32 undef, 24
; CLEANUP-CPS-NEXT:    [[DOTFCA_25_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_24_INSERT]], i32 undef, 25
; CLEANUP-CPS-NEXT:    [[DOTFCA_26_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_25_INSERT]], i32 undef, 26
...
; CLEANUP-CPS-NEXT:    [[TMP5:%.*]] = extractvalue { [[STRUCT_DISPATCHSYSTEMDATA]], [23 x i32], [30 x i32] } [[TMP3]], 2
...
; CLEANUP-CPS-NEXT:    call void @amd.dx.setLocalRootIndex(i32 0)
; CLEANUP-CPS-NEXT:    call void @lgc.cps.free(i32 108)
...
; CLEANUP-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_0_1_0_EXTRACT:%.*]] = extractvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[SYSTEM_DATA]], 0, 0, 1, 0
; CLEANUP-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_0_1_0_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 0, i32 1, i32 0
; CLEANUP-CPS-NEXT:    store <2 x float> [[SYSTEM_DATA_FCA_0_0_1_0_EXTRACT]], ptr [[SYSTEM_DATA_FCA_0_0_1_0_GEP]], align 4
...
; CLEANUP-CPS-NEXT:    store float [[SYSTEM_DATA_FCA_0_1_0_EXTRACT]], ptr [[SYSTEM_DATA_FCA_0_1_0_GEP]], align 4
...
; CLEANUP-CPS-NEXT:    store i32 [[SYSTEM_DATA_FCA_0_1_1_EXTRACT]], ptr [[SYSTEM_DATA_FCA_0_1_1_GEP]], align 4
...
; CLEANUP-CPS-NEXT:    [[TMP0:%.*]] = inttoptr i32 [[PAYLOAD_FCA_0_EXTRACT]] to ptr addrspace(32)
; CLEANUP-CPS-NEXT:    [[TMP1:%.*]] = load i32, ptr addrspace(32) [[TMP0]], align 4
; CLEANUP-CPS-NEXT:    [[TMP2:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 1
; CLEANUP-CPS-NEXT:    [[TMP3:%.*]] = load i32, ptr addrspace(32) [[TMP2]], align 4
; CLEANUP-CPS-NEXT:    [[TMP4:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 2
; CLEANUP-CPS-NEXT:    [[TMP5:%.*]] = load i32, ptr addrspace(32) [[TMP4]], align 4
; CLEANUP-CPS-NEXT:    [[TMP6:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 3
; CLEANUP-CPS-NEXT:    [[TMP7:%.*]] = load i32, ptr addrspace(32) [[TMP6]], align 4
; CLEANUP-CPS-NEXT:    [[TMP8:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 4
; CLEANUP-CPS-NEXT:    [[TMP9:%.*]] = load i32, ptr addrspace(32) [[TMP8]], align 4
; CLEANUP-CPS-NEXT:    [[TMP10:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 5
; CLEANUP-CPS-NEXT:    [[TMP11:%.*]] = load i32, ptr addrspace(32) [[TMP10]], align 4
; CLEANUP-CPS-NEXT:    [[TMP12:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 6
; CLEANUP-CPS-NEXT:    [[TMP13:%.*]] = load i32, ptr addrspace(32) [[TMP12]], align 4
; CLEANUP-CPS-NEXT:    [[TMP14:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 7
; CLEANUP-CPS-NEXT:    [[TMP15:%.*]] = load i32, ptr addrspace(32) [[TMP14]], align 4
; CLEANUP-CPS-NEXT:    [[TMP16:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 8
; CLEANUP-CPS-NEXT:    [[TMP17:%.*]] = load i32, ptr addrspace(32) [[TMP16]], align 4
; CLEANUP-CPS-NEXT:    [[TMP18:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 9
; CLEANUP-CPS-NEXT:    [[TMP19:%.*]] = load i32, ptr addrspace(32) [[TMP18]], align 4
; CLEANUP-CPS-NEXT:    [[TMP20:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 10
; CLEANUP-CPS-NEXT:    [[TMP21:%.*]] = load i32, ptr addrspace(32) [[TMP20]], align 4
; CLEANUP-CPS-NEXT:    [[TMP22:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 11
; CLEANUP-CPS-NEXT:    [[TMP23:%.*]] = load i32, ptr addrspace(32) [[TMP22]], align 4
; CLEANUP-CPS-NEXT:    [[TMP24:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 12
; CLEANUP-CPS-NEXT:    [[TMP25:%.*]] = load i32, ptr addrspace(32) [[TMP24]], align 4
; CLEANUP-CPS-NEXT:    [[TMP26:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 13
; CLEANUP-CPS-NEXT:    [[TMP27:%.*]] = load i32, ptr addrspace(32) [[TMP26]], align 4
; CLEANUP-CPS-NEXT:    [[TMP28:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 14
; CLEANUP-CPS-NEXT:    [[TMP29:%.*]] = load i32, ptr addrspace(32) [[TMP28]], align 4
; CLEANUP-CPS-NEXT:    [[TMP30:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 15
; CLEANUP-CPS-NEXT:    [[TMP31:%.*]] = load i32, ptr addrspace(32) [[TMP30]], align 4
; CLEANUP-CPS-NEXT:    [[TMP32:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 16
; CLEANUP-CPS-NEXT:    [[TMP33:%.*]] = load i32, ptr addrspace(32) [[TMP32]], align 4
; CLEANUP-CPS-NEXT:    [[TMP34:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 17
; CLEANUP-CPS-NEXT:    [[TMP35:%.*]] = load i32, ptr addrspace(32) [[TMP34]], align 4
; CLEANUP-CPS-NEXT:    [[TMP36:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 18
; CLEANUP-CPS-NEXT:    [[TMP37:%.*]] = load i32, ptr addrspace(32) [[TMP36]], align 4
; CLEANUP-CPS-NEXT:    [[TMP38:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 19
; CLEANUP-CPS-NEXT:    [[TMP39:%.*]] = load i32, ptr addrspace(32) [[TMP38]], align 4
; CLEANUP-CPS-NEXT:    [[TMP40:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 20
; CLEANUP-CPS-NEXT:    [[TMP41:%.*]] = load i32, ptr addrspace(32) [[TMP40]], align 4
; CLEANUP-CPS-NEXT:    [[TMP42:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 21
; CLEANUP-CPS-NEXT:    [[TMP43:%.*]] = load i32, ptr addrspace(32) [[TMP42]], align 4
; CLEANUP-CPS-NEXT:    [[TMP44:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 22
; CLEANUP-CPS-NEXT:    [[TMP45:%.*]] = load i32, ptr addrspace(32) [[TMP44]], align 4
; CLEANUP-CPS-NEXT:    [[TMP46:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 23
; CLEANUP-CPS-NEXT:    [[TMP47:%.*]] = load i32, ptr addrspace(32) [[TMP46]], align 4
; CLEANUP-CPS-NEXT:    [[TMP48:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 24
; CLEANUP-CPS-NEXT:    [[TMP49:%.*]] = load i32, ptr addrspace(32) [[TMP48]], align 4
; CLEANUP-CPS-NEXT:    [[TMP50:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 25
; CLEANUP-CPS-NEXT:    [[TMP51:%.*]] = load i32, ptr addrspace(32) [[TMP50]], align 4
; CLEANUP-CPS-NEXT:    [[TMP52:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP0]], i32 26
; CLEANUP-CPS-NEXT:    [[TMP53:%.*]] = load i32, ptr addrspace(32) [[TMP52]], align 4
; CLEANUP-CPS-NEXT:    [[TMP54:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 0
; CLEANUP-CPS-NEXT:    [[ADDR_I:%.*]] = getelementptr [[STRUCT_SYSTEMDATA:%.*]], ptr [[TMP54]], i32 0, i32 1
...
; CLEANUP-CPS-NEXT:    [[DOTSROA_025_0_VEC_EXTRACT:%.*]] = extractelement <2 x float> [[VAL_I_FCA_0_INSERT_FCA_0_EXTRACT]], i32 0
; CLEANUP-CPS-NEXT:    [[TMP55:%.*]] = bitcast float [[DOTSROA_025_0_VEC_EXTRACT]] to i32
; CLEANUP-CPS-NEXT:    [[DOTSROA_025_4_VEC_EXTRACT:%.*]] = extractelement <2 x float> [[VAL_I_FCA_0_INSERT_FCA_0_EXTRACT]], i32 1
; CLEANUP-CPS-NEXT:    [[TMP56:%.*]] = bitcast float [[DOTSROA_025_4_VEC_EXTRACT]] to i32
...
; CLEANUP-CPS-NEXT:    [[TMP57:%.*]] = inttoptr i32 [[PAYLOAD_FCA_0_EXTRACT]] to ptr addrspace(32)
; CLEANUP-CPS-NEXT:    store i32 [[TMP1]], ptr addrspace(32) [[TMP57]], align 4
; CLEANUP-CPS-NEXT:    [[TMP58:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 1
; CLEANUP-CPS-NEXT:    store i32 [[TMP3]], ptr addrspace(32) [[TMP58]], align 4
; CLEANUP-CPS-NEXT:    [[TMP59:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 2
; CLEANUP-CPS-NEXT:    store i32 [[TMP5]], ptr addrspace(32) [[TMP59]], align 4
; CLEANUP-CPS-NEXT:    [[TMP60:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 3
; CLEANUP-CPS-NEXT:    store i32 [[TMP7]], ptr addrspace(32) [[TMP60]], align 4
; CLEANUP-CPS-NEXT:    [[TMP61:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 4
; CLEANUP-CPS-NEXT:    store i32 [[TMP9]], ptr addrspace(32) [[TMP61]], align 4
; CLEANUP-CPS-NEXT:    [[TMP62:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 5
; CLEANUP-CPS-NEXT:    store i32 [[TMP11]], ptr addrspace(32) [[TMP62]], align 4
; CLEANUP-CPS-NEXT:    [[TMP63:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 6
; CLEANUP-CPS-NEXT:    store i32 [[TMP13]], ptr addrspace(32) [[TMP63]], align 4
; CLEANUP-CPS-NEXT:    [[TMP64:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 7
; CLEANUP-CPS-NEXT:    store i32 [[TMP15]], ptr addrspace(32) [[TMP64]], align 4
; CLEANUP-CPS-NEXT:    [[TMP65:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 8
; CLEANUP-CPS-NEXT:    store i32 [[TMP17]], ptr addrspace(32) [[TMP65]], align 4
; CLEANUP-CPS-NEXT:    [[TMP66:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 9
; CLEANUP-CPS-NEXT:    store i32 [[TMP19]], ptr addrspace(32) [[TMP66]], align 4
; CLEANUP-CPS-NEXT:    [[TMP67:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 10
; CLEANUP-CPS-NEXT:    store i32 [[TMP21]], ptr addrspace(32) [[TMP67]], align 4
; CLEANUP-CPS-NEXT:    [[TMP68:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 11
; CLEANUP-CPS-NEXT:    store i32 [[TMP23]], ptr addrspace(32) [[TMP68]], align 4
; CLEANUP-CPS-NEXT:    [[TMP69:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 12
; CLEANUP-CPS-NEXT:    store i32 [[TMP25]], ptr addrspace(32) [[TMP69]], align 4
; CLEANUP-CPS-NEXT:    [[TMP70:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 13
; CLEANUP-CPS-NEXT:    store i32 [[TMP27]], ptr addrspace(32) [[TMP70]], align 4
; CLEANUP-CPS-NEXT:    [[TMP71:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 14
; CLEANUP-CPS-NEXT:    store i32 [[TMP29]], ptr addrspace(32) [[TMP71]], align 4
; CLEANUP-CPS-NEXT:    [[TMP72:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 15
; CLEANUP-CPS-NEXT:    store i32 [[TMP31]], ptr addrspace(32) [[TMP72]], align 4
; CLEANUP-CPS-NEXT:    [[TMP73:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 16
; CLEANUP-CPS-NEXT:    store i32 [[TMP33]], ptr addrspace(32) [[TMP73]], align 4
; CLEANUP-CPS-NEXT:    [[TMP74:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 17
; CLEANUP-CPS-NEXT:    store i32 [[TMP35]], ptr addrspace(32) [[TMP74]], align 4
; CLEANUP-CPS-NEXT:    [[TMP75:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 18
; CLEANUP-CPS-NEXT:    store i32 [[TMP37]], ptr addrspace(32) [[TMP75]], align 4
; CLEANUP-CPS-NEXT:    [[TMP76:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 19
; CLEANUP-CPS-NEXT:    store i32 [[TMP39]], ptr addrspace(32) [[TMP76]], align 4
; CLEANUP-CPS-NEXT:    [[TMP77:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 20
; CLEANUP-CPS-NEXT:    store i32 [[TMP41]], ptr addrspace(32) [[TMP77]], align 4
; CLEANUP-CPS-NEXT:    [[TMP78:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 21
; CLEANUP-CPS-NEXT:    store i32 [[TMP43]], ptr addrspace(32) [[TMP78]], align 4
; CLEANUP-CPS-NEXT:    [[TMP79:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 22
; CLEANUP-CPS-NEXT:    store i32 [[TMP45]], ptr addrspace(32) [[TMP79]], align 4
; CLEANUP-CPS-NEXT:    [[TMP80:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 23
; CLEANUP-CPS-NEXT:    store i32 [[TMP47]], ptr addrspace(32) [[TMP80]], align 4
; CLEANUP-CPS-NEXT:    [[TMP81:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 24
; CLEANUP-CPS-NEXT:    store i32 [[TMP49]], ptr addrspace(32) [[TMP81]], align 4
; CLEANUP-CPS-NEXT:    [[TMP82:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 25
; CLEANUP-CPS-NEXT:    store i32 [[TMP51]], ptr addrspace(32) [[TMP82]], align 4
; CLEANUP-CPS-NEXT:    [[TMP83:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP57]], i32 26
; CLEANUP-CPS-NEXT:    store i32 [[TMP53]], ptr addrspace(32) [[TMP83]], align 4
; CLEANUP-CPS-NEXT:    [[HITATTRSALLOCA_SROA_0_0_VEC_EXTRACT:%.*]] = extractelement <2 x float> [[HIT_ATTRS_FCA_0_EXTRACT]], i32 0
; CLEANUP-CPS-NEXT:    [[TMP84:%.*]] = bitcast float [[HITATTRSALLOCA_SROA_0_0_VEC_EXTRACT]] to i32
; CLEANUP-CPS-NEXT:    [[TMP85:%.*]] = bitcast i32 [[TMP84]] to float
; CLEANUP-CPS-NEXT:    [[DOTSROA_027_0_VEC_INSERT:%.*]] = insertelement <2 x float> undef, float [[TMP85]], i32 0
; CLEANUP-CPS-NEXT:    [[HITATTRSALLOCA_SROA_0_4_VEC_EXTRACT:%.*]] = extractelement <2 x float> [[HIT_ATTRS_FCA_0_EXTRACT]], i32 1
; CLEANUP-CPS-NEXT:    [[TMP86:%.*]] = bitcast float [[HITATTRSALLOCA_SROA_0_4_VEC_EXTRACT]] to i32
; CLEANUP-CPS-NEXT:    [[TMP87:%.*]] = bitcast i32 [[TMP86]] to float
; CLEANUP-CPS-NEXT:    [[DOTSROA_027_4_VEC_INSERT:%.*]] = insertelement <2 x float> [[DOTSROA_027_0_VEC_INSERT]], float [[TMP87]], i32 1
; CLEANUP-CPS-NEXT:    [[DOTFCA_0_INSERT26:%.*]] = insertvalue [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES]] poison, <2 x float> [[DOTSROA_027_4_VEC_INSERT]], 0
; CLEANUP-CPS-NEXT:    [[TMP88:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 0
; CLEANUP-CPS-NEXT:    call void @_cont_SetTriangleHitAttributes(ptr [[TMP88]], [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES]] [[DOTFCA_0_INSERT26]])
...
; CLEANUP-CPS-NEXT:    [[DOTFCA_0_0_1_0_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 0, i32 1, i32 0
; CLEANUP-CPS-NEXT:    [[DOTFCA_0_0_1_0_LOAD:%.*]] = load <2 x float>, ptr [[DOTFCA_0_0_1_0_GEP]], align 4
; CLEANUP-CPS-NEXT:    [[DOTFCA_0_0_1_0_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_0_0_0_0_INSERT]], <2 x float> [[DOTFCA_0_0_1_0_LOAD]], 0, 0, 1, 0
...
; CLEANUP-CPS-NEXT:    [[DOTFCA_0_1_0_LOAD:%.*]] = load float, ptr [[DOTFCA_0_1_0_GEP]], align 4
; CLEANUP-CPS-NEXT:    [[DOTFCA_0_1_0_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_0_0_1_0_INSERT]], float [[DOTFCA_0_1_0_LOAD]], 0, 1, 0
...
; CLEANUP-CPS-NEXT:    [[DOTFCA_0_1_1_LOAD:%.*]] = load i32, ptr [[DOTFCA_0_1_1_GEP]], align 4
; CLEANUP-CPS-NEXT:    [[DOTFCA_0_1_1_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_0_1_0_INSERT]], i32 [[DOTFCA_0_1_1_LOAD]], 0, 1, 1
...
; CLEANUP-CPS-NEXT:    [[DOTFCA_0_2_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_0_1_1_INSERT]], <3 x float> [[DOTFCA_0_2_LOAD]], 0, 2
...
; CLEANUP-CPS-NEXT:    [[DOTFCA_1_0_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_0_5_INSERT]], float [[DOTFCA_1_0_LOAD]], 1, 0
...
; CLEANUP-CPS-NEXT:    [[DOTFCA_1_1_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_1_0_INSERT]], i32 [[DOTFCA_1_1_LOAD]], 1, 1
...
; CLEANUP-CPS-NEXT:    [[RETURNADDR_SPILL_ADDR:%.*]] = getelementptr inbounds [[CLOSESTHIT_FRAME]], ptr addrspace(32) [[CONT_STATE_STACK_SEGMENT]], i32 0, i32 1
; CLEANUP-CPS-NEXT:    store i32 [[RETURNADDR]], ptr addrspace(32) [[RETURNADDR_SPILL_ADDR]], align 4
; CLEANUP-CPS-NEXT:    [[PAYLOAD_FCA_0_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 0
; CLEANUP-CPS-NEXT:    [[PAYLOAD_FCA_0_EXTRACT_SPILL_ADDR:%.*]] = getelementptr inbounds [[CLOSESTHIT_FRAME]], ptr addrspace(32) [[CONT_STATE_STACK_SEGMENT]], i32 0, i32 2
...
; CLEANUP-CPS-NEXT:    [[VAL_I_FCA_0_INSERT_FCA_0_EXTRACT:%.*]] = extractvalue [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES]] [[VAL_I_FCA_0_INSERT]], 0
; CLEANUP-CPS-NEXT:    [[DOTSROA_0257_0_VEC_EXTRACT:%.*]] = extractelement <2 x float> [[VAL_I_FCA_0_INSERT_FCA_0_EXTRACT]], i32 0
; CLEANUP-CPS-NEXT:    [[TMP54:%.*]] = bitcast float [[DOTSROA_0257_0_VEC_EXTRACT]] to i32
; CLEANUP-CPS-NEXT:    [[DOTSROA_0257_4_VEC_EXTRACT:%.*]] = extractelement <2 x float> [[VAL_I_FCA_0_INSERT_FCA_0_EXTRACT]], i32 1
; CLEANUP-CPS-NEXT:    [[TMP55:%.*]] = bitcast float [[DOTSROA_0257_4_VEC_EXTRACT]] to i32
; CLEANUP-CPS-NEXT:    call void @amd.dx.setLocalRootIndex(i32 [[SHADER_INDEX]])
; CLEANUP-CPS-NEXT:    [[TMP56:%.*]] = load [[DX_TYPES_HANDLE:%.*]], ptr @"\01?Scene@@3URaytracingAccelerationStructure@@A", align 4
; CLEANUP-CPS-NEXT:    [[TMP57:%.*]] = load [[DX_TYPES_HANDLE]], ptr @"\01?RenderTarget@@3V?$RWTexture2D@V?$vector@M$03@@@@A", align 4
; CLEANUP-CPS-NEXT:    [[TMP58:%.*]] = call [[DX_TYPES_HANDLE]] @[[DX_OP_CREATEHANDLEFORLIB_DX_TYPES_HANDLE]](i32 160, [[DX_TYPES_HANDLE]] [[TMP56]])
; CLEANUP-CPS-NEXT:    [[TMP59:%.*]] = call [[DX_TYPES_HANDLE]] @[[DX_OP_ANNOTATEHANDLE]](i32 216, [[DX_TYPES_HANDLE]] [[TMP58]], [[DX_TYPES_RESOURCEPROPERTIES:%.*]] { i32 16, i32 0 })
; CLEANUP-CPS-NEXT:    [[TMP60:%.*]] = call i64 @amd.dx.getAccelStructAddr([[DX_TYPES_HANDLE]] [[TMP59]])
...
; CLEANUP-CPS-NEXT:    [[SYS_DATA_I:%.*]] = insertvalue [[STRUCT_SYSTEMDATA]] undef, [[STRUCT_DISPATCHSYSTEMDATA]] [[DIS_DATA_I_FCA_0_INSERT]], 0
; CLEANUP-CPS-NEXT:    [[TRAV_DATA_I:%.*]] = insertvalue [[STRUCT_TRAVERSALDATA:%.*]] undef, [[STRUCT_SYSTEMDATA]] [[SYS_DATA_I]], 0
; CLEANUP-CPS-NEXT:    [[TMP61:%.*]] = call i64 (...) @lgc.cps.as.continuation.reference__i64(ptr @ClosestHit.resume.0)
; CLEANUP-CPS-NEXT:    [[TRAV_DATA2_I:%.*]] = insertvalue [[STRUCT_TRAVERSALDATA]] [[TRAV_DATA_I]], i64 [[TMP61]], 5
; CLEANUP-CPS-NEXT:    [[TMP62:%.*]] = ptrtoint ptr addrspace(32) [[PAYLOAD_SPILL_ALLOCA]] to i32
; CLEANUP-CPS-NEXT:    [[TMP63:%.*]] = inttoptr i32 [[TMP62]] to ptr addrspace(32)
; CLEANUP-CPS-NEXT:    store i32 [[TMP1]], ptr addrspace(32) [[TMP63]], align 4
; CLEANUP-CPS-NEXT:    [[TMP64:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 1
; CLEANUP-CPS-NEXT:    store i32 [[TMP3]], ptr addrspace(32) [[TMP64]], align 4
; CLEANUP-CPS-NEXT:    [[TMP65:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 2
; CLEANUP-CPS-NEXT:    store i32 [[TMP5]], ptr addrspace(32) [[TMP65]], align 4
; CLEANUP-CPS-NEXT:    [[TMP66:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 3
; CLEANUP-CPS-NEXT:    store i32 [[TMP7]], ptr addrspace(32) [[TMP66]], align 4
; CLEANUP-CPS-NEXT:    [[TMP67:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 4
; CLEANUP-CPS-NEXT:    store i32 [[TMP9]], ptr addrspace(32) [[TMP67]], align 4
; CLEANUP-CPS-NEXT:    [[TMP68:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 5
; CLEANUP-CPS-NEXT:    store i32 [[TMP11]], ptr addrspace(32) [[TMP68]], align 4
; CLEANUP-CPS-NEXT:    [[TMP69:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 6
; CLEANUP-CPS-NEXT:    store i32 [[TMP13]], ptr addrspace(32) [[TMP69]], align 4
; CLEANUP-CPS-NEXT:    [[TMP70:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 7
; CLEANUP-CPS-NEXT:    store i32 [[TMP15]], ptr addrspace(32) [[TMP70]], align 4
; CLEANUP-CPS-NEXT:    [[TMP71:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 8
; CLEANUP-CPS-NEXT:    store i32 [[TMP17]], ptr addrspace(32) [[TMP71]], align 4
; CLEANUP-CPS-NEXT:    [[TMP72:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 9
; CLEANUP-CPS-NEXT:    store i32 [[TMP19]], ptr addrspace(32) [[TMP72]], align 4
; CLEANUP-CPS-NEXT:    [[TMP73:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 10
; CLEANUP-CPS-NEXT:    store i32 [[TMP21]], ptr addrspace(32) [[TMP73]], align 4
; CLEANUP-CPS-NEXT:    [[TMP74:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 11
; CLEANUP-CPS-NEXT:    store i32 [[TMP23]], ptr addrspace(32) [[TMP74]], align 4
; CLEANUP-CPS-NEXT:    [[TMP75:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 12
; CLEANUP-CPS-NEXT:    store i32 [[TMP25]], ptr addrspace(32) [[TMP75]], align 4
; CLEANUP-CPS-NEXT:    [[TMP76:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 13
; CLEANUP-CPS-NEXT:    store i32 [[TMP27]], ptr addrspace(32) [[TMP76]], align 4
; CLEANUP-CPS-NEXT:    [[TMP77:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 14
; CLEANUP-CPS-NEXT:    store i32 [[TMP29]], ptr addrspace(32) [[TMP77]], align 4
; CLEANUP-CPS-NEXT:    [[TMP78:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 15
; CLEANUP-CPS-NEXT:    store i32 [[TMP31]], ptr addrspace(32) [[TMP78]], align 4
; CLEANUP-CPS-NEXT:    [[TMP79:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 16
; CLEANUP-CPS-NEXT:    store i32 [[TMP33]], ptr addrspace(32) [[TMP79]], align 4
; CLEANUP-CPS-NEXT:    [[TMP80:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 17
; CLEANUP-CPS-NEXT:    store i32 [[TMP35]], ptr addrspace(32) [[TMP80]], align 4
; CLEANUP-CPS-NEXT:    [[TMP81:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 18
; CLEANUP-CPS-NEXT:    store i32 [[TMP37]], ptr addrspace(32) [[TMP81]], align 4
; CLEANUP-CPS-NEXT:    [[TMP82:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 19
; CLEANUP-CPS-NEXT:    store i32 [[TMP39]], ptr addrspace(32) [[TMP82]], align 4
; CLEANUP-CPS-NEXT:    [[TMP83:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 20
; CLEANUP-CPS-NEXT:    store i32 [[TMP41]], ptr addrspace(32) [[TMP83]], align 4
; CLEANUP-CPS-NEXT:    [[TMP84:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 21
; CLEANUP-CPS-NEXT:    store i32 [[TMP43]], ptr addrspace(32) [[TMP84]], align 4
; CLEANUP-CPS-NEXT:    [[TMP85:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 22
; CLEANUP-CPS-NEXT:    store i32 [[TMP45]], ptr addrspace(32) [[TMP85]], align 4
; CLEANUP-CPS-NEXT:    [[TMP86:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 23
; CLEANUP-CPS-NEXT:    store i32 [[TMP47]], ptr addrspace(32) [[TMP86]], align 4
; CLEANUP-CPS-NEXT:    [[TMP87:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 24
; CLEANUP-CPS-NEXT:    store i32 [[TMP49]], ptr addrspace(32) [[TMP87]], align 4
; CLEANUP-CPS-NEXT:    [[TMP88:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 25
; CLEANUP-CPS-NEXT:    store i32 [[TMP51]], ptr addrspace(32) [[TMP88]], align 4
; CLEANUP-CPS-NEXT:    [[TMP89:%.*]] = getelementptr inbounds i32, ptr addrspace(32) [[TMP63]], i32 26
; CLEANUP-CPS-NEXT:    store i32 [[TMP53]], ptr addrspace(32) [[TMP89]], align 4
; CLEANUP-CPS-NEXT:    [[DOTFCA_0_INSERT54:%.*]] = insertvalue [30 x i32] poison, i32 [[TMP62]], 0
; CLEANUP-CPS-NEXT:    [[DOTFCA_1_INSERT57:%.*]] = insertvalue [30 x i32] [[DOTFCA_0_INSERT54]], i32 [[PAYLOAD_FCA_1_EXTRACT]], 1
; CLEANUP-CPS-NEXT:    [[DOTFCA_2_INSERT60:%.*]] = insertvalue [30 x i32] [[DOTFCA_1_INSERT57]], i32 [[PAYLOAD_FCA_2_EXTRACT]], 2
; CLEANUP-CPS-NEXT:    [[DOTFCA_3_INSERT63:%.*]] = insertvalue [30 x i32] [[DOTFCA_2_INSERT60]], i32 [[PAYLOAD_FCA_3_EXTRACT]], 3
; CLEANUP-CPS-NEXT:    [[DOTFCA_4_INSERT66:%.*]] = insertvalue [30 x i32] [[DOTFCA_3_INSERT63]], i32 [[PAYLOAD_FCA_4_EXTRACT]], 4
; CLEANUP-CPS-NEXT:    [[DOTFCA_5_INSERT69:%.*]] = insertvalue [30 x i32] [[DOTFCA_4_INSERT66]], i32 [[PAYLOAD_FCA_5_EXTRACT]], 5
; CLEANUP-CPS-NEXT:    [[DOTFCA_6_INSERT72:%.*]] = insertvalue [30 x i32] [[DOTFCA_5_INSERT69]], i32 [[PAYLOAD_FCA_6_EXTRACT]], 6
; CLEANUP-CPS-NEXT:    [[DOTFCA_7_INSERT75:%.*]] = insertvalue [30 x i32] [[DOTFCA_6_INSERT72]], i32 [[PAYLOAD_FCA_7_EXTRACT]], 7
; CLEANUP-CPS-NEXT:    [[DOTFCA_8_INSERT78:%.*]] = insertvalue [30 x i32] [[DOTFCA_7_INSERT75]], i32 [[PAYLOAD_FCA_8_EXTRACT]], 8
; CLEANUP-CPS-NEXT:    [[DOTFCA_9_INSERT81:%.*]] = insertvalue [30 x i32] [[DOTFCA_8_INSERT78]], i32 [[PAYLOAD_FCA_9_EXTRACT]], 9
; CLEANUP-CPS-NEXT:    [[DOTFCA_10_INSERT84:%.*]] = insertvalue [30 x i32] [[DOTFCA_9_INSERT81]], i32 [[PAYLOAD_FCA_10_EXTRACT]], 10
; CLEANUP-CPS-NEXT:    [[DOTFCA_11_INSERT87:%.*]] = insertvalue [30 x i32] [[DOTFCA_10_INSERT84]], i32 [[PAYLOAD_FCA_11_EXTRACT]], 11
; CLEANUP-CPS-NEXT:    [[DOTFCA_12_INSERT90:%.*]] = insertvalue [30 x i32] [[DOTFCA_11_INSERT87]], i32 [[PAYLOAD_FCA_12_EXTRACT]], 12
; CLEANUP-CPS-NEXT:    [[DOTFCA_13_INSERT93:%.*]] = insertvalue [30 x i32] [[DOTFCA_12_INSERT90]], i32 [[PAYLOAD_FCA_13_EXTRACT]], 13
; CLEANUP-CPS-NEXT:    [[DOTFCA_14_INSERT96:%.*]] = insertvalue [30 x i32] [[DOTFCA_13_INSERT93]], i32 [[PAYLOAD_FCA_14_EXTRACT]], 14
; CLEANUP-CPS-NEXT:    [[DOTFCA_15_INSERT99:%.*]] = insertvalue [30 x i32] [[DOTFCA_14_INSERT96]], i32 [[PAYLOAD_FCA_15_EXTRACT]], 15
; CLEANUP-CPS-NEXT:    [[DOTFCA_16_INSERT102:%.*]] = insertvalue [30 x i32] [[DOTFCA_15_INSERT99]], i32 [[PAYLOAD_FCA_16_EXTRACT]], 16
; CLEANUP-CPS-NEXT:    [[DOTFCA_17_INSERT105:%.*]] = insertvalue [30 x i32] [[DOTFCA_16_INSERT102]], i32 [[PAYLOAD_FCA_17_EXTRACT]], 17
; CLEANUP-CPS-NEXT:    [[DOTFCA_18_INSERT108:%.*]] = insertvalue [30 x i32] [[DOTFCA_17_INSERT105]], i32 [[PAYLOAD_FCA_18_EXTRACT]], 18
; CLEANUP-CPS-NEXT:    [[DOTFCA_19_INSERT111:%.*]] = insertvalue [30 x i32] [[DOTFCA_18_INSERT108]], i32 [[PAYLOAD_FCA_19_EXTRACT]], 19
; CLEANUP-CPS-NEXT:    [[DOTFCA_20_INSERT114:%.*]] = insertvalue [30 x i32] [[DOTFCA_19_INSERT111]], i32 [[PAYLOAD_FCA_20_EXTRACT]], 20
; CLEANUP-CPS-NEXT:    [[DOTFCA_21_INSERT117:%.*]] = insertvalue [30 x i32] [[DOTFCA_20_INSERT114]], i32 [[PAYLOAD_FCA_21_EXTRACT]], 21
; CLEANUP-CPS-NEXT:    [[DOTFCA_22_INSERT120:%.*]] = insertvalue [30 x i32] [[DOTFCA_21_INSERT117]], i32 [[PAYLOAD_FCA_22_EXTRACT]], 22
; CLEANUP-CPS-NEXT:    [[DOTFCA_23_INSERT123:%.*]] = insertvalue [30 x i32] [[DOTFCA_22_INSERT120]], i32 [[PAYLOAD_FCA_23_EXTRACT]], 23
; CLEANUP-CPS-NEXT:    [[DOTFCA_24_INSERT126:%.*]] = insertvalue [30 x i32] [[DOTFCA_23_INSERT123]], i32 [[PAYLOAD_FCA_24_EXTRACT]], 24
; CLEANUP-CPS-NEXT:    [[DOTFCA_25_INSERT129:%.*]] = insertvalue [30 x i32] [[DOTFCA_24_INSERT126]], i32 [[PAYLOAD_FCA_25_EXTRACT]], 25
; CLEANUP-CPS-NEXT:    [[DOTFCA_26_INSERT132:%.*]] = insertvalue [30 x i32] [[DOTFCA_25_INSERT129]], i32 [[PAYLOAD_FCA_26_EXTRACT]], 26
...
; CLEANUP-CPS-NEXT:    [[PAYLOAD_FCA_0_EXTRACT_RELOAD_ADDR:%.*]] = getelementptr inbounds [[CLOSESTHIT_FRAME]], ptr addrspace(32) [[TMP4]], i32 0, i32 2
...
;
;
; POST-PROCESS-CPS-LABEL: define %struct.BuiltInTriangleIntersectionAttributes @_cont_GetTriangleHitAttributes(
; POST-PROCESS-CPS-SAME: ptr [[DATA:%.*]]) #[[ATTR0:[0-9]+]] {
; POST-PROCESS-CPS-NEXT:    [[ADDR:%.*]] = getelementptr [[STRUCT_SYSTEMDATA:%.*]], ptr [[DATA]], i32 0, i32 1
; POST-PROCESS-CPS-NEXT:    [[VAL:%.*]] = load [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES:%.*]], ptr [[ADDR]], align 4
; POST-PROCESS-CPS-NEXT:    ret [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES]] [[VAL]]
;
;
; POST-PROCESS-CPS-LABEL: define i32 @_cont_GetLocalRootIndex(
; POST-PROCESS-CPS-SAME: ptr [[DATA:%.*]]) #[[ATTR0]] {
; POST-PROCESS-CPS-NEXT:    ret i32 5
;
;
; POST-PROCESS-CPS-LABEL: define void @main(
; POST-PROCESS-CPS-SAME: {} [[CONT_STATE:%.*]], i32 [[CSPINIT:%.*]], i32 [[RETURNADDR:%.*]], i32 [[SHADER_INDEX:%.*]], [[STRUCT_DISPATCHSYSTEMDATA:%.*]] [[TMP0:%.*]]) !lgc.rt.shaderstage [[META8:![0-9]+]] !lgc.cps [[META19:![0-9]+]] !continuation [[META20:![0-9]+]] !continuation.stacksize [[META21:![0-9]+]] {
...
; POST-PROCESS-CPS-NEXT:    [[TMP1:%.*]] = load i32, ptr [[CSP]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP2:%.*]] = add i32 [[TMP1]], 108
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP2]], ptr [[CSP]], align 4
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_EXTRACT56:%.*]] = extractvalue [[STRUCT_DISPATCHSYSTEMDATA]] [[TMP0]], 0
; POST-PROCESS-CPS-NEXT:    call void @amd.dx.setLocalRootIndex(i32 0)
; POST-PROCESS-CPS-NEXT:    [[TMP3:%.*]] = load [[DX_TYPES_HANDLE:%.*]], ptr @"\01?Scene@@3URaytracingAccelerationStructure@@A", align 4
; POST-PROCESS-CPS-NEXT:    [[TMP4:%.*]] = load [[DX_TYPES_HANDLE]], ptr @"\01?RenderTarget@@3V?$RWTexture2D@V?$vector@M$03@@@@A", align 4
; POST-PROCESS-CPS-NEXT:    [[TMP5:%.*]] = call [[DX_TYPES_HANDLE]] @[[DX_OP_CREATEHANDLEFORLIB_DX_TYPES_HANDLE:[a-zA-Z0-9_$\"\\.-]*[a-zA-Z_$\"\\.-][a-zA-Z0-9_$\"\\.-]*]](i32 160, [[DX_TYPES_HANDLE]] [[TMP3]])
; POST-PROCESS-CPS-NEXT:    [[TMP6:%.*]] = call [[DX_TYPES_HANDLE]] @[[DX_OP_ANNOTATEHANDLE:[a-zA-Z0-9_$\"\\.-]*[a-zA-Z_$\"\\.-][a-zA-Z0-9_$\"\\.-]*]](i32 216, [[DX_TYPES_HANDLE]] [[TMP5]], [[DX_TYPES_RESOURCEPROPERTIES:%.*]] { i32 16, i32 0 })
; POST-PROCESS-CPS-NEXT:    [[TMP7:%.*]] = call i64 @amd.dx.getAccelStructAddr([[DX_TYPES_HANDLE]] [[TMP6]])
; POST-PROCESS-CPS-NEXT:    [[DIS_DATA_I_FCA_0_INSERT:%.*]] = insertvalue [[STRUCT_DISPATCHSYSTEMDATA]] poison, <3 x i32> [[DOTFCA_0_EXTRACT56]], 0
; POST-PROCESS-CPS-NEXT:    [[SYS_DATA_I:%.*]] = insertvalue [[STRUCT_SYSTEMDATA:%.*]] undef, [[STRUCT_DISPATCHSYSTEMDATA]] [[DIS_DATA_I_FCA_0_INSERT]], 0
; POST-PROCESS-CPS-NEXT:    [[TRAV_DATA_I:%.*]] = insertvalue [[STRUCT_TRAVERSALDATA:%.*]] undef, [[STRUCT_SYSTEMDATA]] [[SYS_DATA_I]], 0
; POST-PROCESS-CPS-NEXT:    [[TMP8:%.*]] = call i64 @continuation.getAddrAndMD(ptr @main.resume.0)
; POST-PROCESS-CPS-NEXT:    [[TRAV_DATA2_I:%.*]] = insertvalue [[STRUCT_TRAVERSALDATA]] [[TRAV_DATA_I]], i64 [[TMP8]], 5
; POST-PROCESS-CPS-NEXT:    [[TMP9:%.*]] = inttoptr i32 [[TMP1]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP10:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP9]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP10]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP11:%.*]] = add i32 [[TMP1]], 4
; POST-PROCESS-CPS-NEXT:    [[TMP12:%.*]] = inttoptr i32 [[TMP11]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP13:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP12]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP13]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP14:%.*]] = add i32 [[TMP1]], 8
...
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP16]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP17:%.*]] = add i32 [[TMP1]], 12
; POST-PROCESS-CPS-NEXT:    [[TMP18:%.*]] = inttoptr i32 [[TMP17]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP19:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP18]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP19]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP20:%.*]] = add i32 [[TMP1]], 16
; POST-PROCESS-CPS-NEXT:    [[TMP21:%.*]] = inttoptr i32 [[TMP20]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP22:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP21]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP22]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP23:%.*]] = add i32 [[TMP1]], 20
; POST-PROCESS-CPS-NEXT:    [[TMP24:%.*]] = inttoptr i32 [[TMP23]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP25:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP24]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP25]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP26:%.*]] = add i32 [[TMP1]], 24
...
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP28]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP29:%.*]] = add i32 [[TMP1]], 28
; POST-PROCESS-CPS-NEXT:    [[TMP30:%.*]] = inttoptr i32 [[TMP29]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP31:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP30]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP31]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP32:%.*]] = add i32 [[TMP1]], 32
; POST-PROCESS-CPS-NEXT:    [[TMP33:%.*]] = inttoptr i32 [[TMP32]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP34:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP33]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP34]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP35:%.*]] = add i32 [[TMP1]], 36
; POST-PROCESS-CPS-NEXT:    [[TMP36:%.*]] = inttoptr i32 [[TMP35]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP37:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP36]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP37]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP38:%.*]] = add i32 [[TMP1]], 40
...
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP40]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP41:%.*]] = add i32 [[TMP1]], 44
; POST-PROCESS-CPS-NEXT:    [[TMP42:%.*]] = inttoptr i32 [[TMP41]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP43:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP42]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP43]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP44:%.*]] = add i32 [[TMP1]], 48
; POST-PROCESS-CPS-NEXT:    [[TMP45:%.*]] = inttoptr i32 [[TMP44]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP46:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP45]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP46]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP47:%.*]] = add i32 [[TMP1]], 52
; POST-PROCESS-CPS-NEXT:    [[TMP48:%.*]] = inttoptr i32 [[TMP47]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP49:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP48]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP49]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP50:%.*]] = add i32 [[TMP1]], 56
...
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP52]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP53:%.*]] = add i32 [[TMP1]], 60
; POST-PROCESS-CPS-NEXT:    [[TMP54:%.*]] = inttoptr i32 [[TMP53]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP55:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP54]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP55]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP56:%.*]] = add i32 [[TMP1]], 64
; POST-PROCESS-CPS-NEXT:    [[TMP57:%.*]] = inttoptr i32 [[TMP56]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP58:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP57]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP58]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP59:%.*]] = add i32 [[TMP1]], 68
; POST-PROCESS-CPS-NEXT:    [[TMP60:%.*]] = inttoptr i32 [[TMP59]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP61:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP60]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP61]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP62:%.*]] = add i32 [[TMP1]], 72
...
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP64]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP65:%.*]] = add i32 [[TMP1]], 76
; POST-PROCESS-CPS-NEXT:    [[TMP66:%.*]] = inttoptr i32 [[TMP65]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP67:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP66]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP67]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP68:%.*]] = add i32 [[TMP1]], 80
; POST-PROCESS-CPS-NEXT:    [[TMP69:%.*]] = inttoptr i32 [[TMP68]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP70:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP69]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP70]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP71:%.*]] = add i32 [[TMP1]], 84
; POST-PROCESS-CPS-NEXT:    [[TMP72:%.*]] = inttoptr i32 [[TMP71]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP73:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP72]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP73]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP74:%.*]] = add i32 [[TMP1]], 88
...
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP76]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP77:%.*]] = add i32 [[TMP1]], 92
; POST-PROCESS-CPS-NEXT:    [[TMP78:%.*]] = inttoptr i32 [[TMP77]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP79:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP78]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP79]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP80:%.*]] = add i32 [[TMP1]], 96
; POST-PROCESS-CPS-NEXT:    [[TMP81:%.*]] = inttoptr i32 [[TMP80]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP82:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP81]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP82]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP83:%.*]] = add i32 [[TMP1]], 100
; POST-PROCESS-CPS-NEXT:    [[TMP84:%.*]] = inttoptr i32 [[TMP83]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP85:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP84]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP85]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP86:%.*]] = add i32 [[TMP1]], 104
...
; POST-PROCESS-CPS-NEXT:    store i32 undef, ptr addrspace(21) [[TMP88]], align 4
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_INSERT:%.*]] = insertvalue [30 x i32] poison, i32 [[TMP1]], 0
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_1_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_0_INSERT]], i32 undef, 1
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_2_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_1_INSERT]], i32 undef, 2
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_3_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_2_INSERT]], i32 undef, 3
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_4_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_3_INSERT]], i32 undef, 4
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_5_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_4_INSERT]], i32 undef, 5
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_6_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_5_INSERT]], i32 undef, 6
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_7_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_6_INSERT]], i32 undef, 7
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_8_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_7_INSERT]], i32 undef, 8
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_9_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_8_INSERT]], i32 undef, 9
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_10_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_9_INSERT]], i32 undef, 10
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_11_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_10_INSERT]], i32 undef, 11
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_12_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_11_INSERT]], i32 undef, 12
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_13_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_12_INSERT]], i32 undef, 13
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_14_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_13_INSERT]], i32 undef, 14
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_15_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_14_INSERT]], i32 undef, 15
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_16_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_15_INSERT]], i32 undef, 16
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_17_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_16_INSERT]], i32 undef, 17
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_18_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_17_INSERT]], i32 undef, 18
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_19_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_18_INSERT]], i32 undef, 19
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_20_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_19_INSERT]], i32 undef, 20
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_21_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_20_INSERT]], i32 undef, 21
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_22_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_21_INSERT]], i32 undef, 22
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_23_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_22_INSERT]], i32 undef, 23
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_24_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_23_INSERT]], i32 undef, 24
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_25_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_24_INSERT]], i32 undef, 25
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_26_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_25_INSERT]], i32 undef, 26
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_27_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_26_INSERT]], i32 undef, 27
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_28_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_27_INSERT]], i32 undef, 28
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_29_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_28_INSERT]], i32 undef, 29
; POST-PROCESS-CPS-NEXT:    [[TMP89:%.*]] = load i32, ptr [[CSP]], align 4
; POST-PROCESS-CPS-NEXT:    call void (...) @lgc.ilcps.waitContinue(i64 4, i64 -1, i32 [[TMP89]], i64 [[TMP8]], [[STRUCT_TRAVERSALDATA]] [[TRAV_DATA2_I]], [10 x i32] poison, [30 x i32] [[DOTFCA_29_INSERT]])
; POST-PROCESS-CPS-NEXT:    unreachable
;
;
; POST-PROCESS-CPS-LABEL: define dso_local void @main.resume.0(
; POST-PROCESS-CPS-SAME: {} [[TMP0:%.*]], i32 [[CSPINIT:%.*]], i32 [[TMP1:%.*]], i32 [[TMP2:%.*]], { [[STRUCT_DISPATCHSYSTEMDATA:%.*]], [23 x i32], [30 x i32] } [[TMP3:%.*]]) !lgc.rt.shaderstage [[META8]] !lgc.cps [[META19]] !continuation [[META20]] {
; POST-PROCESS-CPS-NEXT:  entryresume.0:
; POST-PROCESS-CPS-NEXT:    [[CSP:%.*]] = alloca i32, align 4
; POST-PROCESS-CPS-NEXT:    store i32 [[CSPINIT]], ptr [[CSP]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP4:%.*]] = load i32, ptr [[CSP]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP5:%.*]] = add i32 [[TMP4]], -108
; POST-PROCESS-CPS-NEXT:    [[TMP6:%.*]] = extractvalue { [[STRUCT_DISPATCHSYSTEMDATA]], [23 x i32], [30 x i32] } [[TMP3]], 2
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 0
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_1_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 1
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_2_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 2
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_3_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 3
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_4_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 4
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_5_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 5
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_6_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 6
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_7_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 7
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_8_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 8
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_9_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 9
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_10_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 10
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_11_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 11
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_12_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 12
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_13_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 13
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_14_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 14
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_15_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 15
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_16_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 16
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_17_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 17
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_18_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 18
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_19_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 19
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_20_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 20
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_21_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 21
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_22_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 22
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_23_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 23
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_24_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 24
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_25_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 25
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_26_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 26
...
; POST-PROCESS-CPS-NEXT:    call void @amd.dx.setLocalRootIndex(i32 0)
; POST-PROCESS-CPS-NEXT:    [[TMP115:%.*]] = load i32, ptr [[CSP]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP116:%.*]] = add i32 [[TMP115]], -108
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP116]], ptr [[CSP]], align 4
; POST-PROCESS-CPS-NEXT:    ret void
;
;
; POST-PROCESS-CPS-LABEL: define void @AnyHit(
; POST-PROCESS-CPS-SAME: {} [[CONT_STATE:%.*]], i32 [[CSPINIT:%.*]], i32 [[RETURNADDR:%.*]], i32 [[SHADER_INDEX:%.*]], [[STRUCT_ANYHITTRAVERSALDATA:%.*]] [[SYSTEM_DATA:%.*]], [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES:%.*]] [[HIT_ATTRS:%.*]], [6 x i32] [[PADDING:%.*]], [30 x i32] [[PAYLOAD:%.*]]) #[[ATTR2:[0-9]+]] !lgc.rt.shaderstage [[META22:![0-9]+]] !lgc.cps [[META23:![0-9]+]] !continuation [[META24:![0-9]+]] {
; POST-PROCESS-CPS-NEXT:  AllocaSpillBB:
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_ALLOCA:%.*]] = alloca [[STRUCT_ANYHITTRAVERSALDATA]], align 8
; POST-PROCESS-CPS-NEXT:    [[CSP:%.*]] = alloca i32, align 4
; POST-PROCESS-CPS-NEXT:    store i32 [[CSPINIT]], ptr [[CSP]], align 4
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_0_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 0
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_1_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 1
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_2_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 2
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_3_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 3
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_4_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 4
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_5_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 5
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_6_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 6
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_7_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 7
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_8_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 8
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_9_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 9
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_10_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 10
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_11_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 11
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_12_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 12
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_13_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 13
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_14_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 14
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_15_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 15
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_16_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 16
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_17_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 17
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_18_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 18
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_19_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 19
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_20_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 20
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_21_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 21
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_22_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 22
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_23_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 23
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_24_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 24
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_25_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 25
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_26_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 26
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_27_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 27
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_28_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 28
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_29_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 29
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_0_0_0_EXTRACT:%.*]] = extractvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[SYSTEM_DATA]], 0, 0, 0, 0
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_0_0_0_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 0, i32 0, i32 0
; POST-PROCESS-CPS-NEXT:    store <3 x i32> [[SYSTEM_DATA_FCA_0_0_0_0_EXTRACT]], ptr [[SYSTEM_DATA_FCA_0_0_0_0_GEP]], align 4
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_0_1_0_EXTRACT:%.*]] = extractvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[SYSTEM_DATA]], 0, 0, 1, 0
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_0_1_0_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 0, i32 1, i32 0
; POST-PROCESS-CPS-NEXT:    store <2 x float> [[SYSTEM_DATA_FCA_0_0_1_0_EXTRACT]], ptr [[SYSTEM_DATA_FCA_0_0_1_0_GEP]], align 4
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_1_0_EXTRACT:%.*]] = extractvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[SYSTEM_DATA]], 0, 1, 0
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_1_0_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 1, i32 0
; POST-PROCESS-CPS-NEXT:    store float [[SYSTEM_DATA_FCA_0_1_0_EXTRACT]], ptr [[SYSTEM_DATA_FCA_0_1_0_GEP]], align 4
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_1_1_EXTRACT:%.*]] = extractvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[SYSTEM_DATA]], 0, 1, 1
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_1_1_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 1, i32 1
; POST-PROCESS-CPS-NEXT:    store i32 [[SYSTEM_DATA_FCA_0_1_1_EXTRACT]], ptr [[SYSTEM_DATA_FCA_0_1_1_GEP]], align 4
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_2_EXTRACT:%.*]] = extractvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[SYSTEM_DATA]], 0, 2
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_2_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 2
; POST-PROCESS-CPS-NEXT:    store <3 x float> [[SYSTEM_DATA_FCA_0_2_EXTRACT]], ptr [[SYSTEM_DATA_FCA_0_2_GEP]], align 4
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_3_EXTRACT:%.*]] = extractvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[SYSTEM_DATA]], 0, 3
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_3_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 3
; POST-PROCESS-CPS-NEXT:    store <3 x float> [[SYSTEM_DATA_FCA_0_3_EXTRACT]], ptr [[SYSTEM_DATA_FCA_0_3_GEP]], align 4
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_4_EXTRACT:%.*]] = extractvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[SYSTEM_DATA]], 0, 4
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_4_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 4
; POST-PROCESS-CPS-NEXT:    store float [[SYSTEM_DATA_FCA_0_4_EXTRACT]], ptr [[SYSTEM_DATA_FCA_0_4_GEP]], align 4
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_5_EXTRACT:%.*]] = extractvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[SYSTEM_DATA]], 0, 5
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_5_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 5
; POST-PROCESS-CPS-NEXT:    store i64 [[SYSTEM_DATA_FCA_0_5_EXTRACT]], ptr [[SYSTEM_DATA_FCA_0_5_GEP]], align 4
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_1_0_EXTRACT:%.*]] = extractvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[SYSTEM_DATA]], 1, 0
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_1_0_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 1, i32 0
; POST-PROCESS-CPS-NEXT:    store float [[SYSTEM_DATA_FCA_1_0_EXTRACT]], ptr [[SYSTEM_DATA_FCA_1_0_GEP]], align 4
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_1_1_EXTRACT:%.*]] = extractvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[SYSTEM_DATA]], 1, 1
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_1_1_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 1, i32 1
; POST-PROCESS-CPS-NEXT:    store i32 [[SYSTEM_DATA_FCA_1_1_EXTRACT]], ptr [[SYSTEM_DATA_FCA_1_1_GEP]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP0:%.*]] = inttoptr i32 [[PAYLOAD_FCA_0_EXTRACT]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP0]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP2:%.*]] = load i32, ptr addrspace(21) [[TMP1]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP3:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 4
; POST-PROCESS-CPS-NEXT:    [[TMP4:%.*]] = inttoptr i32 [[TMP3]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP4]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP6:%.*]] = load i32, ptr addrspace(21) [[TMP5]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP7:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 8
; POST-PROCESS-CPS-NEXT:    [[TMP8:%.*]] = inttoptr i32 [[TMP7]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP9:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP8]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP10:%.*]] = load i32, ptr addrspace(21) [[TMP9]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP11:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 12
; POST-PROCESS-CPS-NEXT:    [[TMP12:%.*]] = inttoptr i32 [[TMP11]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP13:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP12]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP14:%.*]] = load i32, ptr addrspace(21) [[TMP13]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP15:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 16
; POST-PROCESS-CPS-NEXT:    [[TMP16:%.*]] = inttoptr i32 [[TMP15]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP17:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP16]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP18:%.*]] = load i32, ptr addrspace(21) [[TMP17]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP19:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 20
; POST-PROCESS-CPS-NEXT:    [[TMP20:%.*]] = inttoptr i32 [[TMP19]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP21:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP20]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP22:%.*]] = load i32, ptr addrspace(21) [[TMP21]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP23:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 24
; POST-PROCESS-CPS-NEXT:    [[TMP24:%.*]] = inttoptr i32 [[TMP23]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP25:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP24]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP26:%.*]] = load i32, ptr addrspace(21) [[TMP25]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP27:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 28
; POST-PROCESS-CPS-NEXT:    [[TMP28:%.*]] = inttoptr i32 [[TMP27]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP29:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP28]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP30:%.*]] = load i32, ptr addrspace(21) [[TMP29]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP31:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 32
; POST-PROCESS-CPS-NEXT:    [[TMP32:%.*]] = inttoptr i32 [[TMP31]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP33:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP32]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP34:%.*]] = load i32, ptr addrspace(21) [[TMP33]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP35:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 36
; POST-PROCESS-CPS-NEXT:    [[TMP36:%.*]] = inttoptr i32 [[TMP35]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP37:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP36]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP38:%.*]] = load i32, ptr addrspace(21) [[TMP37]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP39:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 40
; POST-PROCESS-CPS-NEXT:    [[TMP40:%.*]] = inttoptr i32 [[TMP39]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP41:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP40]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP42:%.*]] = load i32, ptr addrspace(21) [[TMP41]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP43:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 44
; POST-PROCESS-CPS-NEXT:    [[TMP44:%.*]] = inttoptr i32 [[TMP43]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP45:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP44]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP46:%.*]] = load i32, ptr addrspace(21) [[TMP45]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP47:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 48
; POST-PROCESS-CPS-NEXT:    [[TMP48:%.*]] = inttoptr i32 [[TMP47]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP49:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP48]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP50:%.*]] = load i32, ptr addrspace(21) [[TMP49]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP51:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 52
; POST-PROCESS-CPS-NEXT:    [[TMP52:%.*]] = inttoptr i32 [[TMP51]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP53:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP52]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP54:%.*]] = load i32, ptr addrspace(21) [[TMP53]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP55:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 56
; POST-PROCESS-CPS-NEXT:    [[TMP56:%.*]] = inttoptr i32 [[TMP55]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP57:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP56]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP58:%.*]] = load i32, ptr addrspace(21) [[TMP57]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP59:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 60
; POST-PROCESS-CPS-NEXT:    [[TMP60:%.*]] = inttoptr i32 [[TMP59]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP61:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP60]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP62:%.*]] = load i32, ptr addrspace(21) [[TMP61]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP63:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 64
; POST-PROCESS-CPS-NEXT:    [[TMP64:%.*]] = inttoptr i32 [[TMP63]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP65:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP64]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP66:%.*]] = load i32, ptr addrspace(21) [[TMP65]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP67:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 68
; POST-PROCESS-CPS-NEXT:    [[TMP68:%.*]] = inttoptr i32 [[TMP67]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP69:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP68]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP70:%.*]] = load i32, ptr addrspace(21) [[TMP69]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP71:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 72
; POST-PROCESS-CPS-NEXT:    [[TMP72:%.*]] = inttoptr i32 [[TMP71]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP73:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP72]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP74:%.*]] = load i32, ptr addrspace(21) [[TMP73]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP75:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 76
; POST-PROCESS-CPS-NEXT:    [[TMP76:%.*]] = inttoptr i32 [[TMP75]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP77:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP76]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP78:%.*]] = load i32, ptr addrspace(21) [[TMP77]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP79:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 80
; POST-PROCESS-CPS-NEXT:    [[TMP80:%.*]] = inttoptr i32 [[TMP79]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP81:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP80]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP82:%.*]] = load i32, ptr addrspace(21) [[TMP81]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP83:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 84
; POST-PROCESS-CPS-NEXT:    [[TMP84:%.*]] = inttoptr i32 [[TMP83]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP85:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP84]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP86:%.*]] = load i32, ptr addrspace(21) [[TMP85]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP87:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 88
; POST-PROCESS-CPS-NEXT:    [[TMP88:%.*]] = inttoptr i32 [[TMP87]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP89:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP88]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP90:%.*]] = load i32, ptr addrspace(21) [[TMP89]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP91:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 92
; POST-PROCESS-CPS-NEXT:    [[TMP92:%.*]] = inttoptr i32 [[TMP91]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP93:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP92]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP94:%.*]] = load i32, ptr addrspace(21) [[TMP93]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP95:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 96
; POST-PROCESS-CPS-NEXT:    [[TMP96:%.*]] = inttoptr i32 [[TMP95]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP97:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP96]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP98:%.*]] = load i32, ptr addrspace(21) [[TMP97]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP99:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 100
; POST-PROCESS-CPS-NEXT:    [[TMP100:%.*]] = inttoptr i32 [[TMP99]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP101:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP100]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP102:%.*]] = load i32, ptr addrspace(21) [[TMP101]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP103:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 104
; POST-PROCESS-CPS-NEXT:    [[TMP104:%.*]] = inttoptr i32 [[TMP103]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP105:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP104]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP106:%.*]] = load i32, ptr addrspace(21) [[TMP105]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP107:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 0
; POST-PROCESS-CPS-NEXT:    [[ADDR_I:%.*]] = getelementptr [[STRUCT_SYSTEMDATA:%.*]], ptr [[TMP107]], i32 0, i32 1
; POST-PROCESS-CPS-NEXT:    [[VAL_I_FCA_0_GEP:%.*]] = getelementptr inbounds [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES]], ptr [[ADDR_I]], i32 0, i32 0
; POST-PROCESS-CPS-NEXT:    [[VAL_I_FCA_0_LOAD:%.*]] = load <2 x float>, ptr [[VAL_I_FCA_0_GEP]], align 4
; POST-PROCESS-CPS-NEXT:    [[VAL_I_FCA_0_INSERT:%.*]] = insertvalue [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES]] poison, <2 x float> [[VAL_I_FCA_0_LOAD]], 0
; POST-PROCESS-CPS-NEXT:    [[VAL_I_FCA_0_INSERT_FCA_0_EXTRACT:%.*]] = extractvalue [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES]] [[VAL_I_FCA_0_INSERT]], 0
; POST-PROCESS-CPS-NEXT:    [[DOTSROA_025_0_VEC_EXTRACT:%.*]] = extractelement <2 x float> [[VAL_I_FCA_0_INSERT_FCA_0_EXTRACT]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP108:%.*]] = bitcast float [[DOTSROA_025_0_VEC_EXTRACT]] to i32
; POST-PROCESS-CPS-NEXT:    [[DOTSROA_025_4_VEC_EXTRACT:%.*]] = extractelement <2 x float> [[VAL_I_FCA_0_INSERT_FCA_0_EXTRACT]], i32 1
; POST-PROCESS-CPS-NEXT:    [[TMP109:%.*]] = bitcast float [[DOTSROA_025_4_VEC_EXTRACT]] to i32
; POST-PROCESS-CPS-NEXT:    [[HIT_ATTRS_FCA_0_EXTRACT:%.*]] = extractvalue [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES]] [[HIT_ATTRS]], 0
; POST-PROCESS-CPS-NEXT:    call void @amd.dx.setLocalRootIndex(i32 [[SHADER_INDEX]])
; POST-PROCESS-CPS-NEXT:    call void @_cont_AcceptHit(ptr [[SYSTEM_DATA_ALLOCA]])
; POST-PROCESS-CPS-NEXT:    [[TMP110:%.*]] = inttoptr i32 [[PAYLOAD_FCA_0_EXTRACT]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP111:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP110]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP2]], ptr addrspace(21) [[TMP111]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP112:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 4
; POST-PROCESS-CPS-NEXT:    [[TMP113:%.*]] = inttoptr i32 [[TMP112]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP114:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP113]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP6]], ptr addrspace(21) [[TMP114]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP115:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 8
...
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP10]], ptr addrspace(21) [[TMP117]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP118:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 12
...
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP14]], ptr addrspace(21) [[TMP120]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP121:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 16
; POST-PROCESS-CPS-NEXT:    [[TMP122:%.*]] = inttoptr i32 [[TMP121]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP123:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP122]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP18]], ptr addrspace(21) [[TMP123]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP124:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 20
; POST-PROCESS-CPS-NEXT:    [[TMP125:%.*]] = inttoptr i32 [[TMP124]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP126:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP125]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP22]], ptr addrspace(21) [[TMP126]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP127:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 24
; POST-PROCESS-CPS-NEXT:    [[TMP128:%.*]] = inttoptr i32 [[TMP127]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP129:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP128]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP26]], ptr addrspace(21) [[TMP129]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP130:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 28
; POST-PROCESS-CPS-NEXT:    [[TMP131:%.*]] = inttoptr i32 [[TMP130]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP132:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP131]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP30]], ptr addrspace(21) [[TMP132]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP133:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 32
; POST-PROCESS-CPS-NEXT:    [[TMP134:%.*]] = inttoptr i32 [[TMP133]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP135:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP134]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP34]], ptr addrspace(21) [[TMP135]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP136:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 36
; POST-PROCESS-CPS-NEXT:    [[TMP137:%.*]] = inttoptr i32 [[TMP136]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP138:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP137]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP38]], ptr addrspace(21) [[TMP138]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP139:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 40
; POST-PROCESS-CPS-NEXT:    [[TMP140:%.*]] = inttoptr i32 [[TMP139]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP141:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP140]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP42]], ptr addrspace(21) [[TMP141]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP142:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 44
; POST-PROCESS-CPS-NEXT:    [[TMP143:%.*]] = inttoptr i32 [[TMP142]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP144:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP143]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP46]], ptr addrspace(21) [[TMP144]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP145:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 48
; POST-PROCESS-CPS-NEXT:    [[TMP146:%.*]] = inttoptr i32 [[TMP145]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP147:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP146]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP50]], ptr addrspace(21) [[TMP147]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP148:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 52
; POST-PROCESS-CPS-NEXT:    [[TMP149:%.*]] = inttoptr i32 [[TMP148]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP150:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP149]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP54]], ptr addrspace(21) [[TMP150]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP151:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 56
; POST-PROCESS-CPS-NEXT:    [[TMP152:%.*]] = inttoptr i32 [[TMP151]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP153:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP152]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP58]], ptr addrspace(21) [[TMP153]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP154:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 60
; POST-PROCESS-CPS-NEXT:    [[TMP155:%.*]] = inttoptr i32 [[TMP154]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP156:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP155]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP62]], ptr addrspace(21) [[TMP156]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP157:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 64
; POST-PROCESS-CPS-NEXT:    [[TMP158:%.*]] = inttoptr i32 [[TMP157]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP159:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP158]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP66]], ptr addrspace(21) [[TMP159]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP160:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 68
; POST-PROCESS-CPS-NEXT:    [[TMP161:%.*]] = inttoptr i32 [[TMP160]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP162:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP161]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP70]], ptr addrspace(21) [[TMP162]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP163:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 72
; POST-PROCESS-CPS-NEXT:    [[TMP164:%.*]] = inttoptr i32 [[TMP163]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP165:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP164]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP74]], ptr addrspace(21) [[TMP165]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP166:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 76
; POST-PROCESS-CPS-NEXT:    [[TMP167:%.*]] = inttoptr i32 [[TMP166]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP168:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP167]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP78]], ptr addrspace(21) [[TMP168]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP169:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 80
; POST-PROCESS-CPS-NEXT:    [[TMP170:%.*]] = inttoptr i32 [[TMP169]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP171:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP170]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP82]], ptr addrspace(21) [[TMP171]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP172:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 84
; POST-PROCESS-CPS-NEXT:    [[TMP173:%.*]] = inttoptr i32 [[TMP172]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP174:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP173]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP86]], ptr addrspace(21) [[TMP174]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP175:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 88
; POST-PROCESS-CPS-NEXT:    [[TMP176:%.*]] = inttoptr i32 [[TMP175]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP177:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP176]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP90]], ptr addrspace(21) [[TMP177]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP178:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 92
; POST-PROCESS-CPS-NEXT:    [[TMP179:%.*]] = inttoptr i32 [[TMP178]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP180:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP179]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP94]], ptr addrspace(21) [[TMP180]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP181:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 96
; POST-PROCESS-CPS-NEXT:    [[TMP182:%.*]] = inttoptr i32 [[TMP181]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP183:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP182]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP98]], ptr addrspace(21) [[TMP183]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP184:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 100
; POST-PROCESS-CPS-NEXT:    [[TMP185:%.*]] = inttoptr i32 [[TMP184]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP186:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP185]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP102]], ptr addrspace(21) [[TMP186]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP187:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 104
; POST-PROCESS-CPS-NEXT:    [[TMP188:%.*]] = inttoptr i32 [[TMP187]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP189:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP188]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP106]], ptr addrspace(21) [[TMP189]], align 4
; POST-PROCESS-CPS-NEXT:    [[HITATTRSALLOCA_SROA_0_0_VEC_EXTRACT:%.*]] = extractelement <2 x float> [[HIT_ATTRS_FCA_0_EXTRACT]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP190:%.*]] = bitcast float [[HITATTRSALLOCA_SROA_0_0_VEC_EXTRACT]] to i32
; POST-PROCESS-CPS-NEXT:    [[TMP191:%.*]] = bitcast i32 [[TMP190]] to float
; POST-PROCESS-CPS-NEXT:    [[DOTSROA_027_0_VEC_INSERT:%.*]] = insertelement <2 x float> undef, float [[TMP191]], i32 0
; POST-PROCESS-CPS-NEXT:    [[HITATTRSALLOCA_SROA_0_4_VEC_EXTRACT:%.*]] = extractelement <2 x float> [[HIT_ATTRS_FCA_0_EXTRACT]], i32 1
; POST-PROCESS-CPS-NEXT:    [[TMP192:%.*]] = bitcast float [[HITATTRSALLOCA_SROA_0_4_VEC_EXTRACT]] to i32
; POST-PROCESS-CPS-NEXT:    [[TMP193:%.*]] = bitcast i32 [[TMP192]] to float
; POST-PROCESS-CPS-NEXT:    [[DOTSROA_027_4_VEC_INSERT:%.*]] = insertelement <2 x float> [[DOTSROA_027_0_VEC_INSERT]], float [[TMP193]], i32 1
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_INSERT26:%.*]] = insertvalue [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES]] poison, <2 x float> [[DOTSROA_027_4_VEC_INSERT]], 0
; POST-PROCESS-CPS-NEXT:    [[TMP194:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 0
; POST-PROCESS-CPS-NEXT:    call void @_cont_SetTriangleHitAttributes(ptr [[TMP194]], [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES]] [[DOTFCA_0_INSERT26]])
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_0_0_0_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 0, i32 0, i32 0
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_0_0_0_LOAD:%.*]] = load <3 x i32>, ptr [[DOTFCA_0_0_0_0_GEP]], align 4
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_0_0_0_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] poison, <3 x i32> [[DOTFCA_0_0_0_0_LOAD]], 0, 0, 0, 0
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_0_1_0_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 0, i32 1, i32 0
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_0_1_0_LOAD:%.*]] = load <2 x float>, ptr [[DOTFCA_0_0_1_0_GEP]], align 4
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_0_1_0_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_0_0_0_0_INSERT]], <2 x float> [[DOTFCA_0_0_1_0_LOAD]], 0, 0, 1, 0
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_1_0_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 1, i32 0
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_1_0_LOAD:%.*]] = load float, ptr [[DOTFCA_0_1_0_GEP]], align 4
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_1_0_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_0_0_1_0_INSERT]], float [[DOTFCA_0_1_0_LOAD]], 0, 1, 0
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_1_1_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 1, i32 1
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_1_1_LOAD:%.*]] = load i32, ptr [[DOTFCA_0_1_1_GEP]], align 4
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_1_1_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_0_1_0_INSERT]], i32 [[DOTFCA_0_1_1_LOAD]], 0, 1, 1
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_2_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 2
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_2_LOAD:%.*]] = load <3 x float>, ptr [[DOTFCA_0_2_GEP]], align 4
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_2_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_0_1_1_INSERT]], <3 x float> [[DOTFCA_0_2_LOAD]], 0, 2
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_3_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 3
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_3_LOAD:%.*]] = load <3 x float>, ptr [[DOTFCA_0_3_GEP]], align 4
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_3_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_0_2_INSERT]], <3 x float> [[DOTFCA_0_3_LOAD]], 0, 3
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_4_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 4
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_4_LOAD:%.*]] = load float, ptr [[DOTFCA_0_4_GEP]], align 4
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_4_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_0_3_INSERT]], float [[DOTFCA_0_4_LOAD]], 0, 4
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_5_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 5
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_5_LOAD:%.*]] = load i64, ptr [[DOTFCA_0_5_GEP]], align 4
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_5_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_0_4_INSERT]], i64 [[DOTFCA_0_5_LOAD]], 0, 5
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_1_0_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 1, i32 0
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_1_0_LOAD:%.*]] = load float, ptr [[DOTFCA_1_0_GEP]], align 4
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_1_0_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_0_5_INSERT]], float [[DOTFCA_1_0_LOAD]], 1, 0
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_1_1_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 1, i32 1
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_1_1_LOAD:%.*]] = load i32, ptr [[DOTFCA_1_1_GEP]], align 4
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_1_1_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_1_0_INSERT]], i32 [[DOTFCA_1_1_LOAD]], 1, 1
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_INSERT:%.*]] = insertvalue [30 x i32] poison, i32 [[PAYLOAD_FCA_0_EXTRACT]], 0
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_1_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_0_INSERT]], i32 [[PAYLOAD_FCA_1_EXTRACT]], 1
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_2_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_1_INSERT]], i32 [[PAYLOAD_FCA_2_EXTRACT]], 2
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_3_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_2_INSERT]], i32 [[PAYLOAD_FCA_3_EXTRACT]], 3
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_4_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_3_INSERT]], i32 [[PAYLOAD_FCA_4_EXTRACT]], 4
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_5_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_4_INSERT]], i32 [[PAYLOAD_FCA_5_EXTRACT]], 5
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_6_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_5_INSERT]], i32 [[PAYLOAD_FCA_6_EXTRACT]], 6
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_7_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_6_INSERT]], i32 [[PAYLOAD_FCA_7_EXTRACT]], 7
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_8_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_7_INSERT]], i32 [[PAYLOAD_FCA_8_EXTRACT]], 8
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_9_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_8_INSERT]], i32 [[PAYLOAD_FCA_9_EXTRACT]], 9
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_10_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_9_INSERT]], i32 [[PAYLOAD_FCA_10_EXTRACT]], 10
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_11_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_10_INSERT]], i32 [[PAYLOAD_FCA_11_EXTRACT]], 11
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_12_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_11_INSERT]], i32 [[PAYLOAD_FCA_12_EXTRACT]], 12
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_13_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_12_INSERT]], i32 [[PAYLOAD_FCA_13_EXTRACT]], 13
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_14_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_13_INSERT]], i32 [[PAYLOAD_FCA_14_EXTRACT]], 14
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_15_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_14_INSERT]], i32 [[PAYLOAD_FCA_15_EXTRACT]], 15
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_16_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_15_INSERT]], i32 [[PAYLOAD_FCA_16_EXTRACT]], 16
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_17_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_16_INSERT]], i32 [[PAYLOAD_FCA_17_EXTRACT]], 17
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_18_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_17_INSERT]], i32 [[PAYLOAD_FCA_18_EXTRACT]], 18
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_19_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_18_INSERT]], i32 [[PAYLOAD_FCA_19_EXTRACT]], 19
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_20_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_19_INSERT]], i32 [[PAYLOAD_FCA_20_EXTRACT]], 20
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_21_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_20_INSERT]], i32 [[PAYLOAD_FCA_21_EXTRACT]], 21
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_22_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_21_INSERT]], i32 [[PAYLOAD_FCA_22_EXTRACT]], 22
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_23_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_22_INSERT]], i32 [[PAYLOAD_FCA_23_EXTRACT]], 23
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_24_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_23_INSERT]], i32 [[PAYLOAD_FCA_24_EXTRACT]], 24
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_25_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_24_INSERT]], i32 [[PAYLOAD_FCA_25_EXTRACT]], 25
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_26_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_25_INSERT]], i32 [[PAYLOAD_FCA_26_EXTRACT]], 26
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_27_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_26_INSERT]], i32 [[PAYLOAD_FCA_27_EXTRACT]], 27
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_28_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_27_INSERT]], i32 [[PAYLOAD_FCA_28_EXTRACT]], 28
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_29_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_28_INSERT]], i32 [[PAYLOAD_FCA_29_EXTRACT]], 29
; POST-PROCESS-CPS-NEXT:    [[TMP195:%.*]] = zext i32 [[RETURNADDR]] to i64
; POST-PROCESS-CPS-NEXT:    [[TMP196:%.*]] = load i32, ptr [[CSP]], align 4
; POST-PROCESS-CPS-NEXT:    call void (...) @lgc.ilcps.continue(i64 [[TMP195]], i32 [[TMP196]], i64 poison, i32 poison, [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_1_1_INSERT]], [8 x i32] poison, [30 x i32] [[DOTFCA_29_INSERT]])
; POST-PROCESS-CPS-NEXT:    unreachable
;
;
...
; POST-PROCESS-CPS-NEXT:    [[CSP:%.*]] = alloca i32, align 4
; POST-PROCESS-CPS-NEXT:    store i32 [[CSPINIT]], ptr [[CSP]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP0:%.*]] = load i32, ptr [[CSP]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP1:%.*]] = add i32 [[TMP0]], 116
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP1]], ptr [[CSP]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP2:%.*]] = add i32 [[TMP0]], 108
; POST-PROCESS-CPS-NEXT:    [[TMP3:%.*]] = inttoptr i32 [[TMP2]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP3]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[RETURNADDR]], ptr addrspace(21) [[TMP4]], align 4
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_0_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 0
; POST-PROCESS-CPS-NEXT:    [[TMP5:%.*]] = add i32 [[TMP0]], 112
; POST-PROCESS-CPS-NEXT:    [[TMP6:%.*]] = inttoptr i32 [[TMP5]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP7:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP6]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[PAYLOAD_FCA_0_EXTRACT]], ptr addrspace(21) [[TMP7]], align 4
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_1_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 1
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_2_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 2
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_3_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 3
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_4_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 4
...
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_28_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 28
; POST-PROCESS-CPS-NEXT:    [[PAYLOAD_FCA_29_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 29
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_0_EXTRACT:%.*]] = extractvalue [[STRUCT_SYSTEMDATA]] [[SYSTEM_DATA]], 0, 0
; POST-PROCESS-CPS-NEXT:    [[SYSTEM_DATA_FCA_1_0_EXTRACT:%.*]] = extractvalue [[STRUCT_SYSTEMDATA]] [[SYSTEM_DATA]], 1, 0
; POST-PROCESS-CPS-NEXT:    [[TMP8:%.*]] = inttoptr i32 [[PAYLOAD_FCA_0_EXTRACT]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP9:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP8]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP10:%.*]] = load i32, ptr addrspace(21) [[TMP9]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP11:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 4
; POST-PROCESS-CPS-NEXT:    [[TMP12:%.*]] = inttoptr i32 [[TMP11]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP13:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP12]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP14:%.*]] = load i32, ptr addrspace(21) [[TMP13]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP15:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 8
; POST-PROCESS-CPS-NEXT:    [[TMP16:%.*]] = inttoptr i32 [[TMP15]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP17:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP16]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP18:%.*]] = load i32, ptr addrspace(21) [[TMP17]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP19:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 12
; POST-PROCESS-CPS-NEXT:    [[TMP20:%.*]] = inttoptr i32 [[TMP19]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP21:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP20]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP22:%.*]] = load i32, ptr addrspace(21) [[TMP21]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP23:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 16
; POST-PROCESS-CPS-NEXT:    [[TMP24:%.*]] = inttoptr i32 [[TMP23]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP25:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP24]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP26:%.*]] = load i32, ptr addrspace(21) [[TMP25]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP27:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 20
; POST-PROCESS-CPS-NEXT:    [[TMP28:%.*]] = inttoptr i32 [[TMP27]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP29:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP28]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP30:%.*]] = load i32, ptr addrspace(21) [[TMP29]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP31:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 24
; POST-PROCESS-CPS-NEXT:    [[TMP32:%.*]] = inttoptr i32 [[TMP31]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP33:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP32]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP34:%.*]] = load i32, ptr addrspace(21) [[TMP33]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP35:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 28
; POST-PROCESS-CPS-NEXT:    [[TMP36:%.*]] = inttoptr i32 [[TMP35]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP37:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP36]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP38:%.*]] = load i32, ptr addrspace(21) [[TMP37]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP39:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 32
; POST-PROCESS-CPS-NEXT:    [[TMP40:%.*]] = inttoptr i32 [[TMP39]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP41:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP40]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP42:%.*]] = load i32, ptr addrspace(21) [[TMP41]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP43:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 36
; POST-PROCESS-CPS-NEXT:    [[TMP44:%.*]] = inttoptr i32 [[TMP43]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP45:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP44]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP46:%.*]] = load i32, ptr addrspace(21) [[TMP45]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP47:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 40
; POST-PROCESS-CPS-NEXT:    [[TMP48:%.*]] = inttoptr i32 [[TMP47]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP49:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP48]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP50:%.*]] = load i32, ptr addrspace(21) [[TMP49]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP51:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 44
; POST-PROCESS-CPS-NEXT:    [[TMP52:%.*]] = inttoptr i32 [[TMP51]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP53:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP52]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP54:%.*]] = load i32, ptr addrspace(21) [[TMP53]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP55:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 48
; POST-PROCESS-CPS-NEXT:    [[TMP56:%.*]] = inttoptr i32 [[TMP55]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP57:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP56]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP58:%.*]] = load i32, ptr addrspace(21) [[TMP57]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP59:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 52
; POST-PROCESS-CPS-NEXT:    [[TMP60:%.*]] = inttoptr i32 [[TMP59]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP61:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP60]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP62:%.*]] = load i32, ptr addrspace(21) [[TMP61]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP63:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 56
; POST-PROCESS-CPS-NEXT:    [[TMP64:%.*]] = inttoptr i32 [[TMP63]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP65:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP64]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP66:%.*]] = load i32, ptr addrspace(21) [[TMP65]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP67:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 60
; POST-PROCESS-CPS-NEXT:    [[TMP68:%.*]] = inttoptr i32 [[TMP67]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP69:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP68]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP70:%.*]] = load i32, ptr addrspace(21) [[TMP69]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP71:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 64
; POST-PROCESS-CPS-NEXT:    [[TMP72:%.*]] = inttoptr i32 [[TMP71]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP73:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP72]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP74:%.*]] = load i32, ptr addrspace(21) [[TMP73]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP75:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 68
; POST-PROCESS-CPS-NEXT:    [[TMP76:%.*]] = inttoptr i32 [[TMP75]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP77:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP76]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP78:%.*]] = load i32, ptr addrspace(21) [[TMP77]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP79:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 72
; POST-PROCESS-CPS-NEXT:    [[TMP80:%.*]] = inttoptr i32 [[TMP79]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP81:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP80]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP82:%.*]] = load i32, ptr addrspace(21) [[TMP81]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP83:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 76
; POST-PROCESS-CPS-NEXT:    [[TMP84:%.*]] = inttoptr i32 [[TMP83]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP85:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP84]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP86:%.*]] = load i32, ptr addrspace(21) [[TMP85]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP87:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 80
; POST-PROCESS-CPS-NEXT:    [[TMP88:%.*]] = inttoptr i32 [[TMP87]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP89:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP88]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP90:%.*]] = load i32, ptr addrspace(21) [[TMP89]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP91:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 84
; POST-PROCESS-CPS-NEXT:    [[TMP92:%.*]] = inttoptr i32 [[TMP91]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP93:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP92]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP94:%.*]] = load i32, ptr addrspace(21) [[TMP93]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP95:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 88
; POST-PROCESS-CPS-NEXT:    [[TMP96:%.*]] = inttoptr i32 [[TMP95]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP97:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP96]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP98:%.*]] = load i32, ptr addrspace(21) [[TMP97]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP99:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 92
; POST-PROCESS-CPS-NEXT:    [[TMP100:%.*]] = inttoptr i32 [[TMP99]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP101:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP100]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP102:%.*]] = load i32, ptr addrspace(21) [[TMP101]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP103:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 96
; POST-PROCESS-CPS-NEXT:    [[TMP104:%.*]] = inttoptr i32 [[TMP103]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP105:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP104]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP106:%.*]] = load i32, ptr addrspace(21) [[TMP105]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP107:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 100
; POST-PROCESS-CPS-NEXT:    [[TMP108:%.*]] = inttoptr i32 [[TMP107]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP109:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP108]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP110:%.*]] = load i32, ptr addrspace(21) [[TMP109]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP111:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 104
; POST-PROCESS-CPS-NEXT:    [[TMP112:%.*]] = inttoptr i32 [[TMP111]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP113:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP112]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP114:%.*]] = load i32, ptr addrspace(21) [[TMP113]], align 4
; POST-PROCESS-CPS-NEXT:    [[VAL_I_FCA_0_INSERT:%.*]] = insertvalue [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES:%.*]] poison, <2 x float> [[SYSTEM_DATA_FCA_1_0_EXTRACT]], 0
; POST-PROCESS-CPS-NEXT:    [[VAL_I_FCA_0_INSERT_FCA_0_EXTRACT:%.*]] = extractvalue [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES]] [[VAL_I_FCA_0_INSERT]], 0
; POST-PROCESS-CPS-NEXT:    [[DOTSROA_0257_0_VEC_EXTRACT:%.*]] = extractelement <2 x float> [[VAL_I_FCA_0_INSERT_FCA_0_EXTRACT]], i32 0
; POST-PROCESS-CPS-NEXT:    [[TMP115:%.*]] = bitcast float [[DOTSROA_0257_0_VEC_EXTRACT]] to i32
; POST-PROCESS-CPS-NEXT:    [[DOTSROA_0257_4_VEC_EXTRACT:%.*]] = extractelement <2 x float> [[VAL_I_FCA_0_INSERT_FCA_0_EXTRACT]], i32 1
; POST-PROCESS-CPS-NEXT:    [[TMP116:%.*]] = bitcast float [[DOTSROA_0257_4_VEC_EXTRACT]] to i32
; POST-PROCESS-CPS-NEXT:    call void @amd.dx.setLocalRootIndex(i32 [[SHADER_INDEX]])
; POST-PROCESS-CPS-NEXT:    [[TMP117:%.*]] = load [[DX_TYPES_HANDLE:%.*]], ptr @"\01?Scene@@3URaytracingAccelerationStructure@@A", align 4
; POST-PROCESS-CPS-NEXT:    [[TMP118:%.*]] = load [[DX_TYPES_HANDLE]], ptr @"\01?RenderTarget@@3V?$RWTexture2D@V?$vector@M$03@@@@A", align 4
; POST-PROCESS-CPS-NEXT:    [[TMP119:%.*]] = call [[DX_TYPES_HANDLE]] @[[DX_OP_CREATEHANDLEFORLIB_DX_TYPES_HANDLE]](i32 160, [[DX_TYPES_HANDLE]] [[TMP117]])
; POST-PROCESS-CPS-NEXT:    [[TMP120:%.*]] = call [[DX_TYPES_HANDLE]] @[[DX_OP_ANNOTATEHANDLE]](i32 216, [[DX_TYPES_HANDLE]] [[TMP119]], [[DX_TYPES_RESOURCEPROPERTIES:%.*]] { i32 16, i32 0 })
; POST-PROCESS-CPS-NEXT:    [[TMP121:%.*]] = call i64 @amd.dx.getAccelStructAddr([[DX_TYPES_HANDLE]] [[TMP120]])
; POST-PROCESS-CPS-NEXT:    [[DIS_DATA_I_FCA_0_INSERT:%.*]] = insertvalue [[STRUCT_DISPATCHSYSTEMDATA:%.*]] poison, <3 x i32> [[SYSTEM_DATA_FCA_0_0_EXTRACT]], 0
; POST-PROCESS-CPS-NEXT:    [[SYS_DATA_I:%.*]] = insertvalue [[STRUCT_SYSTEMDATA]] undef, [[STRUCT_DISPATCHSYSTEMDATA]] [[DIS_DATA_I_FCA_0_INSERT]], 0
; POST-PROCESS-CPS-NEXT:    [[TRAV_DATA_I:%.*]] = insertvalue [[STRUCT_TRAVERSALDATA:%.*]] undef, [[STRUCT_SYSTEMDATA]] [[SYS_DATA_I]], 0
; POST-PROCESS-CPS-NEXT:    [[TMP122:%.*]] = call i64 @continuation.getAddrAndMD(ptr @ClosestHit.resume.0)
; POST-PROCESS-CPS-NEXT:    [[TRAV_DATA2_I:%.*]] = insertvalue [[STRUCT_TRAVERSALDATA]] [[TRAV_DATA_I]], i64 [[TMP122]], 5
; POST-PROCESS-CPS-NEXT:    [[TMP123:%.*]] = inttoptr i32 [[TMP0]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP124:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP123]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP10]], ptr addrspace(21) [[TMP124]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP125:%.*]] = add i32 [[TMP0]], 4
; POST-PROCESS-CPS-NEXT:    [[TMP126:%.*]] = inttoptr i32 [[TMP125]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP127:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP126]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP14]], ptr addrspace(21) [[TMP127]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP128:%.*]] = add i32 [[TMP0]], 8
; POST-PROCESS-CPS-NEXT:    [[TMP129:%.*]] = inttoptr i32 [[TMP128]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP130:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP129]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP18]], ptr addrspace(21) [[TMP130]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP131:%.*]] = add i32 [[TMP0]], 12
; POST-PROCESS-CPS-NEXT:    [[TMP132:%.*]] = inttoptr i32 [[TMP131]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP133:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP132]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP22]], ptr addrspace(21) [[TMP133]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP134:%.*]] = add i32 [[TMP0]], 16
; POST-PROCESS-CPS-NEXT:    [[TMP135:%.*]] = inttoptr i32 [[TMP134]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP136:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP135]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP26]], ptr addrspace(21) [[TMP136]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP137:%.*]] = add i32 [[TMP0]], 20
; POST-PROCESS-CPS-NEXT:    [[TMP138:%.*]] = inttoptr i32 [[TMP137]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP139:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP138]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP30]], ptr addrspace(21) [[TMP139]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP140:%.*]] = add i32 [[TMP0]], 24
; POST-PROCESS-CPS-NEXT:    [[TMP141:%.*]] = inttoptr i32 [[TMP140]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP142:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP141]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP34]], ptr addrspace(21) [[TMP142]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP143:%.*]] = add i32 [[TMP0]], 28
; POST-PROCESS-CPS-NEXT:    [[TMP144:%.*]] = inttoptr i32 [[TMP143]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP145:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP144]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP38]], ptr addrspace(21) [[TMP145]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP146:%.*]] = add i32 [[TMP0]], 32
; POST-PROCESS-CPS-NEXT:    [[TMP147:%.*]] = inttoptr i32 [[TMP146]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP148:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP147]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP42]], ptr addrspace(21) [[TMP148]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP149:%.*]] = add i32 [[TMP0]], 36
; POST-PROCESS-CPS-NEXT:    [[TMP150:%.*]] = inttoptr i32 [[TMP149]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP151:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP150]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP46]], ptr addrspace(21) [[TMP151]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP152:%.*]] = add i32 [[TMP0]], 40
; POST-PROCESS-CPS-NEXT:    [[TMP153:%.*]] = inttoptr i32 [[TMP152]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP154:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP153]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP50]], ptr addrspace(21) [[TMP154]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP155:%.*]] = add i32 [[TMP0]], 44
; POST-PROCESS-CPS-NEXT:    [[TMP156:%.*]] = inttoptr i32 [[TMP155]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP157:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP156]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP54]], ptr addrspace(21) [[TMP157]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP158:%.*]] = add i32 [[TMP0]], 48
; POST-PROCESS-CPS-NEXT:    [[TMP159:%.*]] = inttoptr i32 [[TMP158]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP160:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP159]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP58]], ptr addrspace(21) [[TMP160]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP161:%.*]] = add i32 [[TMP0]], 52
; POST-PROCESS-CPS-NEXT:    [[TMP162:%.*]] = inttoptr i32 [[TMP161]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP163:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP162]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP62]], ptr addrspace(21) [[TMP163]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP164:%.*]] = add i32 [[TMP0]], 56
; POST-PROCESS-CPS-NEXT:    [[TMP165:%.*]] = inttoptr i32 [[TMP164]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP166:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP165]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP66]], ptr addrspace(21) [[TMP166]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP167:%.*]] = add i32 [[TMP0]], 60
; POST-PROCESS-CPS-NEXT:    [[TMP168:%.*]] = inttoptr i32 [[TMP167]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP169:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP168]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP70]], ptr addrspace(21) [[TMP169]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP170:%.*]] = add i32 [[TMP0]], 64
; POST-PROCESS-CPS-NEXT:    [[TMP171:%.*]] = inttoptr i32 [[TMP170]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP172:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP171]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP74]], ptr addrspace(21) [[TMP172]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP173:%.*]] = add i32 [[TMP0]], 68
; POST-PROCESS-CPS-NEXT:    [[TMP174:%.*]] = inttoptr i32 [[TMP173]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP175:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP174]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP78]], ptr addrspace(21) [[TMP175]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP176:%.*]] = add i32 [[TMP0]], 72
; POST-PROCESS-CPS-NEXT:    [[TMP177:%.*]] = inttoptr i32 [[TMP176]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP178:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP177]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP82]], ptr addrspace(21) [[TMP178]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP179:%.*]] = add i32 [[TMP0]], 76
; POST-PROCESS-CPS-NEXT:    [[TMP180:%.*]] = inttoptr i32 [[TMP179]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP181:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP180]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP86]], ptr addrspace(21) [[TMP181]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP182:%.*]] = add i32 [[TMP0]], 80
; POST-PROCESS-CPS-NEXT:    [[TMP183:%.*]] = inttoptr i32 [[TMP182]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP184:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP183]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP90]], ptr addrspace(21) [[TMP184]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP185:%.*]] = add i32 [[TMP0]], 84
; POST-PROCESS-CPS-NEXT:    [[TMP186:%.*]] = inttoptr i32 [[TMP185]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP187:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP186]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP94]], ptr addrspace(21) [[TMP187]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP188:%.*]] = add i32 [[TMP0]], 88
; POST-PROCESS-CPS-NEXT:    [[TMP189:%.*]] = inttoptr i32 [[TMP188]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP190:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP189]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP98]], ptr addrspace(21) [[TMP190]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP191:%.*]] = add i32 [[TMP0]], 92
; POST-PROCESS-CPS-NEXT:    [[TMP192:%.*]] = inttoptr i32 [[TMP191]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP193:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP192]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP102]], ptr addrspace(21) [[TMP193]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP194:%.*]] = add i32 [[TMP0]], 96
; POST-PROCESS-CPS-NEXT:    [[TMP195:%.*]] = inttoptr i32 [[TMP194]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP196:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP195]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP106]], ptr addrspace(21) [[TMP196]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP197:%.*]] = add i32 [[TMP0]], 100
; POST-PROCESS-CPS-NEXT:    [[TMP198:%.*]] = inttoptr i32 [[TMP197]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP199:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP198]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP110]], ptr addrspace(21) [[TMP199]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP200:%.*]] = add i32 [[TMP0]], 104
; POST-PROCESS-CPS-NEXT:    [[TMP201:%.*]] = inttoptr i32 [[TMP200]] to ptr addrspace(21)
; POST-PROCESS-CPS-NEXT:    [[TMP202:%.*]] = getelementptr i8, ptr addrspace(21) [[TMP201]], i32 0
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP114]], ptr addrspace(21) [[TMP202]], align 4
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_INSERT54:%.*]] = insertvalue [30 x i32] poison, i32 [[TMP0]], 0
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_1_INSERT57:%.*]] = insertvalue [30 x i32] [[DOTFCA_0_INSERT54]], i32 [[PAYLOAD_FCA_1_EXTRACT]], 1
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_2_INSERT60:%.*]] = insertvalue [30 x i32] [[DOTFCA_1_INSERT57]], i32 [[PAYLOAD_FCA_2_EXTRACT]], 2
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_3_INSERT63:%.*]] = insertvalue [30 x i32] [[DOTFCA_2_INSERT60]], i32 [[PAYLOAD_FCA_3_EXTRACT]], 3
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_4_INSERT66:%.*]] = insertvalue [30 x i32] [[DOTFCA_3_INSERT63]], i32 [[PAYLOAD_FCA_4_EXTRACT]], 4
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_5_INSERT69:%.*]] = insertvalue [30 x i32] [[DOTFCA_4_INSERT66]], i32 [[PAYLOAD_FCA_5_EXTRACT]], 5
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_6_INSERT72:%.*]] = insertvalue [30 x i32] [[DOTFCA_5_INSERT69]], i32 [[PAYLOAD_FCA_6_EXTRACT]], 6
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_7_INSERT75:%.*]] = insertvalue [30 x i32] [[DOTFCA_6_INSERT72]], i32 [[PAYLOAD_FCA_7_EXTRACT]], 7
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_8_INSERT78:%.*]] = insertvalue [30 x i32] [[DOTFCA_7_INSERT75]], i32 [[PAYLOAD_FCA_8_EXTRACT]], 8
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_9_INSERT81:%.*]] = insertvalue [30 x i32] [[DOTFCA_8_INSERT78]], i32 [[PAYLOAD_FCA_9_EXTRACT]], 9
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_10_INSERT84:%.*]] = insertvalue [30 x i32] [[DOTFCA_9_INSERT81]], i32 [[PAYLOAD_FCA_10_EXTRACT]], 10
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_11_INSERT87:%.*]] = insertvalue [30 x i32] [[DOTFCA_10_INSERT84]], i32 [[PAYLOAD_FCA_11_EXTRACT]], 11
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_12_INSERT90:%.*]] = insertvalue [30 x i32] [[DOTFCA_11_INSERT87]], i32 [[PAYLOAD_FCA_12_EXTRACT]], 12
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_13_INSERT93:%.*]] = insertvalue [30 x i32] [[DOTFCA_12_INSERT90]], i32 [[PAYLOAD_FCA_13_EXTRACT]], 13
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_14_INSERT96:%.*]] = insertvalue [30 x i32] [[DOTFCA_13_INSERT93]], i32 [[PAYLOAD_FCA_14_EXTRACT]], 14
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_15_INSERT99:%.*]] = insertvalue [30 x i32] [[DOTFCA_14_INSERT96]], i32 [[PAYLOAD_FCA_15_EXTRACT]], 15
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_16_INSERT102:%.*]] = insertvalue [30 x i32] [[DOTFCA_15_INSERT99]], i32 [[PAYLOAD_FCA_16_EXTRACT]], 16
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_17_INSERT105:%.*]] = insertvalue [30 x i32] [[DOTFCA_16_INSERT102]], i32 [[PAYLOAD_FCA_17_EXTRACT]], 17
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_18_INSERT108:%.*]] = insertvalue [30 x i32] [[DOTFCA_17_INSERT105]], i32 [[PAYLOAD_FCA_18_EXTRACT]], 18
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_19_INSERT111:%.*]] = insertvalue [30 x i32] [[DOTFCA_18_INSERT108]], i32 [[PAYLOAD_FCA_19_EXTRACT]], 19
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_20_INSERT114:%.*]] = insertvalue [30 x i32] [[DOTFCA_19_INSERT111]], i32 [[PAYLOAD_FCA_20_EXTRACT]], 20
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_21_INSERT117:%.*]] = insertvalue [30 x i32] [[DOTFCA_20_INSERT114]], i32 [[PAYLOAD_FCA_21_EXTRACT]], 21
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_22_INSERT120:%.*]] = insertvalue [30 x i32] [[DOTFCA_21_INSERT117]], i32 [[PAYLOAD_FCA_22_EXTRACT]], 22
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_23_INSERT123:%.*]] = insertvalue [30 x i32] [[DOTFCA_22_INSERT120]], i32 [[PAYLOAD_FCA_23_EXTRACT]], 23
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_24_INSERT126:%.*]] = insertvalue [30 x i32] [[DOTFCA_23_INSERT123]], i32 [[PAYLOAD_FCA_24_EXTRACT]], 24
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_25_INSERT129:%.*]] = insertvalue [30 x i32] [[DOTFCA_24_INSERT126]], i32 [[PAYLOAD_FCA_25_EXTRACT]], 25
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_26_INSERT132:%.*]] = insertvalue [30 x i32] [[DOTFCA_25_INSERT129]], i32 [[PAYLOAD_FCA_26_EXTRACT]], 26
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_27_INSERT135:%.*]] = insertvalue [30 x i32] [[DOTFCA_26_INSERT132]], i32 [[PAYLOAD_FCA_27_EXTRACT]], 27
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_28_INSERT138:%.*]] = insertvalue [30 x i32] [[DOTFCA_27_INSERT135]], i32 [[PAYLOAD_FCA_28_EXTRACT]], 28
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_29_INSERT141:%.*]] = insertvalue [30 x i32] [[DOTFCA_28_INSERT138]], i32 [[PAYLOAD_FCA_29_EXTRACT]], 29
; POST-PROCESS-CPS-NEXT:    [[TMP203:%.*]] = load i32, ptr [[CSP]], align 4
; POST-PROCESS-CPS-NEXT:    call void (...) @lgc.ilcps.waitContinue(i64 4, i64 -1, i32 [[TMP203]], i64 [[TMP122]], [[STRUCT_TRAVERSALDATA]] [[TRAV_DATA2_I]], [10 x i32] poison, [30 x i32] [[DOTFCA_29_INSERT141]])
; POST-PROCESS-CPS-NEXT:    unreachable
;
;
; POST-PROCESS-CPS-LABEL: define dso_local void @ClosestHit.resume.0(
; POST-PROCESS-CPS-SAME: {} [[TMP0:%.*]], i32 [[CSPINIT:%.*]], i32 [[TMP1:%.*]], i32 [[TMP2:%.*]], { [[STRUCT_DISPATCHSYSTEMDATA:%.*]], [23 x i32], [30 x i32] } [[TMP3:%.*]]) !lgc.rt.shaderstage [[META25]] !lgc.cps [[META22]] !continuation [[META26]] {
; POST-PROCESS-CPS-NEXT:  entryresume.0:
; POST-PROCESS-CPS-NEXT:    [[CSP:%.*]] = alloca i32, align 4
; POST-PROCESS-CPS-NEXT:    store i32 [[CSPINIT]], ptr [[CSP]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP4:%.*]] = load i32, ptr [[CSP]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP5:%.*]] = add i32 [[TMP4]], -116
; POST-PROCESS-CPS-NEXT:    [[TMP6:%.*]] = extractvalue { [[STRUCT_DISPATCHSYSTEMDATA]], [23 x i32], [30 x i32] } [[TMP3]], 2
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_0_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 0
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_1_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 1
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_2_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP6]], 2
...
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_1_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_0_INSERT]], i32 [[DOTFCA_1_EXTRACT]], 1
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_2_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_1_INSERT]], i32 [[DOTFCA_2_EXTRACT]], 2
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_3_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_2_INSERT]], i32 [[DOTFCA_3_EXTRACT]], 3
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_4_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_3_INSERT]], i32 [[DOTFCA_4_EXTRACT]], 4
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_5_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_4_INSERT]], i32 [[DOTFCA_5_EXTRACT]], 5
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_6_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_5_INSERT]], i32 [[DOTFCA_6_EXTRACT]], 6
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_7_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_6_INSERT]], i32 [[DOTFCA_7_EXTRACT]], 7
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_8_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_7_INSERT]], i32 [[DOTFCA_8_EXTRACT]], 8
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_9_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_8_INSERT]], i32 [[DOTFCA_9_EXTRACT]], 9
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_10_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_9_INSERT]], i32 [[DOTFCA_10_EXTRACT]], 10
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_11_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_10_INSERT]], i32 [[DOTFCA_11_EXTRACT]], 11
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_12_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_11_INSERT]], i32 [[DOTFCA_12_EXTRACT]], 12
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_13_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_12_INSERT]], i32 [[DOTFCA_13_EXTRACT]], 13
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_14_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_13_INSERT]], i32 [[DOTFCA_14_EXTRACT]], 14
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_15_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_14_INSERT]], i32 [[DOTFCA_15_EXTRACT]], 15
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_16_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_15_INSERT]], i32 [[DOTFCA_16_EXTRACT]], 16
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_17_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_16_INSERT]], i32 [[DOTFCA_17_EXTRACT]], 17
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_18_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_17_INSERT]], i32 [[DOTFCA_18_EXTRACT]], 18
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_19_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_18_INSERT]], i32 [[DOTFCA_19_EXTRACT]], 19
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_20_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_19_INSERT]], i32 [[DOTFCA_20_EXTRACT]], 20
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_21_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_20_INSERT]], i32 [[DOTFCA_21_EXTRACT]], 21
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_22_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_21_INSERT]], i32 [[DOTFCA_22_EXTRACT]], 22
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_23_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_22_INSERT]], i32 [[DOTFCA_23_EXTRACT]], 23
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_24_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_23_INSERT]], i32 [[DOTFCA_24_EXTRACT]], 24
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_25_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_24_INSERT]], i32 [[DOTFCA_25_EXTRACT]], 25
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_26_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_25_INSERT]], i32 [[DOTFCA_26_EXTRACT]], 26
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_27_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_26_INSERT]], i32 [[DOTFCA_27_EXTRACT]], 27
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_28_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_27_INSERT]], i32 [[DOTFCA_28_EXTRACT]], 28
; POST-PROCESS-CPS-NEXT:    [[DOTFCA_29_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_28_INSERT]], i32 [[DOTFCA_29_EXTRACT]], 29
; POST-PROCESS-CPS-NEXT:    [[TMP201:%.*]] = load i32, ptr [[CSP]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP202:%.*]] = add i32 [[TMP201]], -116
; POST-PROCESS-CPS-NEXT:    store i32 [[TMP202]], ptr [[CSP]], align 4
; POST-PROCESS-CPS-NEXT:    [[TMP203:%.*]] = zext i32 [[RETURNADDR_RELOAD]] to i64
; POST-PROCESS-CPS-NEXT:    [[TMP204:%.*]] = load i32, ptr [[CSP]], align 4
; POST-PROCESS-CPS-NEXT:    call void (...) @lgc.ilcps.continue(i64 [[TMP203]], i32 [[TMP204]], i64 poison, i32 poison, [[STRUCT_DISPATCHSYSTEMDATA]] [[DOTFCA_0_INSERT253]], [23 x i32] poison, [30 x i32] [[DOTFCA_29_INSERT]])
; POST-PROCESS-CPS-NEXT:    unreachable
;
;
; POST-PROCESS-GLOBAL-CPS-LABEL: define %struct.BuiltInTriangleIntersectionAttributes @_cont_GetTriangleHitAttributes(
; POST-PROCESS-GLOBAL-CPS-SAME: ptr [[DATA:%.*]]) #[[ATTR0:[0-9]+]] {
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[ADDR:%.*]] = getelementptr [[STRUCT_SYSTEMDATA:%.*]], ptr [[DATA]], i32 0, i32 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[VAL:%.*]] = load [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES:%.*]], ptr [[ADDR]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    ret [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES]] [[VAL]]
;
;
; POST-PROCESS-GLOBAL-CPS-LABEL: define i32 @_cont_GetLocalRootIndex(
; POST-PROCESS-GLOBAL-CPS-SAME: ptr [[DATA:%.*]]) #[[ATTR0]] {
; POST-PROCESS-GLOBAL-CPS-NEXT:    ret i32 5
;
;
; POST-PROCESS-GLOBAL-CPS-LABEL: define void @main(
; POST-PROCESS-GLOBAL-CPS-SAME: {} [[CONT_STATE:%.*]], i32 [[CSPINIT:%.*]], i32 [[RETURNADDR:%.*]], i32 [[SHADER_INDEX:%.*]], [[STRUCT_DISPATCHSYSTEMDATA:%.*]] [[TMP0:%.*]]) !lgc.rt.shaderstage [[META8:![0-9]+]] !lgc.cps [[META19:![0-9]+]] !continuation [[META20:![0-9]+]] !continuation.stacksize [[META21:![0-9]+]] {
...
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP1:%.*]] = call i64 @_cont_GetContinuationStackGlobalMemBase()
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP2:%.*]] = inttoptr i64 [[TMP1]] to ptr addrspace(22)
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP3:%.*]] = load i32, ptr [[CSP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP4:%.*]] = add i32 [[TMP3]], 108
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP4]], ptr [[CSP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_EXTRACT56:%.*]] = extractvalue [[STRUCT_DISPATCHSYSTEMDATA]] [[TMP0]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    call void @amd.dx.setLocalRootIndex(i32 0)
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP5:%.*]] = load [[DX_TYPES_HANDLE:%.*]], ptr @"\01?Scene@@3URaytracingAccelerationStructure@@A", align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP6:%.*]] = load [[DX_TYPES_HANDLE]], ptr @"\01?RenderTarget@@3V?$RWTexture2D@V?$vector@M$03@@@@A", align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP7:%.*]] = call [[DX_TYPES_HANDLE]] @[[DX_OP_CREATEHANDLEFORLIB_DX_TYPES_HANDLE:[a-zA-Z0-9_$\"\\.-]*[a-zA-Z_$\"\\.-][a-zA-Z0-9_$\"\\.-]*]](i32 160, [[DX_TYPES_HANDLE]] [[TMP5]])
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP8:%.*]] = call [[DX_TYPES_HANDLE]] @[[DX_OP_ANNOTATEHANDLE:[a-zA-Z0-9_$\"\\.-]*[a-zA-Z_$\"\\.-][a-zA-Z0-9_$\"\\.-]*]](i32 216, [[DX_TYPES_HANDLE]] [[TMP7]], [[DX_TYPES_RESOURCEPROPERTIES:%.*]] { i32 16, i32 0 })
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP9:%.*]] = call i64 @amd.dx.getAccelStructAddr([[DX_TYPES_HANDLE]] [[TMP8]])
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DIS_DATA_I_FCA_0_INSERT:%.*]] = insertvalue [[STRUCT_DISPATCHSYSTEMDATA]] poison, <3 x i32> [[DOTFCA_0_EXTRACT56]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYS_DATA_I:%.*]] = insertvalue [[STRUCT_SYSTEMDATA:%.*]] undef, [[STRUCT_DISPATCHSYSTEMDATA]] [[DIS_DATA_I_FCA_0_INSERT]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TRAV_DATA_I:%.*]] = insertvalue [[STRUCT_TRAVERSALDATA:%.*]] undef, [[STRUCT_SYSTEMDATA]] [[SYS_DATA_I]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP10:%.*]] = call i64 @continuation.getAddrAndMD(ptr @main.resume.0)
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TRAV_DATA2_I:%.*]] = insertvalue [[STRUCT_TRAVERSALDATA]] [[TRAV_DATA_I]], i64 [[TMP10]], 5
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP11:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP3]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP11]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP12:%.*]] = add i32 [[TMP3]], 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP13:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP12]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP13]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP14:%.*]] = add i32 [[TMP3]], 8
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP15:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP14]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP15]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP16:%.*]] = add i32 [[TMP3]], 12
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP17:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP16]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP17]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP18:%.*]] = add i32 [[TMP3]], 16
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP19:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP18]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP19]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP20:%.*]] = add i32 [[TMP3]], 20
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP21:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP20]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP21]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP22:%.*]] = add i32 [[TMP3]], 24
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP23:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP22]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP23]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP24:%.*]] = add i32 [[TMP3]], 28
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP25:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP24]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP25]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP26:%.*]] = add i32 [[TMP3]], 32
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP27:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP26]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP27]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP28:%.*]] = add i32 [[TMP3]], 36
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP29:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP28]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP29]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP30:%.*]] = add i32 [[TMP3]], 40
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP31:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP30]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP31]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP32:%.*]] = add i32 [[TMP3]], 44
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP33:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP32]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP33]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP34:%.*]] = add i32 [[TMP3]], 48
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP35:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP34]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP35]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP36:%.*]] = add i32 [[TMP3]], 52
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP37:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP36]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP37]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP38:%.*]] = add i32 [[TMP3]], 56
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP39:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP38]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP39]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP40:%.*]] = add i32 [[TMP3]], 60
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP41:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP40]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP41]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP42:%.*]] = add i32 [[TMP3]], 64
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP43:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP42]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP43]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP44:%.*]] = add i32 [[TMP3]], 68
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP45:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP44]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP45]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP46:%.*]] = add i32 [[TMP3]], 72
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP47:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP46]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP47]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP48:%.*]] = add i32 [[TMP3]], 76
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP49:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP48]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP49]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP50:%.*]] = add i32 [[TMP3]], 80
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP51:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP50]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP51]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP52:%.*]] = add i32 [[TMP3]], 84
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP53:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP52]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP53]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP54:%.*]] = add i32 [[TMP3]], 88
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP55:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP54]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP55]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP56:%.*]] = add i32 [[TMP3]], 92
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP57:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP56]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP57]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP58:%.*]] = add i32 [[TMP3]], 96
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP59:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP58]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP59]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP60:%.*]] = add i32 [[TMP3]], 100
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP61:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP60]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP61]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP62:%.*]] = add i32 [[TMP3]], 104
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP63:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP2]], i32 [[TMP62]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 undef, ptr addrspace(22) [[TMP63]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_INSERT:%.*]] = insertvalue [30 x i32] poison, i32 [[TMP3]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_1_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_0_INSERT]], i32 undef, 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_2_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_1_INSERT]], i32 undef, 2
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_3_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_2_INSERT]], i32 undef, 3
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_4_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_3_INSERT]], i32 undef, 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_5_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_4_INSERT]], i32 undef, 5
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_6_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_5_INSERT]], i32 undef, 6
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_7_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_6_INSERT]], i32 undef, 7
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_8_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_7_INSERT]], i32 undef, 8
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_9_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_8_INSERT]], i32 undef, 9
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_10_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_9_INSERT]], i32 undef, 10
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_11_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_10_INSERT]], i32 undef, 11
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_12_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_11_INSERT]], i32 undef, 12
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_13_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_12_INSERT]], i32 undef, 13
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_14_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_13_INSERT]], i32 undef, 14
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_15_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_14_INSERT]], i32 undef, 15
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_16_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_15_INSERT]], i32 undef, 16
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_17_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_16_INSERT]], i32 undef, 17
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_18_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_17_INSERT]], i32 undef, 18
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_19_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_18_INSERT]], i32 undef, 19
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_20_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_19_INSERT]], i32 undef, 20
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_21_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_20_INSERT]], i32 undef, 21
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_22_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_21_INSERT]], i32 undef, 22
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_23_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_22_INSERT]], i32 undef, 23
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_24_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_23_INSERT]], i32 undef, 24
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_25_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_24_INSERT]], i32 undef, 25
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_26_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_25_INSERT]], i32 undef, 26
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_27_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_26_INSERT]], i32 undef, 27
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_28_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_27_INSERT]], i32 undef, 28
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_29_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_28_INSERT]], i32 undef, 29
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP64:%.*]] = load i32, ptr [[CSP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    call void (...) @lgc.ilcps.waitContinue(i64 4, i64 -1, i32 [[TMP64]], i64 [[TMP10]], [[STRUCT_TRAVERSALDATA]] [[TRAV_DATA2_I]], [10 x i32] poison, [30 x i32] [[DOTFCA_29_INSERT]])
; POST-PROCESS-GLOBAL-CPS-NEXT:    unreachable
;
;
; POST-PROCESS-GLOBAL-CPS-LABEL: define dso_local void @main.resume.0(
; POST-PROCESS-GLOBAL-CPS-SAME: {} [[TMP0:%.*]], i32 [[CSPINIT:%.*]], i32 [[TMP1:%.*]], i32 [[TMP2:%.*]], { [[STRUCT_DISPATCHSYSTEMDATA:%.*]], [23 x i32], [30 x i32] } [[TMP3:%.*]]) !lgc.rt.shaderstage [[META8]] !lgc.cps [[META19]] !continuation [[META20]] {
; POST-PROCESS-GLOBAL-CPS-NEXT:  entryresume.0:
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[CSP:%.*]] = alloca i32, align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[CSPINIT]], ptr [[CSP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP4:%.*]] = call i64 @_cont_GetContinuationStackGlobalMemBase()
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP5:%.*]] = inttoptr i64 [[TMP4]] to ptr addrspace(22)
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP6:%.*]] = load i32, ptr [[CSP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP7:%.*]] = add i32 [[TMP6]], -108
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP8:%.*]] = extractvalue { [[STRUCT_DISPATCHSYSTEMDATA]], [23 x i32], [30 x i32] } [[TMP3]], 2
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_1_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_2_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 2
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_3_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 3
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_4_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_5_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 5
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_6_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 6
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_7_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 7
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_8_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 8
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_9_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 9
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_10_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 10
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_11_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 11
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_12_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 12
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_13_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 13
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_14_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 14
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_15_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 15
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_16_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 16
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_17_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 17
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_18_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 18
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_19_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 19
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_20_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 20
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_21_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 21
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_22_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 22
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_23_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 23
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_24_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 24
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_25_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 25
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_26_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 26
...
; POST-PROCESS-GLOBAL-CPS-NEXT:    call void @amd.dx.setLocalRootIndex(i32 0)
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP90:%.*]] = load i32, ptr [[CSP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP91:%.*]] = add i32 [[TMP90]], -108
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP91]], ptr [[CSP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    ret void
;
;
; POST-PROCESS-GLOBAL-CPS-LABEL: define void @AnyHit(
; POST-PROCESS-GLOBAL-CPS-SAME: {} [[CONT_STATE:%.*]], i32 [[CSPINIT:%.*]], i32 [[RETURNADDR:%.*]], i32 [[SHADER_INDEX:%.*]], [[STRUCT_ANYHITTRAVERSALDATA:%.*]] [[SYSTEM_DATA:%.*]], [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES:%.*]] [[HIT_ATTRS:%.*]], [6 x i32] [[PADDING:%.*]], [30 x i32] [[PAYLOAD:%.*]]) #[[ATTR2:[0-9]+]] !lgc.rt.shaderstage [[META22:![0-9]+]] !lgc.cps [[META23:![0-9]+]] !continuation [[META24:![0-9]+]] {
; POST-PROCESS-GLOBAL-CPS-NEXT:  AllocaSpillBB:
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_ALLOCA:%.*]] = alloca [[STRUCT_ANYHITTRAVERSALDATA]], align 8
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[CSP:%.*]] = alloca i32, align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[CSPINIT]], ptr [[CSP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP0:%.*]] = call i64 @_cont_GetContinuationStackGlobalMemBase()
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP1:%.*]] = inttoptr i64 [[TMP0]] to ptr addrspace(22)
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_0_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_1_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_2_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 2
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_3_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 3
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_4_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_5_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 5
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_6_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 6
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_7_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 7
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_8_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 8
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_9_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 9
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_10_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 10
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_11_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 11
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_12_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 12
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_13_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 13
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_14_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 14
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_15_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 15
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_16_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 16
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_17_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 17
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_18_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 18
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_19_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 19
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_20_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 20
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_21_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 21
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_22_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 22
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_23_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 23
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_24_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 24
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_25_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 25
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_26_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 26
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_27_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 27
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_28_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 28
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_29_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 29
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_0_0_0_EXTRACT:%.*]] = extractvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[SYSTEM_DATA]], 0, 0, 0, 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_0_0_0_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 0, i32 0, i32 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    store <3 x i32> [[SYSTEM_DATA_FCA_0_0_0_0_EXTRACT]], ptr [[SYSTEM_DATA_FCA_0_0_0_0_GEP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_0_1_0_EXTRACT:%.*]] = extractvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[SYSTEM_DATA]], 0, 0, 1, 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_0_1_0_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 0, i32 1, i32 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    store <2 x float> [[SYSTEM_DATA_FCA_0_0_1_0_EXTRACT]], ptr [[SYSTEM_DATA_FCA_0_0_1_0_GEP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_1_0_EXTRACT:%.*]] = extractvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[SYSTEM_DATA]], 0, 1, 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_1_0_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 1, i32 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    store float [[SYSTEM_DATA_FCA_0_1_0_EXTRACT]], ptr [[SYSTEM_DATA_FCA_0_1_0_GEP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_1_1_EXTRACT:%.*]] = extractvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[SYSTEM_DATA]], 0, 1, 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_1_1_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 1, i32 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[SYSTEM_DATA_FCA_0_1_1_EXTRACT]], ptr [[SYSTEM_DATA_FCA_0_1_1_GEP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_2_EXTRACT:%.*]] = extractvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[SYSTEM_DATA]], 0, 2
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_2_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 2
; POST-PROCESS-GLOBAL-CPS-NEXT:    store <3 x float> [[SYSTEM_DATA_FCA_0_2_EXTRACT]], ptr [[SYSTEM_DATA_FCA_0_2_GEP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_3_EXTRACT:%.*]] = extractvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[SYSTEM_DATA]], 0, 3
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_3_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 3
; POST-PROCESS-GLOBAL-CPS-NEXT:    store <3 x float> [[SYSTEM_DATA_FCA_0_3_EXTRACT]], ptr [[SYSTEM_DATA_FCA_0_3_GEP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_4_EXTRACT:%.*]] = extractvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[SYSTEM_DATA]], 0, 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_4_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    store float [[SYSTEM_DATA_FCA_0_4_EXTRACT]], ptr [[SYSTEM_DATA_FCA_0_4_GEP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_5_EXTRACT:%.*]] = extractvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[SYSTEM_DATA]], 0, 5
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_5_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 5
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i64 [[SYSTEM_DATA_FCA_0_5_EXTRACT]], ptr [[SYSTEM_DATA_FCA_0_5_GEP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_1_0_EXTRACT:%.*]] = extractvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[SYSTEM_DATA]], 1, 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_1_0_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 1, i32 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    store float [[SYSTEM_DATA_FCA_1_0_EXTRACT]], ptr [[SYSTEM_DATA_FCA_1_0_GEP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_1_1_EXTRACT:%.*]] = extractvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[SYSTEM_DATA]], 1, 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_1_1_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 1, i32 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[SYSTEM_DATA_FCA_1_1_EXTRACT]], ptr [[SYSTEM_DATA_FCA_1_1_GEP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP2:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[PAYLOAD_FCA_0_EXTRACT]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP3:%.*]] = load i32, ptr addrspace(22) [[TMP2]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP4:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP4]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP6:%.*]] = load i32, ptr addrspace(22) [[TMP5]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP7:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 8
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP8:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP7]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP9:%.*]] = load i32, ptr addrspace(22) [[TMP8]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP10:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 12
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP11:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP10]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP12:%.*]] = load i32, ptr addrspace(22) [[TMP11]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP13:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 16
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP14:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP13]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP15:%.*]] = load i32, ptr addrspace(22) [[TMP14]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP16:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 20
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP17:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP16]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP18:%.*]] = load i32, ptr addrspace(22) [[TMP17]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP19:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 24
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP20:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP19]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP21:%.*]] = load i32, ptr addrspace(22) [[TMP20]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP22:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 28
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP23:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP22]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP24:%.*]] = load i32, ptr addrspace(22) [[TMP23]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP25:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 32
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP26:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP25]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP27:%.*]] = load i32, ptr addrspace(22) [[TMP26]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP28:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 36
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP29:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP28]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP30:%.*]] = load i32, ptr addrspace(22) [[TMP29]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP31:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 40
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP32:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP31]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP33:%.*]] = load i32, ptr addrspace(22) [[TMP32]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP34:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 44
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP35:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP34]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP36:%.*]] = load i32, ptr addrspace(22) [[TMP35]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP37:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 48
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP38:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP37]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP39:%.*]] = load i32, ptr addrspace(22) [[TMP38]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP40:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 52
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP41:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP40]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP42:%.*]] = load i32, ptr addrspace(22) [[TMP41]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP43:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 56
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP44:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP43]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP45:%.*]] = load i32, ptr addrspace(22) [[TMP44]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP46:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 60
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP47:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP46]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP48:%.*]] = load i32, ptr addrspace(22) [[TMP47]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP49:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 64
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP50:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP49]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP51:%.*]] = load i32, ptr addrspace(22) [[TMP50]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP52:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 68
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP53:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP52]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP54:%.*]] = load i32, ptr addrspace(22) [[TMP53]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP55:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 72
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP56:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP55]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP57:%.*]] = load i32, ptr addrspace(22) [[TMP56]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP58:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 76
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP59:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP58]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP60:%.*]] = load i32, ptr addrspace(22) [[TMP59]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP61:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 80
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP62:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP61]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP63:%.*]] = load i32, ptr addrspace(22) [[TMP62]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP64:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 84
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP65:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP64]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP66:%.*]] = load i32, ptr addrspace(22) [[TMP65]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP67:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 88
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP68:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP67]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP69:%.*]] = load i32, ptr addrspace(22) [[TMP68]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP70:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 92
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP71:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP70]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP72:%.*]] = load i32, ptr addrspace(22) [[TMP71]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP73:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 96
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP74:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP73]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP75:%.*]] = load i32, ptr addrspace(22) [[TMP74]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP76:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 100
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP77:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP76]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP78:%.*]] = load i32, ptr addrspace(22) [[TMP77]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP79:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 104
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP80:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP79]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP81:%.*]] = load i32, ptr addrspace(22) [[TMP80]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP82:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[ADDR_I:%.*]] = getelementptr [[STRUCT_SYSTEMDATA:%.*]], ptr [[TMP82]], i32 0, i32 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[VAL_I_FCA_0_GEP:%.*]] = getelementptr inbounds [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES]], ptr [[ADDR_I]], i32 0, i32 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[VAL_I_FCA_0_LOAD:%.*]] = load <2 x float>, ptr [[VAL_I_FCA_0_GEP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[VAL_I_FCA_0_INSERT:%.*]] = insertvalue [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES]] poison, <2 x float> [[VAL_I_FCA_0_LOAD]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[VAL_I_FCA_0_INSERT_FCA_0_EXTRACT:%.*]] = extractvalue [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES]] [[VAL_I_FCA_0_INSERT]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTSROA_025_0_VEC_EXTRACT:%.*]] = extractelement <2 x float> [[VAL_I_FCA_0_INSERT_FCA_0_EXTRACT]], i32 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP83:%.*]] = bitcast float [[DOTSROA_025_0_VEC_EXTRACT]] to i32
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTSROA_025_4_VEC_EXTRACT:%.*]] = extractelement <2 x float> [[VAL_I_FCA_0_INSERT_FCA_0_EXTRACT]], i32 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP84:%.*]] = bitcast float [[DOTSROA_025_4_VEC_EXTRACT]] to i32
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[HIT_ATTRS_FCA_0_EXTRACT:%.*]] = extractvalue [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES]] [[HIT_ATTRS]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    call void @amd.dx.setLocalRootIndex(i32 [[SHADER_INDEX]])
; POST-PROCESS-GLOBAL-CPS-NEXT:    call void @_cont_AcceptHit(ptr [[SYSTEM_DATA_ALLOCA]])
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP85:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[PAYLOAD_FCA_0_EXTRACT]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP3]], ptr addrspace(22) [[TMP85]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP86:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP87:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP86]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP6]], ptr addrspace(22) [[TMP87]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP88:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 8
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP89:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP88]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP9]], ptr addrspace(22) [[TMP89]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP90:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 12
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP91:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP90]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP12]], ptr addrspace(22) [[TMP91]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP92:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 16
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP93:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP92]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP15]], ptr addrspace(22) [[TMP93]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP94:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 20
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP95:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP94]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP18]], ptr addrspace(22) [[TMP95]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP96:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 24
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP97:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP96]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP21]], ptr addrspace(22) [[TMP97]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP98:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 28
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP99:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP98]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP24]], ptr addrspace(22) [[TMP99]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP100:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 32
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP101:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP100]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP27]], ptr addrspace(22) [[TMP101]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP102:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 36
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP103:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP102]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP30]], ptr addrspace(22) [[TMP103]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP104:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 40
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP105:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP104]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP33]], ptr addrspace(22) [[TMP105]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP106:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 44
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP107:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP106]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP36]], ptr addrspace(22) [[TMP107]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP108:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 48
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP109:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP108]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP39]], ptr addrspace(22) [[TMP109]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP110:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 52
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP111:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP110]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP42]], ptr addrspace(22) [[TMP111]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP112:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 56
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP113:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP112]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP45]], ptr addrspace(22) [[TMP113]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP114:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 60
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP115:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP114]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP48]], ptr addrspace(22) [[TMP115]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP116:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 64
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP117:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP116]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP51]], ptr addrspace(22) [[TMP117]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP118:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 68
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP119:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP118]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP54]], ptr addrspace(22) [[TMP119]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP120:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 72
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP121:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP120]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP57]], ptr addrspace(22) [[TMP121]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP122:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 76
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP123:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP122]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP60]], ptr addrspace(22) [[TMP123]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP124:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 80
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP125:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP124]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP63]], ptr addrspace(22) [[TMP125]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP126:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 84
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP127:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP126]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP66]], ptr addrspace(22) [[TMP127]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP128:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 88
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP129:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP128]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP69]], ptr addrspace(22) [[TMP129]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP130:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 92
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP131:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP130]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP72]], ptr addrspace(22) [[TMP131]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP132:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 96
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP133:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP132]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP75]], ptr addrspace(22) [[TMP133]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP134:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 100
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP135:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP134]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP78]], ptr addrspace(22) [[TMP135]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP136:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 104
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP137:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP136]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP81]], ptr addrspace(22) [[TMP137]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[HITATTRSALLOCA_SROA_0_0_VEC_EXTRACT:%.*]] = extractelement <2 x float> [[HIT_ATTRS_FCA_0_EXTRACT]], i32 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP138:%.*]] = bitcast float [[HITATTRSALLOCA_SROA_0_0_VEC_EXTRACT]] to i32
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP139:%.*]] = bitcast i32 [[TMP138]] to float
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTSROA_027_0_VEC_INSERT:%.*]] = insertelement <2 x float> undef, float [[TMP139]], i32 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[HITATTRSALLOCA_SROA_0_4_VEC_EXTRACT:%.*]] = extractelement <2 x float> [[HIT_ATTRS_FCA_0_EXTRACT]], i32 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP140:%.*]] = bitcast float [[HITATTRSALLOCA_SROA_0_4_VEC_EXTRACT]] to i32
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP141:%.*]] = bitcast i32 [[TMP140]] to float
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTSROA_027_4_VEC_INSERT:%.*]] = insertelement <2 x float> [[DOTSROA_027_0_VEC_INSERT]], float [[TMP141]], i32 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_INSERT26:%.*]] = insertvalue [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES]] poison, <2 x float> [[DOTSROA_027_4_VEC_INSERT]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP142:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    call void @_cont_SetTriangleHitAttributes(ptr [[TMP142]], [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES]] [[DOTFCA_0_INSERT26]])
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_0_0_0_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 0, i32 0, i32 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_0_0_0_LOAD:%.*]] = load <3 x i32>, ptr [[DOTFCA_0_0_0_0_GEP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_0_0_0_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] poison, <3 x i32> [[DOTFCA_0_0_0_0_LOAD]], 0, 0, 0, 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_0_1_0_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 0, i32 1, i32 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_0_1_0_LOAD:%.*]] = load <2 x float>, ptr [[DOTFCA_0_0_1_0_GEP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_0_1_0_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_0_0_0_0_INSERT]], <2 x float> [[DOTFCA_0_0_1_0_LOAD]], 0, 0, 1, 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_1_0_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 1, i32 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_1_0_LOAD:%.*]] = load float, ptr [[DOTFCA_0_1_0_GEP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_1_0_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_0_0_1_0_INSERT]], float [[DOTFCA_0_1_0_LOAD]], 0, 1, 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_1_1_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 1, i32 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_1_1_LOAD:%.*]] = load i32, ptr [[DOTFCA_0_1_1_GEP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_1_1_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_0_1_0_INSERT]], i32 [[DOTFCA_0_1_1_LOAD]], 0, 1, 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_2_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 2
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_2_LOAD:%.*]] = load <3 x float>, ptr [[DOTFCA_0_2_GEP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_2_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_0_1_1_INSERT]], <3 x float> [[DOTFCA_0_2_LOAD]], 0, 2
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_3_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 3
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_3_LOAD:%.*]] = load <3 x float>, ptr [[DOTFCA_0_3_GEP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_3_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_0_2_INSERT]], <3 x float> [[DOTFCA_0_3_LOAD]], 0, 3
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_4_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_4_LOAD:%.*]] = load float, ptr [[DOTFCA_0_4_GEP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_4_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_0_3_INSERT]], float [[DOTFCA_0_4_LOAD]], 0, 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_5_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 0, i32 5
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_5_LOAD:%.*]] = load i64, ptr [[DOTFCA_0_5_GEP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_5_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_0_4_INSERT]], i64 [[DOTFCA_0_5_LOAD]], 0, 5
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_1_0_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 1, i32 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_1_0_LOAD:%.*]] = load float, ptr [[DOTFCA_1_0_GEP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_1_0_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_0_5_INSERT]], float [[DOTFCA_1_0_LOAD]], 1, 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_1_1_GEP:%.*]] = getelementptr inbounds [[STRUCT_ANYHITTRAVERSALDATA]], ptr [[SYSTEM_DATA_ALLOCA]], i32 0, i32 1, i32 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_1_1_LOAD:%.*]] = load i32, ptr [[DOTFCA_1_1_GEP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_1_1_INSERT:%.*]] = insertvalue [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_1_0_INSERT]], i32 [[DOTFCA_1_1_LOAD]], 1, 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_INSERT:%.*]] = insertvalue [30 x i32] poison, i32 [[PAYLOAD_FCA_0_EXTRACT]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_1_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_0_INSERT]], i32 [[PAYLOAD_FCA_1_EXTRACT]], 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_2_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_1_INSERT]], i32 [[PAYLOAD_FCA_2_EXTRACT]], 2
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_3_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_2_INSERT]], i32 [[PAYLOAD_FCA_3_EXTRACT]], 3
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_4_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_3_INSERT]], i32 [[PAYLOAD_FCA_4_EXTRACT]], 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_5_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_4_INSERT]], i32 [[PAYLOAD_FCA_5_EXTRACT]], 5
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_6_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_5_INSERT]], i32 [[PAYLOAD_FCA_6_EXTRACT]], 6
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_7_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_6_INSERT]], i32 [[PAYLOAD_FCA_7_EXTRACT]], 7
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_8_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_7_INSERT]], i32 [[PAYLOAD_FCA_8_EXTRACT]], 8
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_9_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_8_INSERT]], i32 [[PAYLOAD_FCA_9_EXTRACT]], 9
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_10_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_9_INSERT]], i32 [[PAYLOAD_FCA_10_EXTRACT]], 10
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_11_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_10_INSERT]], i32 [[PAYLOAD_FCA_11_EXTRACT]], 11
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_12_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_11_INSERT]], i32 [[PAYLOAD_FCA_12_EXTRACT]], 12
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_13_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_12_INSERT]], i32 [[PAYLOAD_FCA_13_EXTRACT]], 13
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_14_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_13_INSERT]], i32 [[PAYLOAD_FCA_14_EXTRACT]], 14
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_15_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_14_INSERT]], i32 [[PAYLOAD_FCA_15_EXTRACT]], 15
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_16_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_15_INSERT]], i32 [[PAYLOAD_FCA_16_EXTRACT]], 16
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_17_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_16_INSERT]], i32 [[PAYLOAD_FCA_17_EXTRACT]], 17
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_18_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_17_INSERT]], i32 [[PAYLOAD_FCA_18_EXTRACT]], 18
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_19_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_18_INSERT]], i32 [[PAYLOAD_FCA_19_EXTRACT]], 19
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_20_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_19_INSERT]], i32 [[PAYLOAD_FCA_20_EXTRACT]], 20
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_21_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_20_INSERT]], i32 [[PAYLOAD_FCA_21_EXTRACT]], 21
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_22_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_21_INSERT]], i32 [[PAYLOAD_FCA_22_EXTRACT]], 22
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_23_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_22_INSERT]], i32 [[PAYLOAD_FCA_23_EXTRACT]], 23
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_24_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_23_INSERT]], i32 [[PAYLOAD_FCA_24_EXTRACT]], 24
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_25_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_24_INSERT]], i32 [[PAYLOAD_FCA_25_EXTRACT]], 25
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_26_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_25_INSERT]], i32 [[PAYLOAD_FCA_26_EXTRACT]], 26
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_27_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_26_INSERT]], i32 [[PAYLOAD_FCA_27_EXTRACT]], 27
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_28_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_27_INSERT]], i32 [[PAYLOAD_FCA_28_EXTRACT]], 28
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_29_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_28_INSERT]], i32 [[PAYLOAD_FCA_29_EXTRACT]], 29
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP143:%.*]] = zext i32 [[RETURNADDR]] to i64
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP144:%.*]] = load i32, ptr [[CSP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    call void (...) @lgc.ilcps.continue(i64 [[TMP143]], i32 [[TMP144]], i64 poison, i32 poison, [[STRUCT_ANYHITTRAVERSALDATA]] [[DOTFCA_1_1_INSERT]], [8 x i32] poison, [30 x i32] [[DOTFCA_29_INSERT]])
; POST-PROCESS-GLOBAL-CPS-NEXT:    unreachable
;
;
...
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP0:%.*]] = call i64 @_cont_GetContinuationStackGlobalMemBase()
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP1:%.*]] = inttoptr i64 [[TMP0]] to ptr addrspace(22)
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP2:%.*]] = load i32, ptr [[CSP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP3:%.*]] = add i32 [[TMP2]], 116
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP3]], ptr [[CSP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP4:%.*]] = add i32 [[TMP2]], 108
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP5:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP4]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[RETURNADDR]], ptr addrspace(22) [[TMP5]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_0_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP6:%.*]] = add i32 [[TMP2]], 112
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP7:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP6]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[PAYLOAD_FCA_0_EXTRACT]], ptr addrspace(22) [[TMP7]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_1_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_2_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 2
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_3_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 3
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_4_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 4
...
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_28_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 28
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[PAYLOAD_FCA_29_EXTRACT:%.*]] = extractvalue [30 x i32] [[PAYLOAD]], 29
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_0_0_EXTRACT:%.*]] = extractvalue [[STRUCT_SYSTEMDATA]] [[SYSTEM_DATA]], 0, 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYSTEM_DATA_FCA_1_0_EXTRACT:%.*]] = extractvalue [[STRUCT_SYSTEMDATA]] [[SYSTEM_DATA]], 1, 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP8:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[PAYLOAD_FCA_0_EXTRACT]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP9:%.*]] = load i32, ptr addrspace(22) [[TMP8]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP10:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP11:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP10]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP12:%.*]] = load i32, ptr addrspace(22) [[TMP11]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP13:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 8
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP14:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP13]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP15:%.*]] = load i32, ptr addrspace(22) [[TMP14]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP16:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 12
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP17:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP16]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP18:%.*]] = load i32, ptr addrspace(22) [[TMP17]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP19:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 16
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP20:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP19]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP21:%.*]] = load i32, ptr addrspace(22) [[TMP20]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP22:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 20
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP23:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP22]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP24:%.*]] = load i32, ptr addrspace(22) [[TMP23]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP25:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 24
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP26:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP25]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP27:%.*]] = load i32, ptr addrspace(22) [[TMP26]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP28:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 28
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP29:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP28]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP30:%.*]] = load i32, ptr addrspace(22) [[TMP29]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP31:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 32
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP32:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP31]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP33:%.*]] = load i32, ptr addrspace(22) [[TMP32]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP34:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 36
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP35:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP34]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP36:%.*]] = load i32, ptr addrspace(22) [[TMP35]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP37:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 40
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP38:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP37]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP39:%.*]] = load i32, ptr addrspace(22) [[TMP38]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP40:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 44
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP41:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP40]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP42:%.*]] = load i32, ptr addrspace(22) [[TMP41]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP43:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 48
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP44:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP43]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP45:%.*]] = load i32, ptr addrspace(22) [[TMP44]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP46:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 52
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP47:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP46]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP48:%.*]] = load i32, ptr addrspace(22) [[TMP47]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP49:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 56
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP50:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP49]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP51:%.*]] = load i32, ptr addrspace(22) [[TMP50]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP52:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 60
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP53:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP52]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP54:%.*]] = load i32, ptr addrspace(22) [[TMP53]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP55:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 64
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP56:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP55]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP57:%.*]] = load i32, ptr addrspace(22) [[TMP56]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP58:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 68
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP59:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP58]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP60:%.*]] = load i32, ptr addrspace(22) [[TMP59]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP61:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 72
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP62:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP61]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP63:%.*]] = load i32, ptr addrspace(22) [[TMP62]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP64:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 76
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP65:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP64]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP66:%.*]] = load i32, ptr addrspace(22) [[TMP65]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP67:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 80
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP68:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP67]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP69:%.*]] = load i32, ptr addrspace(22) [[TMP68]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP70:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 84
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP71:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP70]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP72:%.*]] = load i32, ptr addrspace(22) [[TMP71]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP73:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 88
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP74:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP73]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP75:%.*]] = load i32, ptr addrspace(22) [[TMP74]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP76:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 92
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP77:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP76]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP78:%.*]] = load i32, ptr addrspace(22) [[TMP77]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP79:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 96
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP80:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP79]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP81:%.*]] = load i32, ptr addrspace(22) [[TMP80]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP82:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 100
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP83:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP82]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP84:%.*]] = load i32, ptr addrspace(22) [[TMP83]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP85:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT]], 104
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP86:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP85]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP87:%.*]] = load i32, ptr addrspace(22) [[TMP86]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[VAL_I_FCA_0_INSERT:%.*]] = insertvalue [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES:%.*]] poison, <2 x float> [[SYSTEM_DATA_FCA_1_0_EXTRACT]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[VAL_I_FCA_0_INSERT_FCA_0_EXTRACT:%.*]] = extractvalue [[STRUCT_BUILTINTRIANGLEINTERSECTIONATTRIBUTES]] [[VAL_I_FCA_0_INSERT]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTSROA_0257_0_VEC_EXTRACT:%.*]] = extractelement <2 x float> [[VAL_I_FCA_0_INSERT_FCA_0_EXTRACT]], i32 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP88:%.*]] = bitcast float [[DOTSROA_0257_0_VEC_EXTRACT]] to i32
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTSROA_0257_4_VEC_EXTRACT:%.*]] = extractelement <2 x float> [[VAL_I_FCA_0_INSERT_FCA_0_EXTRACT]], i32 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP89:%.*]] = bitcast float [[DOTSROA_0257_4_VEC_EXTRACT]] to i32
; POST-PROCESS-GLOBAL-CPS-NEXT:    call void @amd.dx.setLocalRootIndex(i32 [[SHADER_INDEX]])
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP90:%.*]] = load [[DX_TYPES_HANDLE:%.*]], ptr @"\01?Scene@@3URaytracingAccelerationStructure@@A", align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP91:%.*]] = load [[DX_TYPES_HANDLE]], ptr @"\01?RenderTarget@@3V?$RWTexture2D@V?$vector@M$03@@@@A", align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP92:%.*]] = call [[DX_TYPES_HANDLE]] @[[DX_OP_CREATEHANDLEFORLIB_DX_TYPES_HANDLE]](i32 160, [[DX_TYPES_HANDLE]] [[TMP90]])
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP93:%.*]] = call [[DX_TYPES_HANDLE]] @[[DX_OP_ANNOTATEHANDLE]](i32 216, [[DX_TYPES_HANDLE]] [[TMP92]], [[DX_TYPES_RESOURCEPROPERTIES:%.*]] { i32 16, i32 0 })
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP94:%.*]] = call i64 @amd.dx.getAccelStructAddr([[DX_TYPES_HANDLE]] [[TMP93]])
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DIS_DATA_I_FCA_0_INSERT:%.*]] = insertvalue [[STRUCT_DISPATCHSYSTEMDATA:%.*]] poison, <3 x i32> [[SYSTEM_DATA_FCA_0_0_EXTRACT]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[SYS_DATA_I:%.*]] = insertvalue [[STRUCT_SYSTEMDATA]] undef, [[STRUCT_DISPATCHSYSTEMDATA]] [[DIS_DATA_I_FCA_0_INSERT]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TRAV_DATA_I:%.*]] = insertvalue [[STRUCT_TRAVERSALDATA:%.*]] undef, [[STRUCT_SYSTEMDATA]] [[SYS_DATA_I]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP95:%.*]] = call i64 @continuation.getAddrAndMD(ptr @ClosestHit.resume.0)
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TRAV_DATA2_I:%.*]] = insertvalue [[STRUCT_TRAVERSALDATA]] [[TRAV_DATA_I]], i64 [[TMP95]], 5
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP96:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP2]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP9]], ptr addrspace(22) [[TMP96]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP97:%.*]] = add i32 [[TMP2]], 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP98:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP97]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP12]], ptr addrspace(22) [[TMP98]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP99:%.*]] = add i32 [[TMP2]], 8
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP100:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP99]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP15]], ptr addrspace(22) [[TMP100]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP101:%.*]] = add i32 [[TMP2]], 12
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP102:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP101]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP18]], ptr addrspace(22) [[TMP102]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP103:%.*]] = add i32 [[TMP2]], 16
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP104:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP103]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP21]], ptr addrspace(22) [[TMP104]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP105:%.*]] = add i32 [[TMP2]], 20
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP106:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP105]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP24]], ptr addrspace(22) [[TMP106]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP107:%.*]] = add i32 [[TMP2]], 24
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP108:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP107]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP27]], ptr addrspace(22) [[TMP108]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP109:%.*]] = add i32 [[TMP2]], 28
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP110:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP109]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP30]], ptr addrspace(22) [[TMP110]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP111:%.*]] = add i32 [[TMP2]], 32
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP112:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP111]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP33]], ptr addrspace(22) [[TMP112]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP113:%.*]] = add i32 [[TMP2]], 36
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP114:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP113]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP36]], ptr addrspace(22) [[TMP114]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP115:%.*]] = add i32 [[TMP2]], 40
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP116:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP115]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP39]], ptr addrspace(22) [[TMP116]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP117:%.*]] = add i32 [[TMP2]], 44
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP118:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP117]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP42]], ptr addrspace(22) [[TMP118]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP119:%.*]] = add i32 [[TMP2]], 48
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP120:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP119]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP45]], ptr addrspace(22) [[TMP120]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP121:%.*]] = add i32 [[TMP2]], 52
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP122:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP121]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP48]], ptr addrspace(22) [[TMP122]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP123:%.*]] = add i32 [[TMP2]], 56
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP124:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP123]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP51]], ptr addrspace(22) [[TMP124]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP125:%.*]] = add i32 [[TMP2]], 60
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP126:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP125]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP54]], ptr addrspace(22) [[TMP126]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP127:%.*]] = add i32 [[TMP2]], 64
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP128:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP127]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP57]], ptr addrspace(22) [[TMP128]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP129:%.*]] = add i32 [[TMP2]], 68
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP130:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP129]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP60]], ptr addrspace(22) [[TMP130]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP131:%.*]] = add i32 [[TMP2]], 72
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP132:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP131]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP63]], ptr addrspace(22) [[TMP132]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP133:%.*]] = add i32 [[TMP2]], 76
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP134:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP133]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP66]], ptr addrspace(22) [[TMP134]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP135:%.*]] = add i32 [[TMP2]], 80
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP136:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP135]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP69]], ptr addrspace(22) [[TMP136]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP137:%.*]] = add i32 [[TMP2]], 84
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP138:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP137]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP72]], ptr addrspace(22) [[TMP138]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP139:%.*]] = add i32 [[TMP2]], 88
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP140:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP139]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP75]], ptr addrspace(22) [[TMP140]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP141:%.*]] = add i32 [[TMP2]], 92
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP142:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP141]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP78]], ptr addrspace(22) [[TMP142]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP143:%.*]] = add i32 [[TMP2]], 96
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP144:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP143]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP81]], ptr addrspace(22) [[TMP144]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP145:%.*]] = add i32 [[TMP2]], 100
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP146:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP145]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP84]], ptr addrspace(22) [[TMP146]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP147:%.*]] = add i32 [[TMP2]], 104
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP148:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP1]], i32 [[TMP147]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP87]], ptr addrspace(22) [[TMP148]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_INSERT54:%.*]] = insertvalue [30 x i32] poison, i32 [[TMP2]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_1_INSERT57:%.*]] = insertvalue [30 x i32] [[DOTFCA_0_INSERT54]], i32 [[PAYLOAD_FCA_1_EXTRACT]], 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_2_INSERT60:%.*]] = insertvalue [30 x i32] [[DOTFCA_1_INSERT57]], i32 [[PAYLOAD_FCA_2_EXTRACT]], 2
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_3_INSERT63:%.*]] = insertvalue [30 x i32] [[DOTFCA_2_INSERT60]], i32 [[PAYLOAD_FCA_3_EXTRACT]], 3
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_4_INSERT66:%.*]] = insertvalue [30 x i32] [[DOTFCA_3_INSERT63]], i32 [[PAYLOAD_FCA_4_EXTRACT]], 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_5_INSERT69:%.*]] = insertvalue [30 x i32] [[DOTFCA_4_INSERT66]], i32 [[PAYLOAD_FCA_5_EXTRACT]], 5
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_6_INSERT72:%.*]] = insertvalue [30 x i32] [[DOTFCA_5_INSERT69]], i32 [[PAYLOAD_FCA_6_EXTRACT]], 6
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_7_INSERT75:%.*]] = insertvalue [30 x i32] [[DOTFCA_6_INSERT72]], i32 [[PAYLOAD_FCA_7_EXTRACT]], 7
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_8_INSERT78:%.*]] = insertvalue [30 x i32] [[DOTFCA_7_INSERT75]], i32 [[PAYLOAD_FCA_8_EXTRACT]], 8
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_9_INSERT81:%.*]] = insertvalue [30 x i32] [[DOTFCA_8_INSERT78]], i32 [[PAYLOAD_FCA_9_EXTRACT]], 9
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_10_INSERT84:%.*]] = insertvalue [30 x i32] [[DOTFCA_9_INSERT81]], i32 [[PAYLOAD_FCA_10_EXTRACT]], 10
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_11_INSERT87:%.*]] = insertvalue [30 x i32] [[DOTFCA_10_INSERT84]], i32 [[PAYLOAD_FCA_11_EXTRACT]], 11
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_12_INSERT90:%.*]] = insertvalue [30 x i32] [[DOTFCA_11_INSERT87]], i32 [[PAYLOAD_FCA_12_EXTRACT]], 12
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_13_INSERT93:%.*]] = insertvalue [30 x i32] [[DOTFCA_12_INSERT90]], i32 [[PAYLOAD_FCA_13_EXTRACT]], 13
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_14_INSERT96:%.*]] = insertvalue [30 x i32] [[DOTFCA_13_INSERT93]], i32 [[PAYLOAD_FCA_14_EXTRACT]], 14
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_15_INSERT99:%.*]] = insertvalue [30 x i32] [[DOTFCA_14_INSERT96]], i32 [[PAYLOAD_FCA_15_EXTRACT]], 15
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_16_INSERT102:%.*]] = insertvalue [30 x i32] [[DOTFCA_15_INSERT99]], i32 [[PAYLOAD_FCA_16_EXTRACT]], 16
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_17_INSERT105:%.*]] = insertvalue [30 x i32] [[DOTFCA_16_INSERT102]], i32 [[PAYLOAD_FCA_17_EXTRACT]], 17
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_18_INSERT108:%.*]] = insertvalue [30 x i32] [[DOTFCA_17_INSERT105]], i32 [[PAYLOAD_FCA_18_EXTRACT]], 18
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_19_INSERT111:%.*]] = insertvalue [30 x i32] [[DOTFCA_18_INSERT108]], i32 [[PAYLOAD_FCA_19_EXTRACT]], 19
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_20_INSERT114:%.*]] = insertvalue [30 x i32] [[DOTFCA_19_INSERT111]], i32 [[PAYLOAD_FCA_20_EXTRACT]], 20
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_21_INSERT117:%.*]] = insertvalue [30 x i32] [[DOTFCA_20_INSERT114]], i32 [[PAYLOAD_FCA_21_EXTRACT]], 21
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_22_INSERT120:%.*]] = insertvalue [30 x i32] [[DOTFCA_21_INSERT117]], i32 [[PAYLOAD_FCA_22_EXTRACT]], 22
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_23_INSERT123:%.*]] = insertvalue [30 x i32] [[DOTFCA_22_INSERT120]], i32 [[PAYLOAD_FCA_23_EXTRACT]], 23
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_24_INSERT126:%.*]] = insertvalue [30 x i32] [[DOTFCA_23_INSERT123]], i32 [[PAYLOAD_FCA_24_EXTRACT]], 24
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_25_INSERT129:%.*]] = insertvalue [30 x i32] [[DOTFCA_24_INSERT126]], i32 [[PAYLOAD_FCA_25_EXTRACT]], 25
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_26_INSERT132:%.*]] = insertvalue [30 x i32] [[DOTFCA_25_INSERT129]], i32 [[PAYLOAD_FCA_26_EXTRACT]], 26
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_27_INSERT135:%.*]] = insertvalue [30 x i32] [[DOTFCA_26_INSERT132]], i32 [[PAYLOAD_FCA_27_EXTRACT]], 27
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_28_INSERT138:%.*]] = insertvalue [30 x i32] [[DOTFCA_27_INSERT135]], i32 [[PAYLOAD_FCA_28_EXTRACT]], 28
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_29_INSERT141:%.*]] = insertvalue [30 x i32] [[DOTFCA_28_INSERT138]], i32 [[PAYLOAD_FCA_29_EXTRACT]], 29
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP149:%.*]] = load i32, ptr [[CSP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    call void (...) @lgc.ilcps.waitContinue(i64 4, i64 -1, i32 [[TMP149]], i64 [[TMP95]], [[STRUCT_TRAVERSALDATA]] [[TRAV_DATA2_I]], [10 x i32] poison, [30 x i32] [[DOTFCA_29_INSERT141]])
; POST-PROCESS-GLOBAL-CPS-NEXT:    unreachable
;
;
; POST-PROCESS-GLOBAL-CPS-LABEL: define dso_local void @ClosestHit.resume.0(
; POST-PROCESS-GLOBAL-CPS-SAME: {} [[TMP0:%.*]], i32 [[CSPINIT:%.*]], i32 [[TMP1:%.*]], i32 [[TMP2:%.*]], { [[STRUCT_DISPATCHSYSTEMDATA:%.*]], [23 x i32], [30 x i32] } [[TMP3:%.*]]) !lgc.rt.shaderstage [[META25]] !lgc.cps [[META22]] !continuation [[META26]] {
; POST-PROCESS-GLOBAL-CPS-NEXT:  entryresume.0:
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[CSP:%.*]] = alloca i32, align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[CSPINIT]], ptr [[CSP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP4:%.*]] = call i64 @_cont_GetContinuationStackGlobalMemBase()
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP5:%.*]] = inttoptr i64 [[TMP4]] to ptr addrspace(22)
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP6:%.*]] = load i32, ptr [[CSP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP7:%.*]] = add i32 [[TMP6]], -116
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP8:%.*]] = extractvalue { [[STRUCT_DISPATCHSYSTEMDATA]], [23 x i32], [30 x i32] } [[TMP3]], 2
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_1_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_2_EXTRACT:%.*]] = extractvalue [30 x i32] [[TMP8]], 2
...
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP96:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP95]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP13]], ptr addrspace(22) [[TMP96]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP97:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 8
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP98:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP97]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP16]], ptr addrspace(22) [[TMP98]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP99:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 12
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP100:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP99]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP19]], ptr addrspace(22) [[TMP100]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP101:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 16
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP102:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP101]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP22]], ptr addrspace(22) [[TMP102]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP103:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 20
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP104:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP103]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP25]], ptr addrspace(22) [[TMP104]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP105:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 24
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP106:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP105]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP28]], ptr addrspace(22) [[TMP106]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP107:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 28
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP108:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP107]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP31]], ptr addrspace(22) [[TMP108]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP109:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 32
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP110:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP109]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP34]], ptr addrspace(22) [[TMP110]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP111:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 36
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP112:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP111]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP37]], ptr addrspace(22) [[TMP112]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP113:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 40
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP114:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP113]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP40]], ptr addrspace(22) [[TMP114]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP115:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 44
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP116:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP115]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP43]], ptr addrspace(22) [[TMP116]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP117:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 48
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP118:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP117]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP46]], ptr addrspace(22) [[TMP118]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP119:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 52
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP120:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP119]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP49]], ptr addrspace(22) [[TMP120]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP121:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 56
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP122:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP121]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP52]], ptr addrspace(22) [[TMP122]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP123:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 60
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP124:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP123]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP55]], ptr addrspace(22) [[TMP124]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP125:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 64
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP126:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP125]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP58]], ptr addrspace(22) [[TMP126]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP127:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 68
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP128:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP127]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP61]], ptr addrspace(22) [[TMP128]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP129:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 72
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP130:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP129]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP64]], ptr addrspace(22) [[TMP130]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP131:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 76
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP132:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP131]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP67]], ptr addrspace(22) [[TMP132]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP133:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 80
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP134:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP133]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP70]], ptr addrspace(22) [[TMP134]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP135:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 84
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP136:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP135]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP73]], ptr addrspace(22) [[TMP136]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP137:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 88
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP138:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP137]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP76]], ptr addrspace(22) [[TMP138]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP139:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 92
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP140:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP139]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP79]], ptr addrspace(22) [[TMP140]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP141:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 96
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP142:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP141]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP82]], ptr addrspace(22) [[TMP142]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP143:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 100
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP144:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP143]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP85]], ptr addrspace(22) [[TMP144]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP145:%.*]] = add i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 104
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP146:%.*]] = getelementptr i8, ptr addrspace(22) [[TMP5]], i32 [[TMP145]]
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP88]], ptr addrspace(22) [[TMP146]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_INSERT253:%.*]] = insertvalue [[STRUCT_DISPATCHSYSTEMDATA]] poison, <3 x i32> [[DOTFCA_0_EXTRACT254]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_0_INSERT:%.*]] = insertvalue [30 x i32] poison, i32 [[PAYLOAD_FCA_0_EXTRACT_RELOAD]], 0
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_1_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_0_INSERT]], i32 [[DOTFCA_1_EXTRACT]], 1
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_2_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_1_INSERT]], i32 [[DOTFCA_2_EXTRACT]], 2
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_3_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_2_INSERT]], i32 [[DOTFCA_3_EXTRACT]], 3
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_4_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_3_INSERT]], i32 [[DOTFCA_4_EXTRACT]], 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_5_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_4_INSERT]], i32 [[DOTFCA_5_EXTRACT]], 5
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_6_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_5_INSERT]], i32 [[DOTFCA_6_EXTRACT]], 6
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_7_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_6_INSERT]], i32 [[DOTFCA_7_EXTRACT]], 7
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_8_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_7_INSERT]], i32 [[DOTFCA_8_EXTRACT]], 8
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_9_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_8_INSERT]], i32 [[DOTFCA_9_EXTRACT]], 9
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_10_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_9_INSERT]], i32 [[DOTFCA_10_EXTRACT]], 10
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_11_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_10_INSERT]], i32 [[DOTFCA_11_EXTRACT]], 11
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_12_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_11_INSERT]], i32 [[DOTFCA_12_EXTRACT]], 12
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_13_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_12_INSERT]], i32 [[DOTFCA_13_EXTRACT]], 13
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_14_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_13_INSERT]], i32 [[DOTFCA_14_EXTRACT]], 14
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_15_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_14_INSERT]], i32 [[DOTFCA_15_EXTRACT]], 15
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_16_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_15_INSERT]], i32 [[DOTFCA_16_EXTRACT]], 16
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_17_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_16_INSERT]], i32 [[DOTFCA_17_EXTRACT]], 17
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_18_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_17_INSERT]], i32 [[DOTFCA_18_EXTRACT]], 18
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_19_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_18_INSERT]], i32 [[DOTFCA_19_EXTRACT]], 19
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_20_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_19_INSERT]], i32 [[DOTFCA_20_EXTRACT]], 20
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_21_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_20_INSERT]], i32 [[DOTFCA_21_EXTRACT]], 21
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_22_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_21_INSERT]], i32 [[DOTFCA_22_EXTRACT]], 22
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_23_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_22_INSERT]], i32 [[DOTFCA_23_EXTRACT]], 23
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_24_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_23_INSERT]], i32 [[DOTFCA_24_EXTRACT]], 24
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_25_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_24_INSERT]], i32 [[DOTFCA_25_EXTRACT]], 25
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_26_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_25_INSERT]], i32 [[DOTFCA_26_EXTRACT]], 26
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_27_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_26_INSERT]], i32 [[DOTFCA_27_EXTRACT]], 27
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_28_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_27_INSERT]], i32 [[DOTFCA_28_EXTRACT]], 28
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[DOTFCA_29_INSERT:%.*]] = insertvalue [30 x i32] [[DOTFCA_28_INSERT]], i32 [[DOTFCA_29_EXTRACT]], 29
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP147:%.*]] = load i32, ptr [[CSP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP148:%.*]] = add i32 [[TMP147]], -116
; POST-PROCESS-GLOBAL-CPS-NEXT:    store i32 [[TMP148]], ptr [[CSP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP149:%.*]] = zext i32 [[RETURNADDR_RELOAD]] to i64
; POST-PROCESS-GLOBAL-CPS-NEXT:    [[TMP150:%.*]] = load i32, ptr [[CSP]], align 4
; POST-PROCESS-GLOBAL-CPS-NEXT:    call void (...) @lgc.ilcps.continue(i64 [[TMP149]], i32 [[TMP150]], i64 poison, i32 poison, [[STRUCT_DISPATCHSYSTEMDATA]] [[DOTFCA_0_INSERT253]], [23 x i32] poison, [30 x i32] [[DOTFCA_29_INSERT]])
; POST-PROCESS-GLOBAL-CPS-NEXT:    unreachable
;
