; RUN: opt --opaque-pointers=0 --enforce-pointer-metadata=1 --verify-each -passes='add-types-metadata,dxil-cont-lgc-rt-op-converter,lint,lower-raytracing-pipeline,lint,remove-types-metadata' -S %s 2>%t0.stderr | FileCheck -check-prefix=LOWERRAYTRACINGPIPELINE-STACKSIZE %s
...
; CLEANUP-STACKSIZE-DAG: ![[maintrace_stacksize]] = !{i32 188}
...
; SAVESTATE-STACKSIZE-DAG: ![[maintrace_stacksize]] = !{i32 188}
