...
; CHECK-SAME: ) !lgc.rt.shaderstage [[META5:![0-9]+]] !continuation.entry [[META11:![0-9]+]] !continuation.registercount [[META5]] !continuation [[META12:![0-9]+]] !continuation.state [[META5]] !continuation.stacksize [[META13:![0-9]+]] {
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr @debug_global, align 4
; CHECK-NEXT:    [[TMP1:%.*]] = add i32 [[TMP0]], 120
; CHECK-NEXT:    store i32 [[TMP1]], ptr @debug_global, align 4
; CHECK-NEXT:    store i32 [[TMP0]], ptr @debug_global, align 4
