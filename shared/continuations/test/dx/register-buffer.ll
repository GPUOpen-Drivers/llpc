...
; CHECK-SAME: i32 [[I:%.*]]) {
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr addrspace(21) @registerbuffer.getpointer.a0i32(ptr addrspace(20) @GLOBAL_NO_REGS)
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr [20 x i32], ptr addrspace(21) [[TMP1]], i32 0, i32 [[I]]
; CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr addrspace(21) [[TMP2]], align 4
