; RUN: opt --enforce-pointer-metadata=1 --opaque-pointers=0 --verify-each -passes='add-types-metadata,dxil-cont-lgc-rt-op-converter,lint,remove-types-metadata' -S %s 2>%t0.stderr | FileCheck -check-prefix=PAYLOADTYPE %s
; RUN: count 0 < %t0.stderr
; RUN: opt --enforce-pointer-metadata=1 --opaque-pointers=1 --verify-each -passes='add-types-metadata,dxil-cont-lgc-rt-op-converter,lint,remove-types-metadata' -S %s 2>%t1.stderr | FileCheck -check-prefix=PAYLOADTYPE-OPAQUE %s
; RUN: count 0 < %t1.stderr
; RUN: opt --enforce-pointer-metadata=1 --opaque-pointers=0 --verify-each -passes='add-types-metadata,dxil-cont-lgc-rt-op-converter,lint,remove-types-metadata' -S %s 2>%t2.stderr | FileCheck -check-prefix=PAYLOADTYPE2 %s
; RUN: count 0 < %t2.stderr
; RUN: opt --enforce-pointer-metadata=1 --opaque-pointers=1 --verify-each -passes='add-types-metadata,dxil-cont-lgc-rt-op-converter,lint,remove-types-metadata' -S %s 2>%t3.stderr | FileCheck -check-prefix=PAYLOADTYPE2-OPAQUE %s
; RUN: count 0 < %t3.stderr
; RUN: opt --enforce-pointer-metadata=1 --opaque-pointers=0 --verify-each -passes='add-types-metadata,dxil-cont-lgc-rt-op-converter,lint,remove-types-metadata' -S %s 2>%t4.stderr | FileCheck -check-prefix=PAYLOADTYPE3 %s
; RUN: count 0 < %t4.stderr
; RUN: opt --enforce-pointer-metadata=1 --opaque-pointers=1 --verify-each -passes='add-types-metadata,dxil-cont-lgc-rt-op-converter,lint,remove-types-metadata' -S %s 2>%t5.stderr | FileCheck -check-prefix=PAYLOADTYPE3-OPAQUE %s
