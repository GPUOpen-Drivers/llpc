...
; RUN: opt --enforce-pointer-metadata=1 --opaque-pointers=1 --verify-each -passes='dxil-cont-lgc-rt-op-converter,lint' -S %s 2>%t0.stderr | FileCheck %s
...
; CHECK-NEXT:    [[TMP6:%.*]] = call i1 (...) @lgc.rt.report.hit(float 4.000000e+00, i32 0, ptr [[TMP5]], i32 8)
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    call void (...) @lgc.rt.call.callable.shader(i32 1, ptr [[PARAMS]], i32 256), !dxil.payload.type
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    call void (...) @lgc.rt.trace.ray(i64 [[TMP7]], i32 16, i32 -1, i32 0, i32 1, i32 0, <3 x float> zeroinitializer, float 0x3F50624DE0000000, <3 x float> <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00>, float 1.000000e+04, ptr [[TMP3]], [1 x i32] [i32 272]), !dxil.payload.type
; CHECK-NEXT:    ret void
;
...
; CHECK-SAME: (ptr [[ARG:%.*]]) !types !{{[0-9]+}} !dxil.payload.type ![[callable_payload_type:[0-9]+]] {
; CHECK-NEXT:    [[PARAMS:%.*]] = alloca [[STRUCT_THEIRPARAMS2:%.*]], align 4
; CHECK-NEXT:    call void (...) @lgc.rt.call.callable.shader(i32 2, ptr [[PARAMS]], i32 260), !dxil.payload.type
; CHECK-NEXT:    ret void
; CHECK: ![[callable_payload_type]] = !{%struct.MyParams poison}
;
