...
define void @test({} %state, i32 %rcr, float %arg, i32 %arg1) !lgc.cps !0 {
  ...
  %a2 = alloca i32, align 4, addrspace(5)
  %cond = icmp ult i32 %arg1, 0
  %p = select i1 %cond, ptr addrspace(5) %a1, ptr addrspace(5) %a2
  store i32 111, ptr addrspace(5) %p, align 4
  ...
  %v111 = load float, ptr addrspace(5) %p, align 4
