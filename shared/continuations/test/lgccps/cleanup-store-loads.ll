...
entryresume.0:
  ...
  %3 = call float @continuations.getReturnValue.f32()
...
declare float @continuations.getReturnValue.f32() #2
...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[TMP0:%.*]] = call ptr addrspace(32) @lgc.cps.alloc(i32 408)
...
; CHECK-NEXT:    [[DATA:%.*]] = getelementptr inbounds [[TEST_FRAME]], ptr addrspace(32) [[TMP0]], i32 0, i32 2
