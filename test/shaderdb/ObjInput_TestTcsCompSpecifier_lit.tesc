...
; SHADERTEST: call float @llpc.input.import.generic.f32{{.*}}(i32 0, i32 0, i32 2, i32 %
; SHADERTEST: call <2 x float> @llpc.input.import.generic.v2f32{{.*}}(i32 0, i32 0, i32 0, i32 %
