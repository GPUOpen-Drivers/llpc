...
; SHADERTEST: call void @llpc.buffer.store.v16i8(<4 x i32> %{{[0-9]*}}, i32 32, <16 x i8> <i8 0, i8 0, i8 0, i8 64, i8 0, i8 0, i8 0, i8 64, i8 0, i8 0, i8 0, i8 64, i8 0, i8 0, i8 0, i8 64>, i32 0
...
; SHADERTEST: call void @llvm.amdgcn.raw.buffer.store.v4f32(<4 x float> <float 2.000000e+00, float 2.000000e+00, float 2.000000e+00, float 2.000000e+00>, <4 x i32> %{{[0-9]*}}, i32 32, i32 0, i32 0)
