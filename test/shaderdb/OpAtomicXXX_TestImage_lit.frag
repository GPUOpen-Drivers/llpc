...
; SHADERTEST: call i32 (...) @llpc.call.image.atomic.i32(i32 2, i32 0, i32 0, i32 0, <8 x i32>
; SHADERTEST: call i32 (...) @llpc.call.image.atomic.i32(i32 4, i32 1, i32 0, i32 0, <8 x i32>
; SHADERTEST: call i32 (...) @llpc.call.image.atomic.i32(i32 6, i32 1, i32 0, i32 0, <8 x i32>
; SHADERTEST: call i32 (...) @llpc.call.image.atomic.i32(i32 8, i32 6, i32 0, i32 0, <8 x i32>
; SHADERTEST: call i32 (...) @llpc.call.image.atomic.i32(i32 9, i32 0, i32 0, i32 0, <8 x i32>
; SHADERTEST: call i32 (...) @llpc.call.image.atomic.i32(i32 10, i32 0, i32 0, i32 0, <8 x i32>
; SHADERTEST: call i32 (...) @llpc.call.image.atomic.i32(i32 0, i32 0, i32 0, i32 0, <8 x i32>
; SHADERTEST: call i32 (...) @llpc.call.image.atomic.compare.swap.i32(i32 0, i32 0, i32 0, <8 x i32>
; SHADERTEST: call i32 (...) @llpc.call.image.atomic.i32(i32 2, i32 3, i32 0, i32 0, <8 x i32>
; SHADERTEST: call i32 (...) @llpc.call.image.atomic.i32(i32 5, i32 0, i32 0, i32 0, <4 x i32>
; SHADERTEST: call i32 (...) @llpc.call.image.atomic.i32(i32 7, i32 0, i32 0, i32 0, <4 x i32>
; SHADERTEST: call i32 (...) @llpc.call.image.atomic.i32(i32 8, i32 7, i32 0, i32 0, <8 x i32>
; SHADERTEST: call i32 (...) @llpc.call.image.atomic.i32(i32 9, i32 3, i32 0, i32 0, <8 x i32>
; SHADERTEST: call i32 (...) @llpc.call.image.atomic.i32(i32 10, i32 3, i32 0, i32 0, <8 x i32>
; SHADERTEST: call i32 (...) @llpc.call.image.atomic.i32(i32 0, i32 3, i32 0, i32 0, <8 x i32>
; SHADERTEST: call i32 (...) @llpc.call.image.atomic.compare.swap.i32(i32 3, i32 0, i32 0, <8 x i32>
; SHADERTEST: call reassoc nnan nsz arcp contract float (...) @llpc.call.image.atomic.f32(i32 0, i32 1, i32 0, i32 0, <8 x i32>
