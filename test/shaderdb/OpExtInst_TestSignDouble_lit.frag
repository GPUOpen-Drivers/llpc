...
; SHADERTEST: = call reassoc nnan nsz arcp contract double (...) @llpc.call.fsign.f64(double
; SHADERTEST: = call reassoc nnan nsz arcp contract <3 x double> (...) @llpc.call.fsign.v3f64(<3 x double>
