...
; SHADERTEST: call <4 x i32> {{.*}} @llpc.call.desc.load.sampler.v4i32(i32 0, i32 4, i32 0, i1 false)
; SHADERTEST: call <8 x i32> {{.*}} @llpc.call.desc.load.resource.v8i32(i32 0, i32 4, i32 0, i1 false)
; SHADERTEST: call <2 x float> @llpc.image.querylod.f32.1D{{.*}}({{.*}},{{.*}}, float 7.000000e+00,{{.*}})
; SHADERTEST: call <4 x i32> {{.*}} @llpc.call.desc.load.sampler.v4i32(i32 0, i32 5, i32 0, i1 false)
; SHADERTEST: call <8 x i32> {{.*}} @llpc.call.desc.load.resource.v8i32(i32 0, i32 5, i32 0, i1 false)
; SHADERTEST: call <2 x float> @llpc.image.querylod.f32.2D{{.*}}({{.*}},{{.*}}, <2 x float> <float 7.000000e+00, float 8.000000e+00>,{{.*}})
; SHADERTEST: call <4 x i32> {{.*}} @llpc.call.desc.load.sampler.v4i32(i32 0, i32 6, i32 0, i1 false)
; SHADERTEST: call <8 x i32> {{.*}} @llpc.call.desc.load.resource.v8i32(i32 0, i32 6, i32 0, i1 false)
; SHADERTEST: call <2 x float> @llpc.image.querylod.f32.Cube{{.*}}({{.*}},{{.*}}, <3 x float> <float 7.000000e+00, float 8.000000e+00, float 9.000000e+00>,{{.*}})
; SHADERTEST: call <4 x i32> {{.*}} @llpc.call.desc.load.sampler.v4i32(i32 0, i32 7, i32 0, i1 false)
; SHADERTEST: call <8 x i32> {{.*}} @llpc.call.desc.load.resource.v8i32(i32 0, i32 7, i32 0, i1 false)
; SHADERTEST: call <2 x float> @llpc.image.querylod.f32.1D{{.*}}({{.*}},{{.*}}, float 7.000000e+00,{{.*}})
; SHADERTEST: call <4 x i32> {{.*}} @llpc.call.desc.load.sampler.v4i32(i32 0, i32 8, i32 0, i1 false)
; SHADERTEST: call <8 x i32> {{.*}} @llpc.call.desc.load.resource.v8i32(i32 0, i32 8, i32 0, i1 false)
; SHADERTEST: call <2 x float> @llpc.image.querylod.f32.2D{{.*}}({{.*}},{{.*}}, <2 x float> <float 7.000000e+00, float 8.000000e+00>,{{.*}})
; SHADERTEST: call <4 x i32> {{.*}} @llpc.call.desc.load.sampler.v4i32(i32 0, i32 9, i32 0, i1 false)
; SHADERTEST: call <8 x i32> {{.*}} @llpc.call.desc.load.resource.v8i32(i32 0, i32 9, i32 0, i1 false)
; SHADERTEST: call <2 x float> @llpc.image.querylod.f32.Cube{{.*}}({{.*}},{{.*}}, <3 x float> <float 7.000000e+00, float 8.000000e+00, float 9.000000e+00>,{{.*}})
; SHADERTEST: call <4 x i32> {{.*}} @llpc.call.desc.load.sampler.v4i32(i32 0, i32 10, i32 0, i1 false)
; SHADERTEST: call <8 x i32> {{.*}} @llpc.call.desc.load.resource.v8i32(i32 0, i32 10, i32 0, i1 false)
; SHADERTEST: call <2 x float> @llpc.image.querylod.f32.1D{{.*}}({{.*}},{{.*}}, float 7.000000e+00,{{.*}})
; SHADERTEST: call <4 x i32> {{.*}} @llpc.call.desc.load.sampler.v4i32(i32 0, i32 11, i32 0, i1 false)
; SHADERTEST: call <8 x i32> {{.*}} @llpc.call.desc.load.resource.v8i32(i32 0, i32 11, i32 0, i1 false)
; SHADERTEST: call <2 x float> @llpc.image.querylod.f32.2D{{.*}}({{.*}},{{.*}}, <2 x float> <float 7.000000e+00, float 8.000000e+00>,{{.*}})
; SHADERTEST: call <4 x i32> {{.*}} @llpc.call.desc.load.sampler.v4i32(i32 0, i32 12, i32 0, i1 false)
; SHADERTEST: call <8 x i32> {{.*}} @llpc.call.desc.load.resource.v8i32(i32 0, i32 12, i32 0, i1 false)
; SHADERTEST: call <2 x float> @llpc.image.querylod.f32.Cube{{.*}}({{.*}},{{.*}}, <3 x float> <float 7.000000e+00, float 8.000000e+00, float 9.000000e+00>,{{.*}})
