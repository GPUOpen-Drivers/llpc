...
; SHADERTEST: call <2 x float> (...) @llpc.call.image.get.lod.v2f32(i32 0, i32 0, {{.*}}, {{.*}}, float 7.000000e+00)
...
; SHADERTEST: call <2 x float> (...) @llpc.call.image.get.lod.v2f32(i32 1, i32 0, {{.*}}, {{.*}}, <2 x float> <float 7.000000e+00, float 8.000000e+00>)
...
; SHADERTEST: call <2 x float> (...) @llpc.call.image.get.lod.v2f32(i32 2, i32 0, {{.*}}, {{.*}}, <3 x float> <float 7.000000e+00, float 8.000000e+00, float 9.000000e+00>)
...
; SHADERTEST: call <2 x float> (...) @llpc.call.image.get.lod.v2f32(i32 3, i32 0, {{.*}}, {{.*}}, <3 x float> <float 7.000000e+00, float 8.000000e+00, float 9.000000e+00>)
...
; SHADERTEST: call <2 x float> (...) @llpc.call.image.get.lod.v2f32(i32 4, i32 0, {{.*}}, {{.*}}, float 7.000000e+00)
...
; SHADERTEST: call <2 x float> (...) @llpc.call.image.get.lod.v2f32(i32 5, i32 0, {{.*}}, {{.*}}, <2 x float> <float 7.000000e+00, float 8.000000e+00>)
...
; SHADERTEST: call <2 x float> (...) @llpc.call.image.get.lod.v2f32(i32 8, i32 0, {{.*}}, {{.*}}, <3 x float> <float 7.000000e+00, float 8.000000e+00, float 9.000000e+00>)
