...
; SHADERTEST: call {{.*}} @llpc.call.image.query.size.v3i32(i32 2, i32 0, {{.*}}, i32 0) 
; SHADERTEST: call {{.*}} @"llpc.call.get.image.desc.ptr.s[p4v8i32,i32]"(i32 0, i32 3) 
; SHADERTEST: call {{.*}} @llpc.call.image.query.size.v2i32(i32 3, i32 0, {{.*}}, i32 0) 
...
; SHADERTEST: call {{.*}} @llpc.call.image.query.size.v2i32(i32 1, i32 0, {{.*}}, i32 0) 
; SHADERTEST: call {{.*}} @"llpc.call.get.image.desc.ptr.s[p4v8i32,i32]"(i32 0, i32 6) 
; SHADERTEST: call {{.*}} @llpc.call.image.query.size.v2i32(i32 3, i32 0, {{.*}}, i32 0) 
; SHADERTEST: call {{.*}} @"llpc.call.get.image.desc.ptr.s[p4v8i32,i32]"(i32 0, i32 7) 
; SHADERTEST: call {{.*}} @llpc.call.image.query.size.v3i32(i32 8, i32 0, {{.*}}, i32 0) 
; SHADERTEST: call {{.*}} @"llpc.call.get.image.desc.ptr.s[p4v8i32,i32]"(i32 0, i32 8) 
; SHADERTEST: call {{.*}} @llpc.call.image.query.size.v3i32(i32 8, i32 0, {{.*}}, i32 0) 
; SHADERTEST: call {{.*}} @"llpc.call.get.image.desc.ptr.s[p4v8i32,i32]"(i32 0, i32 9) 
; SHADERTEST: call {{.*}} @llpc.call.image.query.size.v2i32(i32 1, i32 0, {{.*}}, i32 0) 
; SHADERTEST: call {{.*}} @"llpc.call.get.image.desc.ptr.s[p4v8i32,i32]"(i32 0, i32 10) 
; SHADERTEST: call {{.*}} @llpc.call.image.query.size.v2i32(i32 1, i32 0, {{.*}}, i32 0) 
; SHADERTEST: call {{.*}} @"llpc.call.get.image.desc.ptr.s[p4v8i32,i32]"(i32 0, i32 11) 
; SHADERTEST: call {{.*}} @llpc.call.image.query.size.v2i32(i32 4, i32 0, {{.*}}, i32 0) 
; SHADERTEST: call {{.*}} @"llpc.call.get.image.desc.ptr.s[p4v8i32,i32]"(i32 0, i32 12) 
; SHADERTEST: call {{.*}} @llpc.call.image.query.size.v3i32(i32 5, i32 0, {{.*}}, i32 0) 
; SHADERTEST: call {{.*}} @llpc.call.image.query.size.i32(i32 0, i32 0, {{.*}}, i32 0) 
; SHADERTEST: call {{.*}} @"llpc.call.get.image.desc.ptr.s[p4v8i32,i32]"(i32 0, i32 16) 
; SHADERTEST: call {{.*}} @llpc.call.image.query.size.v2i32(i32 6, i32 0, {{.*}}, i32 0) 
; SHADERTEST: call {{.*}} @"llpc.call.get.image.desc.ptr.s[p4v8i32,i32]"(i32 0, i32 17) 
