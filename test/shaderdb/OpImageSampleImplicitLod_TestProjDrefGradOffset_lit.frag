...
; SHADERTEST: call {{.*}} @llpc.call.image.sample.f32(i32 1, i32 0, {{.*}}, {{.*}}, i32 793, {{.*}}, <2 x float> <float 0x3FB99999A0000000, float 0x3FC99999A0000000>, <2 x float> <float 0x3FD3333340000000, float 0x3FD99999A0000000>, <2 x i32> <i32 2, i32 3>, {{.*}})
