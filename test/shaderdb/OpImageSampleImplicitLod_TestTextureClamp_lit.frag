...
; SHADERTEST: <4 x float> @spirv.image.sample.f32.1D.minlod({{.*}}, float 0x3FB99999A0000000, {{.*}})
; SHADERTEST: <4 x float> @spirv.image.sample.f32.2D.minlod({{.*}}, <2 x float> <float 0x3FB99999A0000000, float 0x3FB99999A0000000>, {{.*}})
; SHADERTEST: <4 x float> @spirv.image.sample.f32.3D.minlod({{.*}}, <3 x float> <float 0x3FB99999A0000000, float 0x3FB99999A0000000, float 0x3FB99999A0000000>, {{.*}})
; SHADERTEST: <4 x float> @spirv.image.sample.f32.Cube.minlod({{.*}}, <3 x float> <float 0x3FB99999A0000000, float 0x3FB99999A0000000, float 0x3FB99999A0000000>, {{.*}})
; SHADERTEST: <4 x float> @spirv.image.sample.f32.1DArray.minlod({{.*}}, <2 x float> <float 0x3FB99999A0000000, float 0x3FB99999A0000000>, {{.*}})
; SHADERTEST: <4 x float> @spirv.image.sample.f32.2DArray.minlod({{.*}}, <3 x float> <float 0x3FB99999A0000000, float 0x3FB99999A0000000, float 0x3FB99999A0000000>, {{.*}})
