...
; SHADERTEST: <4 x float> @spirv.image.sample.f32.1D.constoffset.minlod({{.*}}, float 0x3FB99999A0000000, i32 2, {{.*}})
; SHADERTEST: <4 x float> @spirv.image.sample.f32.2D.constoffset.minlod({{.*}}, <2 x float> <float 0x3FB99999A0000000, float 0x3FB99999A0000000>, <2 x i32> <i32 2, i32 2>, {{.*}})
; SHADERTEST: <4 x float> @spirv.image.sample.f32.3D.constoffset.minlod({{.*}}, <3 x float> <float 0x3FB99999A0000000, float 0x3FB99999A0000000, float 0x3FB99999A0000000>, <3 x i32> <i32 2, i32 2, i32 2>, {{.*}})
; SHADERTEST: <4 x float> @spirv.image.sample.f32.1DArray.constoffset.minlod({{.*}}, <2 x float> <float 0x3FB99999A0000000, float 0x3FB99999A0000000>, i32 2, {{.*}})
