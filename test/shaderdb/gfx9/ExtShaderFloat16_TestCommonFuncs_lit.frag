...
; SHADERTEST-COUNT-3: %{{.*}} = call half @llvm.fabs.f16(half %{{[0-9]*}})
; SHADERTEST-COUNT-3: %{{.*}} = call half @llvm.floor.f16(half %{{[0-9]*}})
; SHADERTEST-COUNT-3: %{{.*}} = call half @llvm.trunc.f16(half %{{[0-9]*}})
